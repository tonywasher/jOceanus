 ...
 */
public class MetisViewerWindowImpl
        implements MetisViewerWindow {
    /**
     ...
     */
    public MetisViewerWindowImpl(final TethysUIFactory<?> pFactory,
    ...
    @Override
    public void handleExplicitPage(final int pIndex) {
        /* Update the page */
    ...
    @Override
    public void handleMode(final MetisViewerMode pMode) {
        /* Update the page */
