 ...
 * Data Viewer Entry.
 */
public class MetisViewerEntryImpl
        implements MetisViewerEntry {
    /**
     * Entry name prefix.
     */
     ...
     */
    MetisViewerEntryImpl(final MetisViewerManager pManager,
        ...
        if (pParent != null) {
            ...
            ((MetisViewerEntryImpl) pParent).addChild(this);
        }
    }
    ...
    @Override
    public MetisViewerEntry getParent() {
        return theParent;
    }
     ...
     */
    private void addChild(final MetisViewerEntryImpl pChild) {
    ...
    public boolean equals(final Object pThat) {
        ...
        /* Check class */
        if (!(pThat instanceof MetisViewerEntryImpl myThat)) {
            return false;
        }
