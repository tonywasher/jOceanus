 ...
 * the License.
 */
package io.github.tonywasher.joceanus.tethys.swing.base;
 ...
 */
public final class TethysUISwingUtils {
    /**
     * Logger.
     */
     ...
     * @return the icon
     */
    public static TethysUISwingIcon getIcon(final TethysUIIconId pId) {
        try {
    ...
    public static Image[] getIcons(final TethysUIIconId[] pIds) {
        ...
        for (int i = 0; i < pIds.length; i++) {
            final TethysUISwingIcon myIcon = getIcon(pIds[i]);
