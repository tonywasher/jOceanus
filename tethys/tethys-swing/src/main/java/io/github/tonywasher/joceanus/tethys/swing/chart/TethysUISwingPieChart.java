...
import io.github.tonywasher.joceanus.tethys.core.chart.TethysUICorePieChart;
...
public class TethysUISwingPieChart
    ...
    TethysUISwingPieChart(final TethysUICoreFactory<?> pFactory) {
        ...
        theChart = ChartFactory.createPieChart(
                ...
                true,
                false);
        @SuppressWarnings("unchecked") final PiePlot<String> myPlot = (PiePlot<String>) theChart.getPlot();
