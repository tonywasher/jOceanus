...
import io.github.tonywasher.joceanus.tethys.core.control.TethysUICoreTreeManager;
import io.github.tonywasher.joceanus.tethys.core.factory.TethysUICoreFactory;
import io.github.tonywasher.joceanus.tethys.swing.base.TethysUISwingIcon;
...
public class TethysUISwingTreeManager<T>
    ...
    private final class TethysTreeCellRenderer
        ...
        public Component getTreeCellRendererComponent(final JTree pTree,
            ...
            /* Access value */
            @SuppressWarnings("unchecked") final TethysUISwingTreeNode<T> myNode = (TethysUISwingTreeNode<T>) pValue;
