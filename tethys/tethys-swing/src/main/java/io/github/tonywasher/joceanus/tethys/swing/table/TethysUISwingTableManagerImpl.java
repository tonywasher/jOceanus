...
import io.github.tonywasher.joceanus.tethys.core.table.TethysUICoreTableManagerImpl;
...
import io.github.tonywasher.joceanus.tethys.swing.table.TethysUISwingTableSorter.TethysUISwingTableSorterModel;
 ...
 */
public class TethysUISwingTableManagerImpl<C, R>
        extends TethysUICoreTableManagerImpl<C, R>
        implements TethysUISwingTableManager<C, R> {
    /**
     * The Node.
     */
     ...
     * The ColumnList.
     */
    private final List<TethysUITableColumn<?, C, R>> theColumnList;
     ...
     */
    public TethysUISwingTableManagerImpl(final TethysUICoreFactory<?> pFactory) {
        ...
        theCellFactory = new TethysUISwingTableCellFactoryImpl<>(pFactory);
    ...
    @Override
    public TethysUISwingTableManagerImpl<C, R> setFilter(final Predicate<R> pFilter) {
    ...
    @Override
    public TethysUISwingTableManagerImpl<C, R> setComparator(final Comparator<R> pComparator) {
    ...
    @Override
    public List<TethysUITableColumn<?, C, R>> getColumnList() {
    ...
    @Override
    public TethysUISwingTableCellFactory<C, R> getCellFactory() {
    ...
    TethysUISwingTableColumn<?, C, R> getIndexedColumn(final int pIndex) {
        ...
        return (TethysUISwingTableColumn<?, C, R>) theColumnList.get(pIndex);
    }

    @Override
    public R getIndexedRow(final int pIndex) {
    ...
    @Override
    public void fireTableRowUpdated(final int pRowIndex) {
