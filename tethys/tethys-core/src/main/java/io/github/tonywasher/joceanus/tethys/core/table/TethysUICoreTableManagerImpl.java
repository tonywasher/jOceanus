 ...
 * the License.
 */
package io.github.tonywasher.joceanus.tethys.core.table;
 ...
 */
public abstract class TethysUICoreTableManagerImpl<C, R>
        extends TethysUICoreComponent
        implements TethysUICoreTableManager<C, R> {
    /**
     * The Id.
     */
     ...
     */
    protected TethysUICoreTableManagerImpl(final TethysUICoreFactory<?> pFactory) {
    ...
    @Override
    public void registerColumn(final TethysUITableColumn<?, C, R> pColumn) {
        theColumnMap.put(pColumn.getId(), (TethysUICoreTableColumn<?, C, R>) pColumn);
    }
    ...
    @Override
    public TethysUITableColumn<?, C, R> getLastChild() {
        return theLastChild;
    }

    @Override
    public void setLastChild(final TethysUITableColumn<?, C, R> pChild) {
        theLastChild = (TethysUICoreTableColumn<?, C, R>) pChild;
    }
}
