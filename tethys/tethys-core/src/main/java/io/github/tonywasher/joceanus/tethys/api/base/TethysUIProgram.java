 ...
 * the License.
 */
package io.github.tonywasher.joceanus.tethys.api.base;
 ...
 * Program Definitions.
 */
public abstract class TethysUIProgram {
    /**
     * Logger.
     */
    private static final OceanusLogger LOGGER = OceanusLogManager.getLogger(TethysUIProgram.class);
