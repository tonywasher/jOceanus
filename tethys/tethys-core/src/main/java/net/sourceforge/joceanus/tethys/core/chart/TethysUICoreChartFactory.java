...
import net.sourceforge.joceanus.tethys.core.chart.TethysUICoreBarChart.TethysUICoreBarChartData;
import net.sourceforge.joceanus.tethys.core.chart.TethysUICorePieChart.TethysUICorePieChartData;
