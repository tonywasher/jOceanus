 ...
 */
public class TethysUIFXTableManagerImpl<C, R>
        extends TethysUICoreTableManagerImpl<C, R>
        implements TethysUIFXTableManager<C, R> {
    /**
     ...
     */
    public TethysUIFXTableManagerImpl(final TethysUICoreFactory<?> pFactory) {
        ...
        theCellFactory = new TethysUIFXTableCellFactoryImpl<>(pFactory);
    ...
    @Override
    public ObservableList<TableColumn<R, ?>> getColumns() {
        return theColumns;
    }

    @Override
    public TethysUIFXTableCellFactory<C, R> getCellFactory() {
    ...
    @Override
    public TethysUIFXTableManagerImpl<C, R> setFilter(final Predicate<R> pFilter) {
    ...
    @Override
    public TethysUIFXTableManagerImpl<C, R> setComparator(final Comparator<R> pComparator) {
    ...
    @Override
    public void processOnCommit(final R pRow) throws OceanusException {
    ...
    @Override
    public void setActiveCell(final TethysUITableCell<?, C, R> pCell) {
        theActiveCell = (TethysUIFXTableCell<?, C, R>) pCell;
    }
