...
import net.sourceforge.joceanus.prometheus.service.sheet.odf.PrometheusOdfNameSpace.PrometheusOdfItem;

/**
 * Table Item.
 */
public enum PrometheusOdfTableItem
     ...
     */
    PrometheusOdfTableItem(final String pName) {
        theName = pName;
    }
    ...
    public PrometheusOdfNameSpace getNameSpace() {
        switch (this) {
            case TEXT:
                return PrometheusOdfNameSpace.TEXT;
            default:
                return PrometheusOdfNameSpace.TABLE;
        }
    }
}
