...
public abstract class PrometheusSheetStaticData<T extends PrometheusStaticDataItem>
    ...
    protected PrometheusDataValues getRowValues(final String pName) throws OceanusException {
        ...
        myValues.addValue(PrometheusDataResource.STATICDATA_SORT, loadInteger(COL_ORDER));
        myValues.addValue(PrometheusDataResource.STATICDATA_ENABLED, loadBoolean(COL_ENABLED));
        return myValues;
    }
}
