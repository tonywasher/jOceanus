...
public interface PrometheusBackup {
    ...
    class PrometheusBackupPreferences
         ...
         */
        public PrometheusBackupPreferences(final MetisPreferenceParams pParams) throws OceanusException {
            super(pParams, PrometheusPreferenceResource.BUPREF_PREFNAME);
        }
