...
public class Component {
	 ...
	 */
	public BranchList 		getBranchList()		{ return theBranches; }
	...
	public static class ComponentList {
		 ...
		 */
		public List<Component>	getList() 	{ return theList; }
		...
		public void discover() throws ModelException {
			...
			try { 
				...
				throw new ModelException(ExceptionClass.SUBVERSION,
										 "Failed to discover components for " + theRepository.getName(),
										 e);
			}
		}
		...
		protected Branch locateBranch(SVNURL pURL) {
			...
			while (myIterator.hasNext()) {
				...
				if (!pURL.getHost().equals(myCompURL.getHost())) continue;
