 ...
 * $URL: http://tony-laptop/svn/finance/JSvnManager/branches/v1.1.0/src/main/java/net/sourceforge/JSvnManager/tasks/CheckOut.java $
 * $Revision: 153 $
 * $Author: Tony $
...
import net.sourceforge.JSvnManager.data.WorkingCopy;
