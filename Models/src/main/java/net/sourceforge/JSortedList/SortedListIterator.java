...
public class SortedListIterator<T extends LinkObject<T>> implements ListIterator<T> {
     ...
     */
    protected SortedListIterator(SortedList<T> pList, boolean bShowAll) {
        showAll = bShowAll;
        theList = pList;
    }
     ...
     * @param bShowAll show all items in the list
     */
    protected SortedListIterator(SortedList<T> pList, LinkNode<T> pNode, boolean bShowAll) {
    ...
    public boolean hasNext() {
        ...
        myNext = (theNodeBefore != null) ? theNodeBefore.getNext(!showAll) : ((showAll) ? theList.getHead()
                : theList.getFirst());
    ...
    public boolean hasPrevious() {
        ...
        /* Access the next node */
        myPrev = (theNodeAfter != null) ? theNodeAfter.getPrev(!showAll) : ((showAll) ? theList.getTail()
                : theList.getLast());
    ...
    public int nextIndex() {
        ...
        if (myNext != null)
            iIndex = myNext.getIndex(!showAll);
    ...
    public int previousIndex() {
        ...
        if (myPrev != null)
            iIndex = myPrev.getIndex(!showAll);
    ...
    public void remove() {
        ...
        if (wasForward) {
            ...
            theNodeBefore = (theNodeAfter != null) ? theNodeAfter.getPrev(false) : theList.getTail();
        }
        ...
        /* else the last operation was backwards */
            ...
            theNodeAfter = (theNodeBefore != null) ? theNodeBefore.getNext(false) : theList.getHead();
        }
