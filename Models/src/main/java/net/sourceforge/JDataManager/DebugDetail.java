...
public class DebugDetail {
     ...
     * @return the Detail
     */
    protected StringBuilder getDebugDetail() {
        return theBuilder;
    }
     ...
     */
    protected DebugDetail(Object pObject) {
        /* Obtain the detail for this object */
        if (pObject != null)
            theBuilder = ReportObject.formatHTMLObject(this, pObject);
    }
    ...
    public String addDebugLink(Object pItem,
        ...
        if (pItem instanceof ReportDetail) {
            StringBuilder myBuilder = new StringBuilder(100);

            /* Create the Debug Link */
            DebugLink myLink = new DebugLink((ReportDetail) pItem);
    ...
    private class DebugLink {
         ...
         */
        private DebugLink(ReportDetail pObject) {
            /* Store object */
            theObject = pObject;
