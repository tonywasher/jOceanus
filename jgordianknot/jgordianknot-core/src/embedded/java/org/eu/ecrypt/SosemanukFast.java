...
public class SosemanukFast {
    ...
    /*
     * The code internals for the SERPENT-derived functions have been semi-automatically generated,
     * using a mixture of C, C preprocessor, vi macros and Forth. The base circuits for the SERPENT
     * S-boxes have been published by Dag Arne Osvik ("Speeding up Serpent", at the 3rd AES
    ...
    static {
         ...
         * table. We have the following equations: alpha^4 = beta^23 * alpha^3 + beta^245 * alpha^2
         * + beta^48 * alpha + beta^239 1/alpha = beta^16 * alpha^3 + beta^39 * alpha^2 + beta^6 *
         * alpha + beta^64
         */
