...
public class SosemanukEngine
     ...
     * Copied from http://www.ecrypt.eu.org/stream/e2-sosemanuk.html.
     */
    public static class SosemanukFast {
        /*
        ...
        /*
         * The code internals for the SERPENT-derived functions have been semi-automatically
         * generated, using a mixture of C, C preprocessor, vi macros and Forth. The base circuits
         * for the SERPENT S-boxes have been published by Dag Arne Osvik ("Speeding up Serpent", at
         * the 3rd AES Candidate Conference).
         */
        ...
        /**
         * Set the private key. The key length must be between 1 and 32 bytes.
         *
        ...
        /**
         * Set the IV. The IV length must lie between 0 and 16 (inclusive). <code>null</code> is
         * accepted, and yields the same result than an IV of length 0.
         *
        ...
        /*
         * mulAlpha[] is used to multiply a word by alpha; mulAlpha[x] is equal to x * alpha^4.
         * divAlpha[] is used to divide a word by alpha; divAlpha[x] is equal to x / alpha.
         */
        ...
        static {
            /*
             * We first build exponential and logarithm tables relatively to beta in F_{2^8}. We set
             * log(0x00) = 0xFF conventionaly, but this is actually not used in our computations.
             */
            ...
            /*
             * We now compute mulAlpha[] and divAlpha[]. For all x != 0, we work with invertible
             * numbers, which are as such powers of beta. Multiplication (in F_{2^8}) is then
             * implemented as integer addition modulo 255, over the exponents computed by the logb[]
             * table. We have the following equations: alpha^4 = beta^23 * alpha^3 + beta^245 *
             * alpha^2 + beta^48 * alpha + beta^239 1/alpha = beta^16 * alpha^3 + beta^39 * alpha^2
        ...
        /*
         * Internal buffer for partial blocks. "streamPtr" points to the first stream byte which has
         * been computed but not output.
         */
