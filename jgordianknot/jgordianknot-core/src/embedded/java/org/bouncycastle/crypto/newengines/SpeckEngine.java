...
/**
 * The Speck family of block ciphers, described in <em>The Simon and Speck Families of Lightweight
...
public class SpeckEngine
    ...
    private static abstract class SpeckCipher {
         ...
         */
        protected SpeckCipher(int wordSize,
                              int baseRounds,
                              int alpha,
                              int beta) {
    ...
    private static abstract class SpeckIntCipher
         ...
         */
        protected SpeckIntCipher(int wordSize,
                                 int baseRounds) {
    ...
    private static abstract class SpeckLongCipher
         ...
         * @param baseRounds the base (for 2 word key) round count.
         */
        protected SpeckLongCipher(int wordSize,
                                  int baseRounds) {
            super(wordSize, baseRounds, 8, 3);
        }
