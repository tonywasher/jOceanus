...
/**
 * The Simon family of block ciphers, described in <em>The Simon and Speck Families of Lightweight
 * Block Ciphers</em> by <em>Ray Beaulieu, Douglas Shors, Jason Smith, Stefan Treatman-Clark, Bryan
 * Weeks, Louis Wingers </em>
 * <p>
...
public class SimonEngine
    ...
    private static abstract class SimonCipher {
        ...
        {
                { 01, 01, 01, 01, 01, 00, 01, 00, 00, 00, 01, 00, 00, 01, 00, 01, 00, 01, 01, 00, 00, 00, 00, 01, 01, 01, 00, 00, 01, 01, 00, 01, 01, 01, 01, 01, 00, 01, 00, 00, 00, 01, 00, 00, 01,
                        00, 01, 00, 01, 01, 00, 00, 00, 00, 01, 01, 01, 00, 00, 01, 01, 00, },
                { 01, 00, 00, 00, 01, 01, 01, 00, 01, 01, 01, 01, 01, 00, 00, 01, 00, 00, 01, 01, 00, 00, 00, 00, 01, 00, 01, 01, 00, 01, 00, 01, 00, 00, 00, 01, 01, 01, 00, 01, 01, 01, 01, 01, 00,
                        00, 01, 00, 00, 01, 01, 00, 00, 00, 00, 01, 00, 01, 01, 00, 01, 00, },
                { 01, 00, 01, 00, 01, 01, 01, 01, 00, 01, 01, 01, 00, 00, 00, 00, 00, 00, 01, 01, 00, 01, 00, 00, 01, 00, 00, 01, 01, 00, 00, 00, 01, 00, 01, 00, 00, 00, 00, 01, 00, 00, 00, 01, 01,
                        01, 01, 01, 01, 00, 00, 01, 00, 01, 01, 00, 01, 01, 00, 00, 01, 01, },
                { 01, 01, 00, 01, 01, 00, 01, 01, 01, 00, 01, 00, 01, 01, 00, 00, 00, 01, 01, 00, 00, 01, 00, 01, 01, 01, 01, 00, 00, 00, 00, 00, 00, 01, 00, 00, 01, 00, 00, 00, 01, 00, 01, 00, 00,
                        01, 01, 01, 00, 00, 01, 01, 00, 01, 00, 00, 00, 00, 01, 01, 01, 01, },
                { 01, 01, 00, 01, 00, 00, 00, 01, 01, 01, 01, 00, 00, 01, 01, 00, 01, 00, 01, 01, 00, 01, 01, 00, 00, 00, 01, 00, 00, 00, 00, 00, 00, 01, 00, 01, 01, 01, 00, 00, 00, 00, 01, 01, 00,
                        00, 01, 00, 01, 00, 00, 01, 00, 00, 01, 01, 01, 00, 01, 01, 01, 01, }
        };
         ...
         * word key
         */
        protected SimonCipher(int wordSize,
                              int sequenceBase) {
         ...
         * sequence and big endian byte ordering within words. e.g. a plaintext sequence of 2 words
         * p0, p1, will be encoded in a byte array with p1 occurring prior (at lower indexes) to p0,
         * and the bytes of p0 and p1 written in big-endian (most significant byte first) order.
    ...
    private static abstract class SimonIntCipher
         ...
         */
        protected SimonIntCipher(int wordSize,
                                 int sequenceBase) {
    ...
    private static abstract class SimonLongCipher
         ...
         * @param sequenceBase the sequence base to select the rounds constants with.
         */
        protected SimonLongCipher(int wordSize,
                                  int sequenceBase) {
            super(wordSize, sequenceBase);
