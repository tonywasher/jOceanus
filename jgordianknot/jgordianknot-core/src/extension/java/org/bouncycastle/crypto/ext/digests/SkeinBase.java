        ...
        implements Memoable
{
     ...
     *                       bytes.
     */
    public SkeinBase(int blockSizeBits, int outputSizeBits)
    {
    ...
    private void copyIn(SkeinBase engine)
    {
    ...
    {
        return new SkeinBase(this);
    }

    public void reset(Memoable other)
    {
        SkeinBase s = (SkeinBase)other;
