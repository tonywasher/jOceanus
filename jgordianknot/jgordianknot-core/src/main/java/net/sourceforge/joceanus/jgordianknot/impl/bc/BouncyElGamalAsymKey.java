...
/**
 * ElGamal AsymKey classes.
 */
public final class BouncyElGamalAsymKey {
    /**
     * Private constructor.
     */
    private BouncyElGamalAsymKey() {
    }
    ...
    public static class BouncyElGamalPublicKey
         ...
         */
        BouncyElGamalPublicKey(final GordianAsymKeySpec pKeySpec,
    ...
    public static class BouncyElGamalPrivateKey
         ...
         */
        BouncyElGamalPrivateKey(final GordianAsymKeySpec pKeySpec,
