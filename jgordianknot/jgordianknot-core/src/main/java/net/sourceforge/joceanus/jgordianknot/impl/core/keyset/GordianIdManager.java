...
public class GordianIdManager {
     ...
     */
    public GordianSymKeyType generateRandomSymKeyType() {
     ...
     */
    public GordianSymKeyType[] generateRandomKeySetSymKeyTypes(final int pCount) {
     ...
     */
    GordianSymKeySpec deriveSymKeySpecFromEncodedId(final int pEncodedId) throws OceanusException {
     ...
     * @throws OceanusException on error
     */
    int deriveEncodedIdFromSymKeySpec(final GordianSymKeySpec pSymKeySpec) throws OceanusException {
     ...
     * @throws OceanusException on error
     */
    GordianStreamKeyType deriveStreamKeyTypeFromEncodedId(final int pEncodedId) throws OceanusException {
     ...
     * @throws OceanusException on error
     */
    int deriveEncodedIdFromStreamKeyType(final GordianStreamKeyType pKey) throws OceanusException {
     ...
     * @throws OceanusException on error
     */
    GordianDigestSpec deriveDigestSpecFromEncodedId(final int pEncodedId) throws OceanusException {
        /* Isolate id Components */
        final int myLenCode = pEncodedId & TethysDataConverter.NYBBLE_MASK;
     ...
     * @throws OceanusException on error
     */
    int deriveEncodedIdFromDigestSpec(final GordianDigestSpec pDigestSpec) throws OceanusException {
     ...
     * @throws OceanusException on error
     */
    GordianMacSpec deriveMacSpecFromEncodedId(final int pEncodedId) throws OceanusException {
        /* Isolate id Components */
     ...
     * @throws OceanusException on error
     */
    int deriveEncodedIdFromMacSpec(final GordianMacSpec pMacSpec) throws OceanusException {
        /* Determine base code */
     ...
     * @throws OceanusException on error
     */
    GordianSymCipherSpec deriveSymCipherSpecFromEncodedId(final int pEncodedId) throws OceanusException {
        /* Isolate id Components */
     ...
     * @throws OceanusException on error
     */
    GordianStreamCipherSpec deriveStreamCipherSpecFromEncodedId(final int pEncodedId) throws OceanusException {
     ...
     * @throws OceanusException on error
     */
    int deriveEncodedIdFromCipherSpec(final GordianSymCipherSpec pCipherSpec) throws OceanusException {
     ...
     * @throws OceanusException on error
     */
    int deriveEncodedIdFromCipherSpec(final GordianStreamCipherSpec pCipherSpec) throws OceanusException {
        /* Derive the encoded id */
