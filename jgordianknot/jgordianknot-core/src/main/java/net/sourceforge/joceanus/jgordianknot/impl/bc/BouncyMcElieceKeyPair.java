...
/**
 * McEliece KeyPair classes.
 */
public final class BouncyMcElieceKeyPair {
    /**
     * Private constructor.
     */
    private BouncyMcElieceKeyPair() {
    }
    ...
    public static class BouncyMcEliecePublicKey
         ...
         */
        BouncyMcEliecePublicKey(final GordianKeyPairSpec pKeySpec,
    ...
    public static class BouncyMcEliecePrivateKey
         ...
         */
        BouncyMcEliecePrivateKey(final GordianKeyPairSpec pKeySpec,
    ...
    public static class BouncyMcElieceCCA2PublicKey
         ...
         * @param pPublicKey the public key
         */
        BouncyMcElieceCCA2PublicKey(final GordianKeyPairSpec pKeySpec,
    ...
    public static class BouncyMcElieceCCA2PrivateKey
         ...
         * @param pPrivateKey the private key
         */
        BouncyMcElieceCCA2PrivateKey(final GordianKeyPairSpec pKeySpec,
