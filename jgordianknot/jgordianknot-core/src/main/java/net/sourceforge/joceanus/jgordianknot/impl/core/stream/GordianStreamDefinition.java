...
import net.sourceforge.joceanus.jgordianknot.impl.core.keyset.GordianCoreKnuthObfuscater;
...
public final class GordianStreamDefinition {
    ...
    private InputStream buildStreamKeyInputStream(final GordianCoreKeySet pKeySet,
        ...
        final GordianKey<GordianStreamKeyType> myKey = pKeySet.deriveKey(theTypeDefinition, myType);
        myCipher.initCipher(myKey, theInitVector, false);
