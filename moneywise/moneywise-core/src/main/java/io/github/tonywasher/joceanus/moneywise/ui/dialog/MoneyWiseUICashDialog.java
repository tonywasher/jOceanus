 ...
 */
public class MoneyWiseUICashDialog
        extends MoneyWiseUIAssetDialog<MoneyWiseCash> {
    /**
     * The fieldSet.
     */
     ...
     */
    public MoneyWiseUICashDialog(final TethysUIFactory<?> pFactory,
                                 final PrometheusEditSet pEditSet,
                                 final MoneyWiseUIAssetTable<MoneyWiseCash> pOwner) {
