 ...
 * the License.
 */
package io.github.tonywasher.joceanus.moneywise.analysis.lethe.values;
 ...
 */
public enum MoneyWiseAnalysisPayeeAttr implements MoneyWiseAnalysisAttribute {
    /**
     * Income.
     */
    INCOME,
    ...
    public String toString() {
        ...
        if (theName == null) {
            /* Load the name */
            theName = bundleIdForPayeeAttr(this).getValue();
        }
     ...
     */
    private static OceanusBundleId bundleIdForPayeeAttr(final MoneyWiseAnalysisPayeeAttr pAttr) {
