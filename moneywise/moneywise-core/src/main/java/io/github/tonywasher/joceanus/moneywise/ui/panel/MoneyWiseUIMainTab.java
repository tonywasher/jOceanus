...
import io.github.tonywasher.joceanus.moneywise.lethe.ui.panel.MoneyWiseUIReportTab;
import io.github.tonywasher.joceanus.moneywise.lethe.ui.panel.MoneyWiseUITransactionTable.MoneyWiseStatementPanel;
 ...
 */
public class MoneyWiseUIMainTab
     ...
     * The MarketPanel.
     */
    private MoneyWiseUIMarketTabs theMarket;

    /**
     * The maintenance panel.
     */
    private MoneyWiseUIMaintenance theMaint;
     ...
     */
    public MoneyWiseUIMainTab(final TethysUIFactory<?> pFactory) throws OceanusException {
    ...
    protected TethysUIComponent buildMainPanel() throws OceanusException {
        ...
        final MoneyWiseUIReportTab myReports = new MoneyWiseUIReportTab(theView);
     ...
     */
    private void selectMaintenance(final PrometheusGoToEvent<MoneyWiseUIGoToId> pEvent) {
