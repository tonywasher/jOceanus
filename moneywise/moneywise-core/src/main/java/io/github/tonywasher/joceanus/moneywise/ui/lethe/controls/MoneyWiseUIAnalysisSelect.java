 ...
 * the License.
 */
package io.github.tonywasher.joceanus.moneywise.ui.lethe.controls;

import io.github.tonywasher.joceanus.metis.data.MetisDataDifference;
import io.github.tonywasher.joceanus.metis.ui.MetisIcon;
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.base.MoneyWiseAnalysisAttribute;
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.data.MoneyWiseAnalysis;
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.data.MoneyWiseAnalysisType;
import io.github.tonywasher.joceanus.moneywise.ui.MoneyWiseUIAnalysisColumnSet;
...
import io.github.tonywasher.joceanus.moneywise.views.lethe.MoneyWiseAnalysisFilter.MoneyWiseAnalysisAllFilter;
import io.github.tonywasher.joceanus.moneywise.views.lethe.MoneyWiseAnalysisView;
 ...
 */
public class MoneyWiseUIAnalysisSelect
     ...
     * ColumnSet Button.
     */
    private final TethysUIScrollButtonManager<MoneyWiseUIAnalysisColumnSet> theColumnButton;
     ...
     */
    private final MoneyWiseUIDepositAnalysisSelect theDepositSelect;

    /**
     * Cash Select Panel.
     */
    private final MoneyWiseUICashAnalysisSelect theCashSelect;

    /**
     * Loan Select Panel.
     */
    private final MoneyWiseUILoanAnalysisSelect theLoanSelect;

    /**
     * Security Select Panel.
     */
    private final MoneyWiseUISecurityAnalysisSelect theSecuritySelect;

    /**
     * Portfolio Select Panel.
     */
    private final MoneyWiseUIPortfolioAnalysisSelect thePortfolioSelect;

    /**
     * Payee Select Panel.
     */
    private final MoneyWiseUIPayeeAnalysisSelect thePayeeSelect;

    /**
     * TransCategory Select Panel.
     */
    private final MoneyWiseUITransCategoryAnalysisSelect theCategorySelect;

    /**
     * TaxBasis Select Panel.
     */
    private final MoneyWiseUITaxBasisAnalysisSelect theTaxBasisSelect;

    /**
     * TransactionTag Select Panel.
     */
    private final MoneyWiseUITransTagSelect theTagSelect;

    /**
     * All Select Panel.
     */
    private final MoneyWiseUIAllSelect theAllSelect;

    /**
     * The card panel.
     */
    private final TethysUICardPaneManager<MoneyWiseUIAnalysisFilterSelection> theCardPanel;
     ...
     * Select panel map.
     */
    private final Map<MoneyWiseAnalysisType, MoneyWiseUIAnalysisFilterSelection> theMap;
     ...
     * Column menu.
     */
    private final TethysUIScrollMenu<MoneyWiseUIAnalysisColumnSet> theColumnMenu;
     ...
     */
    public MoneyWiseUIAnalysisSelect(final TethysUIFactory<?> pFactory,
        ...
        theColumnButton = myButtons.newScrollButton(MoneyWiseUIAnalysisColumnSet.class);
        ...
        theDepositSelect = new MoneyWiseUIDepositAnalysisSelect(pFactory);
        theCashSelect = new MoneyWiseUICashAnalysisSelect(pFactory);
        theLoanSelect = new MoneyWiseUILoanAnalysisSelect(pFactory);
        theSecuritySelect = new MoneyWiseUISecurityAnalysisSelect(pFactory);
        thePortfolioSelect = new MoneyWiseUIPortfolioAnalysisSelect(pFactory);
        thePayeeSelect = new MoneyWiseUIPayeeAnalysisSelect(pFactory);
        theCategorySelect = new MoneyWiseUITransCategoryAnalysisSelect(pFactory);
        theTaxBasisSelect = new MoneyWiseUITaxBasisAnalysisSelect(pFactory);
        theTagSelect = new MoneyWiseUITransTagSelect(pFactory);
        theAllSelect = new MoneyWiseUIAllSelect(pFactory);
     ...
     */
    public MoneyWiseUIAnalysisColumnSet getColumns() {
    ...
    public void selectStatement(final MoneyWiseStatementSelect pSelect) {
        ...
        final MoneyWiseUIAnalysisFilterSelection myPanel = theMap.get(myType);
    ...
    private boolean isAvailable() {
        ...
        for (MoneyWiseUIAnalysisFilterSelection myEntry : theMap.values()) {
    ...
    private void checkType() {
        ...
        /* Loop through the panels */
        for (Entry<MoneyWiseAnalysisType, MoneyWiseUIAnalysisFilterSelection> myEntry : theMap.entrySet()) {
            /* If the filter is possible */
            final MoneyWiseUIAnalysisFilterSelection myPanel = myEntry.getValue();
            if (myPanel.isAvailable()) {
    ...
    private void buildColumnsMenu() {
        ...
        for (MoneyWiseUIAnalysisColumnSet mySet : MoneyWiseUIAnalysisColumnSet.values()) {
    ...
    private void handleNewColumns() {
        ...
        /* Record the columns */
        final MoneyWiseUIAnalysisColumnSet mySet = theColumnButton.getValue();
    ...
    private final class MoneyWiseAnalysisState {
         ...
         * The ColumnSet.
         */
        private MoneyWiseUIAnalysisColumnSet theColumns;
        ...
        private MoneyWiseAnalysisState() {
            ...
            theType = null;
            theBucket = null;
            theColumns = MoneyWiseUIAnalysisColumnSet.STANDARD;
            showColumns = true;
        }
         ...
         * @return the columns.
         */
        private MoneyWiseUIAnalysisColumnSet getColumns() {
            return theColumns;
        }
         ...
         */
        private void determineState(final MoneyWiseUIAnalysisFilterSelection pFilter) {
         ...
         * @return true/false did a change occur
         */
        private boolean setColumns(final MoneyWiseUIAnalysisColumnSet pColumnSet) {
            if (!MetisDataDifference.isEqual(pColumnSet, theColumns)) {
                /* If this is the balance bucket */
                if (pColumnSet.equals(MoneyWiseUIAnalysisColumnSet.BALANCE)) {
                    showColumns = false;
                } else {
