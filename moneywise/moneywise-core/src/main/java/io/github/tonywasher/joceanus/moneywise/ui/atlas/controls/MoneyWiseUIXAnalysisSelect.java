 ...
 * the License.
 */
package io.github.tonywasher.joceanus.moneywise.ui.atlas.controls;
...
import io.github.tonywasher.joceanus.moneywise.analysis.atlas.base.MoneyWiseXAnalysisAttribute;
import io.github.tonywasher.joceanus.moneywise.analysis.atlas.buckets.MoneyWiseXAnalysis;
import io.github.tonywasher.joceanus.moneywise.analysis.atlas.buckets.MoneyWiseXAnalysisType;
...
import io.github.tonywasher.joceanus.moneywise.views.atlas.MoneyWiseXAnalysisFilter.MoneyWiseXAnalysisAllFilter;
 ...
 */
public class MoneyWiseUIXAnalysisSelect
     ...
     */
    private final MoneyWiseUIXDepositAnalysisSelect theDepositSelect;

    /**
     * Cash Select Panel.
     */
    private final MoneyWiseUIXCashAnalysisSelect theCashSelect;

    /**
     * Loan Select Panel.
     */
    private final MoneyWiseUIXLoanAnalysisSelect theLoanSelect;

    /**
     * Security Select Panel.
     */
    private final MoneyWiseUIXSecurityAnalysisSelect theSecuritySelect;

    /**
     * Portfolio Select Panel.
     */
    private final MoneyWiseUIXPortfolioAnalysisSelect thePortfolioSelect;

    /**
     * Payee Select Panel.
     */
    private final MoneyWiseUIXPayeeAnalysisSelect thePayeeSelect;

    /**
     * TransCategory Select Panel.
     */
    private final MoneyWiseUIXTransCategoryAnalysisSelect theCategorySelect;

    /**
     * TaxBasis Select Panel.
     */
    private final MoneyWiseUIXTaxBasisAnalysisSelect theTaxBasisSelect;

    /**
     * TransactionTag Select Panel.
     */
    private final MoneyWiseUIXTransTagSelect theTagSelect;

    /**
     * All Select Panel.
     */
    private final MoneyWiseUIXAllSelect theAllSelect;

    /**
     * The card panel.
     */
    private final TethysUICardPaneManager<MoneyWiseUIXAnalysisFilterSelection> theCardPanel;
     ...
     * Select panel map.
     */
    private final Map<MoneyWiseXAnalysisType, MoneyWiseUIXAnalysisFilterSelection> theMap;
    ...
    public MoneyWiseUIXAnalysisSelect(final TethysUIFactory<?> pFactory,
        ...
        theDepositSelect = new MoneyWiseUIXDepositAnalysisSelect(pFactory);
        theCashSelect = new MoneyWiseUIXCashAnalysisSelect(pFactory);
        theLoanSelect = new MoneyWiseUIXLoanAnalysisSelect(pFactory);
        theSecuritySelect = new MoneyWiseUIXSecurityAnalysisSelect(pFactory);
        thePortfolioSelect = new MoneyWiseUIXPortfolioAnalysisSelect(pFactory);
        thePayeeSelect = new MoneyWiseUIXPayeeAnalysisSelect(pFactory);
        theCategorySelect = new MoneyWiseUIXTransCategoryAnalysisSelect(pFactory);
        theTaxBasisSelect = new MoneyWiseUIXTaxBasisAnalysisSelect(pFactory);
        theTagSelect = new MoneyWiseUIXTransTagSelect(pFactory);
        theAllSelect = new MoneyWiseUIXAllSelect(pFactory);
    ...
    public void selectStatement(final MoneyWiseXStatementSelect pSelect) {
        ...
        final MoneyWiseUIXAnalysisFilterSelection myPanel = theMap.get(myType);
    ...
    private boolean isAvailable() {
        ...
        for (MoneyWiseUIXAnalysisFilterSelection myEntry : theMap.values()) {
    ...
    private void checkType() {
        ...
        /* Loop through the panels */
        for (Entry<MoneyWiseXAnalysisType, MoneyWiseUIXAnalysisFilterSelection> myEntry : theMap.entrySet()) {
            /* If the filter is possible */
            final MoneyWiseUIXAnalysisFilterSelection myPanel = myEntry.getValue();
            if (myPanel.isAvailable()) {
    ...
    private final class MoneyWiseAnalysisState {
         ...
         */
        private void determineState(final MoneyWiseUIXAnalysisFilterSelection pFilter) {
