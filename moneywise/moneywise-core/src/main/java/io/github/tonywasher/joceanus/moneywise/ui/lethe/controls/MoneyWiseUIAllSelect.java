 ...
 */
public class MoneyWiseUIAllSelect
        implements MoneyWiseUIAnalysisFilterSelection {
    /**
     * The panel.
     */
     ...
     */
    protected MoneyWiseUIAllSelect(final TethysUIFactory<?> pFactory) {
        /* Create the filter */
    ...
    public void setFilter(final MoneyWiseAnalysisFilter<?, ?> pFilter) {
        ...
        if (pFilter instanceof MoneyWiseAnalysisAllFilter myFilter) {
            /* Set the dateRange */
