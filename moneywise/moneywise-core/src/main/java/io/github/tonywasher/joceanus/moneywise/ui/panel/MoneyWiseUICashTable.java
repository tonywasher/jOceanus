...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUICashDialog;
 ...
 */
public class MoneyWiseUICashTable
        extends MoneyWiseUIAssetTable<MoneyWiseCash> {
    /**
     * The Cash dialog.
     */
    private final MoneyWiseUICashDialog theActiveCash;
     ...
     */
    MoneyWiseUICashTable(final MoneyWiseView pView,
        ...
        /* Create a Cash panel */
        theActiveCash = new MoneyWiseUICashDialog(myGuiFactory, pEditSet, this);
