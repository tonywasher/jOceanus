...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUITagDialog;
 ...
 * MoneyWise Tag Table.
 */
public class MoneyWiseUITransTagTable
        extends MoneyWiseUIBaseTable<MoneyWiseTransTag> {
    /**
     * The filter panel.
     */
     ...
     * The tag dialog.
     */
    private final MoneyWiseUITagDialog theActiveTag;
     ...
     */
    MoneyWiseUITransTagTable(final MoneyWiseView pView,
        ...
        /* Create a tag panel */
        theActiveTag = new MoneyWiseUITagDialog(myGuiFactory, pEditSet, this);
