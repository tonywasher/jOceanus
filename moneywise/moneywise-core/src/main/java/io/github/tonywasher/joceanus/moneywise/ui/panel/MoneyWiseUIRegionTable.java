...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUIRegionDialog;
 ...
 */
public class MoneyWiseUIRegionTable
        extends MoneyWiseUIBaseTable<MoneyWiseRegion> {
    /**
     * The filter panel.
     */
     ...
     * The Region dialog.
     */
    private final MoneyWiseUIRegionDialog theActiveRegion;
     ...
     */
    MoneyWiseUIRegionTable(final MoneyWiseView pView,
        ...
        theActiveRegion = new MoneyWiseUIRegionDialog(myGuiFactory, pEditSet, this);
