 ...
 */
public class MoneyWiseUIStaticPanel
     ...
     */
    private final TethysUICardPaneManager<MoneyWiseUIStaticTable<?, ?>> theTableCard;
     ...
     * The list of panels.
     */
    private final List<MoneyWiseUIStaticTable<?, ?>> thePanels;
     ...
     */
    MoneyWiseUIStaticPanel(final MoneyWiseView pView) {
        /* Store parameters */
        theView = pView;
    ...
    public void refreshData() throws OceanusException {
        ...
        for (MoneyWiseUIStaticTable<?, ?> myPanel : thePanels) {
            /* Note the stage */
    ...
    private void buildDataMenu() {
        ...
        /* Loop through the panels */
        for (MoneyWiseUIStaticTable<?, ?> myTable : thePanels) {
    ...
    private <L extends PrometheusStaticList<T>, T extends PrometheusStaticDataItem> void addStatic(final MoneyWiseStaticDataType pItemType,
        ...
        final MoneyWiseUIStaticTable<L, T> myPanel = new MoneyWiseUIStaticTable<>(theView, theEditSet, theError, pItemType, pListClass);
    ...
    public void selectStatic(final PrometheusStaticDataItem pStatic) {
        ...
        if (theTableCard.selectCard(myName)) {
            /* Update selection */
            final MoneyWiseUIStaticTable<?, ?> myPanel = theTableCard.getActiveCard();
    ...
    private void showNewButton() {
        ...
        final MoneyWiseUIStaticTable<?, ?> myPanel = (MoneyWiseUIStaticTable<?, ?>) theSelectButton.getValue().getData();
