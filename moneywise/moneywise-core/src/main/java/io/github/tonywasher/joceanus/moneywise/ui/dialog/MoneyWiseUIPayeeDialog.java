 ...
 */
public class MoneyWiseUIPayeeDialog
        extends MoneyWiseUIAssetDialog<MoneyWisePayee> {
    /**
     * The fieldSet.
     */
     ...
     */
    public MoneyWiseUIPayeeDialog(final TethysUIFactory<?> pFactory,
                                  final PrometheusEditSet pEditSet,
                                  final MoneyWiseUIAssetTable<MoneyWisePayee> pOwner) {
