...
import io.github.tonywasher.joceanus.moneywise.ui.controls.MoneyWiseUISpotRatesSelect;
import io.github.tonywasher.joceanus.moneywise.views.MoneyWiseSpotExchangeRate;
import io.github.tonywasher.joceanus.moneywise.views.MoneyWiseSpotExchangeRate.MoneyWiseSpotExchangeList;
 ...
 */
public class MoneyWiseUIMarketRatesTable
        extends MoneyWiseUIBaseTable<MoneyWiseSpotExchangeRate> {
    /**
     * The SpotRates selection panel.
     */
    private final MoneyWiseUISpotRatesSelect theSelect;
     ...
     */
    MoneyWiseUIMarketRatesTable(final MoneyWiseView pView,
        ...
        theSelect = new MoneyWiseUISpotRatesSelect(myGuiFactory, pView);
     ...
     */
    MoneyWiseUISpotRatesSelect getSelect() {
        return theSelect;
    }
    ...
    public static class MoneyWiseSpotRatesPanel
         ...
         * The table.
         */
        private final MoneyWiseUIMarketRatesTable theTable;
        ...
        public MoneyWiseSpotRatesPanel(final MoneyWiseView pView) {
            ...
            /* Create the table */
            theTable = new MoneyWiseUIMarketRatesTable(pView, theEditSet, theError);
