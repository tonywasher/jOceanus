...
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.base.MoneyWiseAnalysisValues;
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.data.MoneyWiseAnalysisAccountBucket;
...
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.data.MoneyWiseAnalysisTaxBasisBaseBucket;
...
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.values.MoneyWiseAnalysisCategoryValues;
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.values.MoneyWiseAnalysisPayeeAttr;
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.values.MoneyWiseAnalysisPayeeValues;
...
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.values.MoneyWiseAnalysisTaxBasisAttr;
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.values.MoneyWiseAnalysisTaxBasisValues;
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.values.MoneyWiseAnalysisTransAttr;
...
public abstract class MoneyWiseAnalysisFilter<B, T extends Enum<T> & MoneyWiseAnalysisAttribute>
     ...
     */
    public abstract OceanusDecimal getDeltaForTransaction(MoneyWiseTransaction pTrans);
     ...
     * @return the value
     */
    public OceanusDecimal getBalanceForTransaction(final MoneyWiseTransaction pTrans) {
     ...
     * @return the value
     */
    public OceanusDecimal getDebitForTransaction(final MoneyWiseTransaction pTrans) {
        OceanusDecimal myValue = getDeltaValueForTransaction(pTrans);
        if (myValue != null) {
     ...
     * @return the value
     */
    public OceanusDecimal getCreditForTransaction(final MoneyWiseTransaction pTrans) {
        final OceanusDecimal myValue = getDeltaValueForTransaction(pTrans);
        return (myValue != null
     ...
     * @return the value
     */
    private OceanusDecimal getDeltaValueForTransaction(final MoneyWiseTransaction pTrans) {
