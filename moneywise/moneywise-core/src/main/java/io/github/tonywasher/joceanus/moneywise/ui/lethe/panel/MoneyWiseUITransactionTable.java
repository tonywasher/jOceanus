 ...
 * the License.
 */
package io.github.tonywasher.joceanus.moneywise.ui.lethe.panel;
...
import io.github.tonywasher.joceanus.moneywise.ui.lethe.controls.MoneyWiseUIAnalysisSelect;
import io.github.tonywasher.joceanus.moneywise.ui.lethe.controls.MoneyWiseUIAnalysisSelect.MoneyWiseStatementSelect;
import io.github.tonywasher.joceanus.moneywise.ui.lethe.dialog.MoneyWiseUITransactionDialog;
 ...
 */
public class MoneyWiseUITransactionTable
        extends MoneyWiseUIBaseTable<MoneyWiseTransaction> {
    /**
     ...
     */
    private final MoneyWiseUITransactionDialog theActiveTran;
     ...
     */
    private final MoneyWiseUIAnalysisSelect theSelect;
     ...
     * ColumnSet.
     */
    private MoneyWiseUIAnalysisColumnSet theColumnSet;
     ...
     */
    MoneyWiseUITransactionTable(final MoneyWiseView pView,
        ...
        theSelect = new MoneyWiseUIAnalysisSelect(myGuiFactory, pView, theAnalysisView, theNewButton);

        /* Create the action buttons */
        theActionButtons = new PrometheusActionButtons(myGuiFactory, getEditSet());

        /* Create a transaction panel */
        theActiveTran = new MoneyWiseUITransactionDialog(myGuiFactory, pEditSet, theSelect, this);
        ...
        myTable.declareIconColumn(MoneyWiseBasicResource.TRANSACTION_DIRECTION, MoneyWiseAssetDirection.class)
                ...
                .setCellValueFactory(MoneyWiseUITransactionTable::getFilteredDirection)
                .setEditable(true)
        ...
        myTable.declareStringColumn(MoneyWiseTransInfoClass.COMMENTS)
                .setCellValueFactory(MoneyWiseUITransactionTable::getFilteredComments)
                .setEditable(true)
        ...
        myTable.declareIconColumn(PrometheusDataResource.DATAITEM_TOUCH, MetisAction.class)
                ...
                .setCellValueFactory(MoneyWiseUITransactionTable::getFilteredAction)
        ...
        adjustColumns(theSelect.showColumns()
                ...
                : MoneyWiseUIAnalysisColumnSet.BALANCE);
    }
     ...
     */
    MoneyWiseUIAnalysisSelect getSelect() {
        return theSelect;
    }
    ...
    protected boolean isFiltered(final MoneyWiseTransaction pRow) {
        ...
        if (pRow.isHeader()) {
            return MoneyWiseUIAnalysisColumnSet.BALANCE.equals(theColumnSet);
        }
     ...
     */
    private void adjustColumns(final MoneyWiseUIAnalysisColumnSet pSet) {
    ...
    public static class MoneyWiseStatementPanel
         ...
         * The table.
         */
        private final MoneyWiseUITransactionTable theTable;
        ...
        public MoneyWiseStatementPanel(final MoneyWiseView pView) {
            ...
            /* Create the table */
            theTable = new MoneyWiseUITransactionTable(pView, theEditSet, theError, myViewerFilter, theViewerAnalysis);
