 ...
 */
public class MoneyWiseUIRegionDialog
        extends MoneyWiseUIItemPanel<MoneyWiseRegion> {
    /**
     * Constructor.
     *
     ...
     */
    public MoneyWiseUIRegionDialog(final TethysUIFactory<?> pFactory,
                                   final PrometheusEditSet pEditSet,
                                   final MoneyWiseUIBaseTable<MoneyWiseRegion> pOwner) {
