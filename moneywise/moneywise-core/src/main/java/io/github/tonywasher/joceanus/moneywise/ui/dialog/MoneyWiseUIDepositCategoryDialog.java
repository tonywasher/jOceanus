 ...
 */
public class MoneyWiseUIDepositCategoryDialog
        extends MoneyWiseUIItemPanel<MoneyWiseDepositCategory> {
    /**
     * Constructor.
     *
     ...
     */
    public MoneyWiseUIDepositCategoryDialog(final TethysUIFactory<?> pFactory,
                                            final PrometheusEditSet pEditSet,
                                            final MoneyWiseUIBaseTable<MoneyWiseDepositCategory> pOwner) {
