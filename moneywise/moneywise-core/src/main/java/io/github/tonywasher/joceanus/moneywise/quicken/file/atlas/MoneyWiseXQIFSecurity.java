 ...
 */
public class MoneyWiseXQIFSecurity
        extends MoneyWiseXQIFRecord<MoneyWiseQSecurityLineType>
        implements Comparable<MoneyWiseXQIFSecurity> {
    /**
     * Item type.
     */
     ...
     * Category Map.
     */
    protected static final Map<MoneyWiseSecurityClass, String> XQIF_ACTCATMAP = createClassMap();
     ...
     */
    public MoneyWiseXQIFSecurity(final MoneyWiseSecurity pSecurity) {
        ...
        /* Build lines */
        addLine(new MoneyWiseXQIFSecurityNameLine(theName));
        addLine(new MoneyWiseXQIFSecuritySymbolLine(theSymbol));
        addLine(new MoneyWiseXQIFSecurityTypeLine(theClass));
    }
    ...
    protected MoneyWiseXQIFSecurity(final List<String> pLines) {
        ...
        while (myIterator.hasNext()) {
            ...
            if (myType != null) {
                ...
                switch (myType) {
                    case NAME:
                        addLine(new MoneyWiseXQIFSecurityNameLine(myData));
                        myName = myData;
                        break;
                    case SYMBOL:
                        addLine(new MoneyWiseXQIFSecuritySymbolLine(myData));
                        mySymbol = myData;
                        break;
                    case SECTYPE:
                        final MoneyWiseXQIFSecurityTypeLine myQLine = new MoneyWiseXQIFSecurityTypeLine(myData);
                        addLine(myQLine);
    ...
    @Override
    public int compareTo(final MoneyWiseXQIFSecurity pThat) {
     ...
     */
    public abstract static class MoneyWiseXQIFSecurityLine<X extends MoneyWiseQLineType>
         ...
         * @param pSecurity the Security
         */
        protected MoneyWiseXQIFSecurityLine(final MoneyWiseXQIFSecurity pSecurity) {
            /* Store data */
        ...
        public boolean equals(final Object pThat) {
            ...
            /* Cast correctly */
            final MoneyWiseXQIFSecurityLine<?> myLine = (MoneyWiseXQIFSecurityLine<?>) pThat;
     ...
     */
    public static class MoneyWiseXQIFSecurityNameLine
            extends MoneyWiseXQIFStringLine<MoneyWiseQSecurityLineType> {
        /**
         * Constructor.
         *
         * @param pName the Name
         */
        protected MoneyWiseXQIFSecurityNameLine(final String pName) {
            /* Call super-constructor */
            super(pName);
        }
     ...
     */
    public static class MoneyWiseXQIFSecuritySymbolLine
            extends MoneyWiseXQIFStringLine<MoneyWiseQSecurityLineType> {
        /**
         * Constructor.
         *
         ...
         */
        protected MoneyWiseXQIFSecuritySymbolLine(final String pSymbol) {
            /* Call super-constructor */
            super(pSymbol);
        }
     ...
     */
    public static class MoneyWiseXQIFSecurityTypeLine
            extends MoneyWiseXQIFStringLine<MoneyWiseQSecurityLineType> {
        /**
         ...
         */
        protected MoneyWiseXQIFSecurityTypeLine(final MoneyWiseSecurityClass pClass) {
            /* Call super-constructor */
         ...
         */
        protected MoneyWiseXQIFSecurityTypeLine(final String pType) {
            /* Call super-constructor */
            super(pType);

            /* Loop through the map entries */
            MoneyWiseSecurityClass myClass = null;
            final Iterator<Entry<MoneyWiseSecurityClass, String>> myIterator = XQIF_ACTCATMAP.entrySet().iterator();
            while (myIterator.hasNext()) {
