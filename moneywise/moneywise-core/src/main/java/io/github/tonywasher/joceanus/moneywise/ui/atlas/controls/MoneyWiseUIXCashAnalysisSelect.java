 ...
 */
public class MoneyWiseUIXCashAnalysisSelect
        implements MoneyWiseUIXAnalysisFilterSelection, OceanusEventProvider<PrometheusDataEvent> {
    /**
     ...
     */
    protected MoneyWiseUIXCashAnalysisSelect(final TethysUIFactory<?> pFactory) {
    ...
    public void setFilter(final MoneyWiseXAnalysisFilter<?, ?> pFilter) {
        ...
        if (pFilter instanceof MoneyWiseXAnalysisCashFilter myFilter) {
