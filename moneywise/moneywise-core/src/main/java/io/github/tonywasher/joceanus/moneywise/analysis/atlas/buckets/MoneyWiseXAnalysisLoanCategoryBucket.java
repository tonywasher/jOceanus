...
public final class MoneyWiseXAnalysisLoanCategoryBucket
    ...
    public static final class MoneyWiseXAnalysisLoanCategoryBucketList
         ...
         */
        MoneyWiseXAnalysisLoanCategoryBucketList(final MoneyWiseXAnalysisHolder pAnalysis) {
            /* Initialise class */
            theAnalysis = pAnalysis;
            theCurrency = theAnalysis.getCurrency();
            theTotals = allocateTotalsBucket();
            theList = new MetisListIndexed<>();
            theList.setComparator(Comparator.comparing(MoneyWiseXAnalysisLoanCategoryBucket::getAccountCategory));
        }
