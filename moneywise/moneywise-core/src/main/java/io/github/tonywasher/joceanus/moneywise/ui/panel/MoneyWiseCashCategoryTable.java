...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseCashCategoryDialog;
...
public class MoneyWiseCashCategoryTable
     ...
     * The Category dialog.
     */
    private final MoneyWiseCashCategoryDialog theActiveCategory;
    ...
    MoneyWiseCashCategoryTable(final MoneyWiseView pView,
        ...
        theActiveCategory = new MoneyWiseCashCategoryDialog(myGuiFactory, pEditSet, this);
