...
import io.github.tonywasher.joceanus.moneywise.data.validate.MoneyWiseValidateSecurity;
 ...
 */
public class MoneyWiseUISecurityDialog
        extends MoneyWiseUIAssetDialog<MoneyWiseSecurity> {
    /**
     * Prices Tab Title.
     */
     ...
     * SecurityPrice Table.
     */
    private final MoneyWiseUISecurityPriceTable thePrices;
     ...
     */
    public MoneyWiseUISecurityDialog(final TethysUIFactory<?> pFactory,
                                     final MoneyWiseView pView,
                                     final PrometheusEditSet pEditSet,
                                     final MoneyWiseUIAssetTable<MoneyWiseSecurity> pOwner) {
        ...
        thePrices = new MoneyWiseUISecurityPriceTable(pView, getEditSet(), pOwner.getErrorPanel());
