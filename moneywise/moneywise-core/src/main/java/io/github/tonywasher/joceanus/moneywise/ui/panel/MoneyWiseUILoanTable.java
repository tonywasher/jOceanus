...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUILoanDialog;
 ...
 */
public class MoneyWiseUILoanTable
        extends MoneyWiseUIAssetTable<MoneyWiseLoan> {
    /**
     * The Loan dialog.
     */
    private final MoneyWiseUILoanDialog theActiveLoan;
     ...
     */
    MoneyWiseUILoanTable(final MoneyWiseView pView,
        ...
        /* Create a Loan panel */
        theActiveLoan = new MoneyWiseUILoanDialog(myGuiFactory, pEditSet, this);
