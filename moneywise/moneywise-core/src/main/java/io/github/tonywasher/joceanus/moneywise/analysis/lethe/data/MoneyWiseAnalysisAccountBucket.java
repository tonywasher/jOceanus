...
import io.github.tonywasher.joceanus.moneywise.analysis.lethe.base.MoneyWiseAnalysisBaseResource;
...
public abstract class MoneyWiseAnalysisAccountBucket<T extends MoneyWiseAssetBase>
    ...
    public abstract static class MoneyWiseAnalysisAccountBucketList<B extends MoneyWiseAnalysisAccountBucket<T>, T extends MoneyWiseAssetBase>
        ...
        protected MoneyWiseAnalysisAccountBucketList(final MoneyWiseAnalysisControl pAnalysis) {
            ...
            theList.setComparator(Comparator.comparing(MoneyWiseAnalysisAccountBucket::getAccount));
        }
