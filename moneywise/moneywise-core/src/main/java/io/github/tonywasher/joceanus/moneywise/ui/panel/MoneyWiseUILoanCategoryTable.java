...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUILoanCategoryDialog;
 ...
 */
public class MoneyWiseUILoanCategoryTable
        extends MoneyWiseUICategoryTable<MoneyWiseLoanCategory, MoneyWiseLoanCategoryType> {
    /**
     * The Category dialog.
     */
    private final MoneyWiseUILoanCategoryDialog theActiveCategory;
     ...
     */
    MoneyWiseUILoanCategoryTable(final MoneyWiseView pView,
        ...
        theActiveCategory = new MoneyWiseUILoanCategoryDialog(myGuiFactory, pEditSet, this);
