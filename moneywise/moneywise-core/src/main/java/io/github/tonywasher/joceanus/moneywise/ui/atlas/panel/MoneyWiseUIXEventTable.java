 ...
 * the License.
 */
package io.github.tonywasher.joceanus.moneywise.ui.atlas.panel;
...
import io.github.tonywasher.joceanus.moneywise.analysis.atlas.base.MoneyWiseXAnalysisDataType;
...
import io.github.tonywasher.joceanus.moneywise.ui.atlas.controls.MoneyWiseUIXAnalysisSelect;
import io.github.tonywasher.joceanus.moneywise.ui.atlas.controls.MoneyWiseUIXAnalysisSelect.MoneyWiseXStatementSelect;
import io.github.tonywasher.joceanus.moneywise.ui.atlas.dialog.MoneyWiseXTransactionDialog;
 ...
 */
public class MoneyWiseUIXEventTable
        extends MoneyWiseUIBaseTable<MoneyWiseXAnalysisEvent> {
    /**
     ...
     */
    private final MoneyWiseUIXAnalysisSelect theSelect;
    ...
    MoneyWiseUIXEventTable(final MoneyWiseView pView,
        ...
        theSelect = new MoneyWiseUIXAnalysisSelect(myGuiFactory, pView, theAnalysisMgr, theNewButton);

        /* Create the action buttons */
        theActionButtons = new PrometheusActionButtons(myGuiFactory, getEditSet());

        /* Create a transaction panel */
        theActiveTran = new MoneyWiseXTransactionDialog(myGuiFactory, pEditSet, theSelect, this);
        ...
        myTable.declareIconColumn(MoneyWiseBasicResource.TRANSACTION_DIRECTION, MoneyWiseAssetDirection.class)
                ...
                .setCellValueFactory(MoneyWiseUIXEventTable::getFilteredDirection)
                .setEditable(true)
        ...
        myTable.declareStringColumn(MoneyWiseTransInfoClass.COMMENTS)
                .setCellValueFactory(MoneyWiseUIXEventTable::getFilteredComments)
                .setEditable(true)
        ...
        myTable.declareIconColumn(PrometheusDataResource.DATAITEM_TOUCH, MetisAction.class)
                ...
                .setCellValueFactory(MoneyWiseUIXEventTable::getFilteredAction)
     ...
     */
    MoneyWiseUIXAnalysisSelect getSelect() {
        return theSelect;
    }
    ...
    public static class MoneyWiseXStatementPanel
         ...
         * The table.
         */
        private final MoneyWiseUIXEventTable theTable;
        ...
        public MoneyWiseXStatementPanel(final MoneyWiseView pView,
            ...
            /* Create the table */
            theTable = new MoneyWiseUIXEventTable(pView, theEditSet, pAnalysisMgr, theError, myViewerFilter, theViewerAnalysis);
