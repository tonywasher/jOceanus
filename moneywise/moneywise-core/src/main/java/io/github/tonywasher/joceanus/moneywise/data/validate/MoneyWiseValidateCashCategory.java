...
public class MoneyWiseValidateCashCategory
    ...
    public void validate(final PrometheusDataItemCtl pCategory) {
        ...
        if (myCatType == null) {
            myCategory.addError(PrometheusDataItem.ERROR_MISSING, MoneyWiseStaticDataType.CASHTYPE);
        } else {
            /* Access the class */
            ...
            if (!myCatType.getEnabled()) {
                myCategory.addError(PrometheusDataItem.ERROR_DISABLED, MoneyWiseStaticDataType.CASHTYPE);
            }
