 ...
 */
public class MoneyWiseUILoanCategoryDialog
        extends MoneyWiseUIItemPanel<MoneyWiseLoanCategory> {
    /**
     * Constructor.
     *
     ...
     */
    public MoneyWiseUILoanCategoryDialog(final TethysUIFactory<?> pFactory,
                                         final PrometheusEditSet pEditSet,
                                         final MoneyWiseUIBaseTable<MoneyWiseLoanCategory> pOwner) {
