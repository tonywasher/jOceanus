 ...
 */
public class MoneyWiseUITransCategoryDialog
        extends MoneyWiseUIItemPanel<MoneyWiseTransCategory> {
    /**
     * Constructor.
     *
     ...
     */
    public MoneyWiseUITransCategoryDialog(final TethysUIFactory<?> pFactory,
                                          final PrometheusEditSet pEditSet,
                                          final MoneyWiseUIBaseTable<MoneyWiseTransCategory> pOwner) {
