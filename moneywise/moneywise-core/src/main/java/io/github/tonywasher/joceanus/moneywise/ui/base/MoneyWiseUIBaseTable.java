 ...
 */
public abstract class MoneyWiseUIBaseTable<T extends PrometheusDataItem>
        implements MoneyWiseUIBaseTableCtl<T> {
    /**
     * The logger.
     */
    private static final OceanusLogger LOGGER = OceanusLogManager.getLogger(MoneyWiseUIBaseTable.class);
     ...
     */
    private final MoneyWiseUITableSelect<T> theSelect;
     ...
     */
    protected MoneyWiseUIBaseTable(final MoneyWiseView pView,
        ...
        theSelect = new MoneyWiseUITableSelect<>(theTable, this::isFiltered);
    }
     ...
     */
    protected void declareItemPanel(final MoneyWiseUIItemPanel<T> pPanel) {
    ...
    public String isValidName(final String pNewName,
        ...
        while (myIterator.hasNext()) {
            ...
            if (!(myValue instanceof MetisDataNamedItem myNamed)
                    || myValue.isDeleted()
                    || myValue.equals(pRow)) {
                continue;
            }
    ...
    protected Iterator<PrometheusDataItem> nameSpaceIterator() {
        return new MoneyWiseUINameSpaceIterator(theEditSet, theItemType);
    }
