...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUIPortfolioDialog;
 ...
 */
public class MoneyWiseUIPortfolioTable
        extends MoneyWiseUIAssetTable<MoneyWisePortfolio> {
    /**
     * The Portfolio dialog.
     */
    private final MoneyWiseUIPortfolioDialog theActivePortfolio;
     ...
     */
    MoneyWiseUIPortfolioTable(final MoneyWiseView pView,
        ...
        theActivePortfolio = new MoneyWiseUIPortfolioDialog(myGuiFactory, pEditSet, this);
