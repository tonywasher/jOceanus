...
/**
 * Validate Trans interface.
 */
public interface MoneyWiseValidateTransCtl
        extends MoneyWiseDataValidatorTrans<MoneyWiseTransaction> {
    /**
     * Obtain the transInfoSet validator.
     *
     * @return the validator
     */
    MoneyWiseValidateTransInfoSet getInfoSetValidator();
}
