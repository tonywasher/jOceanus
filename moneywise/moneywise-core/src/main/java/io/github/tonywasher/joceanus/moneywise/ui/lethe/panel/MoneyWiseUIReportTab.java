...
import io.github.tonywasher.joceanus.moneywise.ui.lethe.controls.MoneyWiseUIReportSelect;
...
public class MoneyWiseUIReportTab
     ...
     */
    private final MoneyWiseUIReportSelect theSelect;
     ...
     */
    public MoneyWiseUIReportTab(final MoneyWiseView pView) throws OceanusException {
        /* Store the view */
        theView = pView;
        ...
        theSelect = new MoneyWiseUIReportSelect(myFactory);
