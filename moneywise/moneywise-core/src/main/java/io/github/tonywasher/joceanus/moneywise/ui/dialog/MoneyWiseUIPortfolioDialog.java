 ...
 */
public class MoneyWiseUIPortfolioDialog
        extends MoneyWiseUIAssetDialog<MoneyWisePortfolio> {
    /**
     * The fieldSet.
     */
     ...
     */
    public MoneyWiseUIPortfolioDialog(final TethysUIFactory<?> pFactory,
                                      final PrometheusEditSet pEditSet,
                                      final MoneyWiseUIAssetTable<MoneyWisePortfolio> pOwner) {
