...
import io.github.tonywasher.joceanus.moneywise.analysis.atlas.analyse.MoneyWiseXAnalyse.MoneyWiseXAnalyseTransAnalyserCtl;
    ...
    private void processDebitXferOut(final MoneyWiseSecurityHolding pHolding) {
        ...
        if (myCapitalGain.isNonZero()) {
            ...
            if (myAsset.getSecurity().getCategoryClass().isChargeableGains()) {
                ...
                final OceanusRatio myRatio = OceanusRatio.getWholeUnits(myYears).getInverseRatio();
