 ...
 * Category panel.
 */
public class MoneyWiseUICategoryPanel
     ...
     */
    private final MoneyWiseUIDepositCategoryTable theDepositTable;

    /**
     * Cash Categories Table.
     */
    private final MoneyWiseUICashCategoryTable theCashTable;

    /**
     * Loan Categories Table.
     */
    private final MoneyWiseUILoanCategoryTable theLoanTable;

    /**
     * Transaction Categories Table.
     */
    private final MoneyWiseUITransCategoryTable theEventTable;

    /**
     * Event Tags Table.
     */
    private final MoneyWiseUITransTagTable theTagTable;

    /**
     * Regions Table.
     */
    private final MoneyWiseUIRegionTable theRegionTable;
     ...
     */
    MoneyWiseUICategoryPanel(final MoneyWiseView pView) {
        /* Store details */
        theView = pView;
        ...
        theDepositTable = new MoneyWiseUIDepositCategoryTable(pView, theEditSet, theError);
        theCashTable = new MoneyWiseUICashCategoryTable(pView, theEditSet, theError);
        theLoanTable = new MoneyWiseUILoanCategoryTable(pView, theEditSet, theError);
        theEventTable = new MoneyWiseUITransCategoryTable(pView, theEditSet, theError);
        theTagTable = new MoneyWiseUITransTagTable(pView, theEditSet, theError);
        theRegionTable = new MoneyWiseUIRegionTable(pView, theEditSet, theError);
    ...
    private void handleGoToEvent(final OceanusEvent<PrometheusDataEvent> pEvent) {
        /* Access details */
        @SuppressWarnings("unchecked") final PrometheusGoToEvent<MoneyWiseUIGoToId> myEvent = pEvent.getDetails(PrometheusGoToEvent.class);
