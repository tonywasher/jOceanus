 ...
 */
public class MoneyWiseUIDepositDialog
        extends MoneyWiseUIAssetDialog<MoneyWiseDeposit> {
    /**
     * Rates Tab Title.
     */
     ...
     * DepositRate Table.
     */
    private final MoneyWiseUIDepositRateTable theRates;
     ...
     */
    public MoneyWiseUIDepositDialog(final TethysUIFactory<?> pFactory,
                                    final MoneyWiseView pView,
                                    final PrometheusEditSet pEditSet,
                                    final MoneyWiseUIAssetTable<MoneyWiseDeposit> pOwner) {
        ...
        theRates = new MoneyWiseUIDepositRateTable(pView, getEditSet(), pOwner.getErrorPanel());
