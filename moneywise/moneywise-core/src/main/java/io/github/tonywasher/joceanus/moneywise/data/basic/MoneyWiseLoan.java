...
public class MoneyWiseLoan
        ...
        implements PrometheusDataInfoSetItemCtl<MoneyWiseLoanInfo> {
    /**
     * Object name.
     */
    ...
    static {
        ...
        FIELD_DEFS.buildFieldMap(MoneyWiseAccountInfoClass.class, MoneyWiseLoan::getFieldValue);
    }
    ...
    public static class MoneyWiseLoanList
         ...
         */
        public MoneyWiseLoanList(final PrometheusDataSet pData) {
