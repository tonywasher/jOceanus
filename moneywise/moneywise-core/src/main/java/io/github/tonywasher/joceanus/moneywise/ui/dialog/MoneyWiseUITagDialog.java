 ...
 */
public class MoneyWiseUITagDialog
        extends MoneyWiseUIItemPanel<MoneyWiseTransTag> {
    /**
     * Constructor.
     *
     ...
     */
    public MoneyWiseUITagDialog(final TethysUIFactory<?> pFactory,
                                final PrometheusEditSet pEditSet,
                                final MoneyWiseUIBaseTable<MoneyWiseTransTag> pOwner) {
