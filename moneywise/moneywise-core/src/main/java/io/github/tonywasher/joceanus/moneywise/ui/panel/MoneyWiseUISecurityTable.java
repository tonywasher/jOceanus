...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUISecurityDialog;
 ...
 */
public class MoneyWiseUISecurityTable
        extends MoneyWiseUIAssetTable<MoneyWiseSecurity> {
    /**
     ...
     * The Security dialog.
     */
    private final MoneyWiseUISecurityDialog theActiveSecurity;
     ...
     */
    MoneyWiseUISecurityTable(final MoneyWiseView pView,
        ...
        theActiveSecurity = new MoneyWiseUISecurityDialog(myGuiFactory, pView, pEditSet, this);
