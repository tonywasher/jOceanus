 ...
 */
public abstract class MoneyWiseUIAssetTable<T extends MoneyWiseAssetBase>
     ...
     */
    protected MoneyWiseUIAssetTable(final MoneyWiseView pView,
    ...
    protected Iterator<PrometheusDataItem> assetNameSpaceIterator() {
        return new MoneyWiseUINameSpaceIterator(getEditSet(),
