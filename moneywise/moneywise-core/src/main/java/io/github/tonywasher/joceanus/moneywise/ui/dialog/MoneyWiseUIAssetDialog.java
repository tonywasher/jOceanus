 ...
 */
public abstract class MoneyWiseUIAssetDialog<T extends MoneyWiseAssetBase>
        extends MoneyWiseUIItemPanel<T> {
    /**
     * Constructor.
     *
     ...
     */
    protected MoneyWiseUIAssetDialog(final TethysUIFactory<?> pFactory,
                                     final PrometheusEditSet pEditSet,
                                     final MoneyWiseUIAssetTable<T> pOwner) {
        /* Initialise the panel */
        super(pFactory, pEditSet, pOwner);
    }

    @Override
    protected MoneyWiseUIAssetTable<T> getOwner() {
        return (MoneyWiseUIAssetTable<T>) super.getOwner();
    }
