 ...
 * @author Tony Washer
 */
public final class MoneyWiseSheetSecurityInfo
     ...
     */
    MoneyWiseSheetSecurityInfo(final PrometheusSheetReader pReader) {
     ...
     */
    MoneyWiseSheetSecurityInfo(final PrometheusSheetWriter pWriter) {
        /* Call super-constructor */
