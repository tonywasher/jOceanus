 ...
 */
public class MoneyWiseUICashCategoryDialog
        extends MoneyWiseUIItemPanel<MoneyWiseCashCategory> {
    /**
     * Constructor.
     *
     ...
     */
    public MoneyWiseUICashCategoryDialog(final TethysUIFactory<?> pFactory,
                                         final PrometheusEditSet pEditSet,
                                         final MoneyWiseUIBaseTable<MoneyWiseCashCategory> pOwner) {
