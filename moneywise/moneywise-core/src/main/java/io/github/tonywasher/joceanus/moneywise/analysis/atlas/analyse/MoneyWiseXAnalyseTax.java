...
import io.github.tonywasher.joceanus.moneywise.analysis.atlas.analyse.MoneyWiseXAnalyse.MoneyWiseXAnalyseSecurityCtl;
    ...
    private void adjustForTaxCredit() throws OceanusException {
        ...
        if (myTaxCredit != null && myTaxCredit.isNonZero()) {
            ...
            if (isIncome) {
                ...
                final MoneyWiseXAnalysisTaxBasisBaseBucket myAccBucket = theTaxBucket.adjustGrossAndTax(theAccount, myTaxCredit);
    ...
    private void adjustForTaxRelief() throws OceanusException {
        ...
        if (myTaxCredit != null && myTaxCredit.isNonZero()) {
            ...
            if (isIncome) {
                ...
                /* Register income and expense for tax */
                final MoneyWiseXAnalysisTaxBasisBaseBucket myAccBucket = theTaxBucket.adjustGrossAndNett(theAccount, myTaxCredit);
    ...
    private void adjustForEmployeeNI() throws OceanusException {
        ...
        if (myNatIns != null && myNatIns.isNonZero()) {
            ...
            if (isIncome) {
                ...
                /* Income for tax */
                final MoneyWiseXAnalysisTaxBasisBaseBucket myAccBucket = theTaxBucket.adjustGrossAndNett(theAccount, myNatIns);
                if (myAccBucket != null) {
                    theState.registerBucketInterest(myAccBucket);
                }
    ...
    private void adjustForEmployerNI() throws OceanusException {
        ...
        if (myNatIns != null && myNatIns.isNonZero()) {
            ...
            if (isIncome) {
                ...
                /* Income for tax */
                final MoneyWiseXAnalysisTaxBasisBaseBucket myAccBucket = theTaxFreeTax.adjustGrossAndNett(theAccount, myNatIns);
                if (myAccBucket != null) {
                    theState.registerBucketInterest(myAccBucket);
                }
    ...
    private void adjustForBenefit() throws OceanusException {
        ...
        if (myBenefit != null && myBenefit.isNonZero()) {
            ...
            if (isIncome) {
                ...
                /* Register income and expense for tax */
                final MoneyWiseXAnalysisTaxBasisBaseBucket myAccBucket = theTaxBucket.adjustGrossAndNett(theAccount, myBenefit);
    ...
    private void adjustForWithheld() throws OceanusException {
        ...
        if (myWithheld != null && myWithheld.isNonZero()) {
            ...
            if (isIncome) {
                ...
                /* Register income and expense for tax */
                final MoneyWiseXAnalysisTaxBasisBaseBucket myAccBucket = theTaxBucket.adjustGrossAndNett(theAccount, myWithheld);
