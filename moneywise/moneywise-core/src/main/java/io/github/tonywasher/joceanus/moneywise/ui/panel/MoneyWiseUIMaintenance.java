 ...
 * @author Tony Washer
 */
public class MoneyWiseUIMaintenance
     ...
     * The Account Panel.
     */
    private final MoneyWiseUIAccountPanel theAccountTab;

    /**
     * The Category Panel.
     */
    private final MoneyWiseUICategoryPanel theCategoryTab;

    /**
     * The Static Panel.
     */
    private final MoneyWiseUIStaticPanel theStatic;
     ...
     */
    MoneyWiseUIMaintenance(final MoneyWiseView pView) {
        /* Store details */
        theView = pView;
     ...
     */
    public void selectMaintenance(final PrometheusGoToEvent<MoneyWiseUIGoToId> pEvent) {
        /* Switch on the subId */
        switch (pEvent.getId()) {
    ...
    private void handleGoToEvent(final OceanusEvent<PrometheusDataEvent> pEvent) {
        /* Access details */
        final PrometheusGoToEvent<MoneyWiseUIGoToId> myEvent = pEvent.getDetails(PrometheusGoToEvent.class);
