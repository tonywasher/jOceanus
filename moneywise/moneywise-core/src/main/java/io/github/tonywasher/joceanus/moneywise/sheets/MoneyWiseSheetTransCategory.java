 ...
 * @author Tony Washer
 */
public final class MoneyWiseSheetTransCategory
     ...
     */
    MoneyWiseSheetTransCategory(final PrometheusSheetReader pReader) {
     ...
     */
    MoneyWiseSheetTransCategory(final PrometheusSheetWriter pWriter) {
        /* Call super constructor */
