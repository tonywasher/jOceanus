 ...
 */
public class MoneyWiseUITableSelect<T extends PrometheusDataItem> {
    /**
     * The table.
     */
     ...
     * The item panel.
     */
    private MoneyWiseUIItemPanel<T> theItemPanel;
     ...
     */
    MoneyWiseUITableSelect(final TethysUITableManager<?, T> pTable,
     ...
     */
    void declareItemPanel(final MoneyWiseUIItemPanel<T> pPanel) {
        theItemPanel = pPanel;
    }
