 ...
 * @author Tony Washer
 */
public final class MoneyWiseSheetAccountInfoType
        extends PrometheusSheetStaticData<MoneyWiseAccountInfoType> {
    /**
     * NamedArea for AccountInfoType.
     */
    public static final String AREA_ACCOUNTINFOTYPES = MoneyWiseAccountInfoType.LIST_NAME;
     ...
     */
    MoneyWiseSheetAccountInfoType(final PrometheusSheetReader pReader) {
     ...
     */
    MoneyWiseSheetAccountInfoType(final PrometheusSheetWriter pWriter) {
        /* Call super-constructor */
