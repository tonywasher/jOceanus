...
import io.github.tonywasher.joceanus.moneywise.ui.controls.MoneyWiseUISpotPricesSelect;
import io.github.tonywasher.joceanus.moneywise.views.MoneyWiseSpotSecurityPrice;
import io.github.tonywasher.joceanus.moneywise.views.MoneyWiseSpotSecurityPrice.MoneyWiseSpotSecurityList;
...
import io.github.tonywasher.joceanus.moneywise.views.MoneyWiseYQLDownloader;
 ...
 */
public class MoneyWiseUIMarketPricesTable
        extends MoneyWiseUIBaseTable<MoneyWiseSpotSecurityPrice> {
    /**
     * The SpotPrices selection panel.
     */
    private final MoneyWiseUISpotPricesSelect theSelect;
     ...
     */
    MoneyWiseUIMarketPricesTable(final MoneyWiseView pView,
        ...
        theSelect = new MoneyWiseUISpotPricesSelect(myGuiFactory, pView);
     ...
     */
    MoneyWiseUISpotPricesSelect getSelect() {
        return theSelect;
    }
    ...
    public static class MoneyWiseSpotPricesPanel
         ...
         * The table.
         */
        private final MoneyWiseUIMarketPricesTable theTable;
        ...
        public MoneyWiseSpotPricesPanel(final MoneyWiseView pView) {
            ...
            /* Create the table */
            theTable = new MoneyWiseUIMarketPricesTable(pView, theEditSet, theError);
