...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUICashCategoryDialog;
 ...
 */
public class MoneyWiseUICashCategoryTable
        extends MoneyWiseUICategoryTable<MoneyWiseCashCategory, MoneyWiseCashCategoryType> {
    /**
     * The Category dialog.
     */
    private final MoneyWiseUICashCategoryDialog theActiveCategory;
     ...
     */
    MoneyWiseUICashCategoryTable(final MoneyWiseView pView,
        ...
        theActiveCategory = new MoneyWiseUICashCategoryDialog(myGuiFactory, pEditSet, this);
