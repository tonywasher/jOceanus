 ...
 */
public class MoneyWiseUIAccountPanel
     ...
     * Deposit Table.
     */
    private final MoneyWiseUIDepositTable theDepositTable;

    /**
     * Cash Table.
     */
    private final MoneyWiseUICashTable theCashTable;

    /**
     * Loan Table.
     */
    private final MoneyWiseUILoanTable theLoanTable;

    /**
     * Portfolio Table.
     */
    private final MoneyWiseUIPortfolioTable thePortfolioTable;

    /**
     * Security Table.
     */
    private final MoneyWiseUISecurityTable theSecurityTable;

    /**
     * Payee Table.
     */
    private final MoneyWiseUIPayeeTable thePayeeTable;
     ...
     */
    MoneyWiseUIAccountPanel(final MoneyWiseView pView) {
        /* Store details */
        theView = pView;
        ...
        thePayeeTable = new MoneyWiseUIPayeeTable(pView, theEditSet, theError);
        theSecurityTable = new MoneyWiseUISecurityTable(pView, theEditSet, theError);
        theDepositTable = new MoneyWiseUIDepositTable(pView, theEditSet, theError);
        theCashTable = new MoneyWiseUICashTable(pView, theEditSet, theError);
        theLoanTable = new MoneyWiseUILoanTable(pView, theEditSet, theError);
        thePortfolioTable = new MoneyWiseUIPortfolioTable(pView, theEditSet, theError);
