 ...
 */
public class MoneyWiseUILoanDialog
        extends MoneyWiseUIAssetDialog<MoneyWiseLoan> {
    /**
     * The fieldSet.
     */
     ...
     */
    public MoneyWiseUILoanDialog(final TethysUIFactory<?> pFactory,
                                 final PrometheusEditSet pEditSet,
                                 final MoneyWiseUIAssetTable<MoneyWiseLoan> pOwner) {
