...
import io.github.tonywasher.joceanus.moneywise.ui.dialog.MoneyWiseUITransCategoryDialog;
 ...
 */
public class MoneyWiseUITransCategoryTable
        extends MoneyWiseUICategoryTable<MoneyWiseTransCategory, MoneyWiseTransCategoryType> {
    /**
     * The Category dialog.
     */
    private final MoneyWiseUITransCategoryDialog theActiveCategory;
     ...
     */
    MoneyWiseUITransCategoryTable(final MoneyWiseView pView,
        ...
        theActiveCategory = new MoneyWiseUITransCategoryDialog(myGuiFactory, pEditSet, this);
