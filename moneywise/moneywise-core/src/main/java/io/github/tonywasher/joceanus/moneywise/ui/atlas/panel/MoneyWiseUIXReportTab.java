...
import io.github.tonywasher.joceanus.moneywise.reports.atlas.MoneyWiseXReportBuilder;
import io.github.tonywasher.joceanus.moneywise.reports.atlas.MoneyWiseXReportStyleSheet;
import io.github.tonywasher.joceanus.moneywise.reports.atlas.MoneyWiseXReportType;
import io.github.tonywasher.joceanus.moneywise.ui.MoneyWiseUIGoToId;
...
import io.github.tonywasher.joceanus.moneywise.ui.atlas.controls.MoneyWiseUIXReportSelect;
...
public class MoneyWiseUIXReportTab
     ...
     */
    private final MoneyWiseUIXReportSelect theSelect;
    ...
    public MoneyWiseUIXReportTab(final MoneyWiseView pView,
        ...
        theSelect = new MoneyWiseUIXReportSelect(myFactory);
    ...
    private void buildReport() throws OceanusException {
        ...
        final MoneyWiseXAnalysisSecurityBucket mySecurity = theSelect.getSecurity();

        /* set lockDown of selection */
        theSelect.setEnabled(true);

        /* Skip if we have no analysis */
        if (theAnalysisMgr.isIdle()) {
            theHTMLPane.setHTMLContent("", "");
            return;
        }

        /* Access the appropriate analysis */
        final MoneyWiseXAnalysis myAnalysis = myReportType.isPointInTime()
                ? theAnalysisMgr.getDatedAnalysis(myRange.getEnd())
    ...
    private void handleGoToRequest(final OceanusEvent<MetisReportEvent> pEvent) {
        ...
        if (MoneyWiseXReportType.ASSETGAINS.equals(theSelect.getReportType())) {
            ...
            final MoneyWiseXAnalysisSecurityBucket myBucket = ((MoneyWiseXAnalysisSecurityFilter) myFilter).getBucket();
            ...
            final MoneyWiseXStatementSelect myStatement = new MoneyWiseXStatementSelect(mySelect, myFilter);

            /* Request the action */
            theEventManager.fireEvent(PrometheusDataEvent.GOTOWINDOW, new PrometheusGoToEvent<>(MoneyWiseUIGoToId.STATEMENT, myStatement));
        }
    }
