 ...
 */
public enum MoneyWiseQPortfolioLineType implements MoneyWiseQLineType {
    /**
     * Date.
     */
    DATE("D"),
     ...
     */
    MoneyWiseQPortfolioLineType(final String pSymbol) {
        /* Store symbol */
        theSymbol = pSymbol;
    }
     ...
     */
    public static MoneyWiseQPortfolioLineType parseLine(final String pLine) {
        /* Loop through the values */
        for (MoneyWiseQPortfolioLineType myType : values()) {
            /* Look for match */
