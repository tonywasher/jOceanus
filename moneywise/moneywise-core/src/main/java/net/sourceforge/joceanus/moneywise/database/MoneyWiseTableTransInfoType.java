 ...
 * @author Tony Washer
 */
public class MoneyWiseTableTransInfoType
        extends PrometheusTableStaticData<MoneyWiseTransInfoType> {
    /**
     * The name of the table.
     */
    protected static final String TABLE_NAME = MoneyWiseTransInfoType.LIST_NAME;
     ...
     */
    protected MoneyWiseTableTransInfoType(final PrometheusDataStore pDatabase) {
