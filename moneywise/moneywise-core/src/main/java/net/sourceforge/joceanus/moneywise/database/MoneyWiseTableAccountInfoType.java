 ...
 * @author Tony Washer
 */
public class MoneyWiseTableAccountInfoType
        extends PrometheusTableStaticData<MoneyWiseAccountInfoType> {
    /**
     * The name of the table.
     */
    protected static final String TABLE_NAME = MoneyWiseAccountInfoType.LIST_NAME;

    /**
     * Constructor.
     * @param pDatabase the database control
     */
    protected MoneyWiseTableAccountInfoType(final PrometheusDataStore pDatabase) {
