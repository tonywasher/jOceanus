 ...
 */
public class MoneyWiseTableCash
        extends PrometheusTableEncrypted<MoneyWiseCash> {
    /**
     * The name of the table.
     */
    protected static final String TABLE_NAME = MoneyWiseCash.LIST_NAME;
     ...
     */
    protected MoneyWiseTableCash(final PrometheusDataStore pDatabase) {
        super(pDatabase, TABLE_NAME);
        final PrometheusTableDefinition myTableDef = getTableDef();

        /* Declare the columns */
        final PrometheusColumnDefinition myCatCol = myTableDef.addReferenceColumn(MoneyWiseBasicResource.CATEGORY_NAME, MoneyWiseTableCashCategory.TABLE_NAME);
    ...
    @Override
    protected void setFieldValue(final MoneyWiseCash pItem,
