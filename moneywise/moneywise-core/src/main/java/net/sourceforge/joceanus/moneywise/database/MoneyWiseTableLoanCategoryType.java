...
/**
 * TableStaticData extension for LoanCategoryType.
 * @author Tony Washer
 */
public class MoneyWiseTableLoanCategoryType
        extends PrometheusTableStaticData<MoneyWiseLoanCategoryType> {
    /**
     * The table name.
     */
    protected static final String TABLE_NAME = MoneyWiseLoanCategoryType.LIST_NAME;

    /**
     * Constructors.
     * @param pDatabase the database control
     */
    protected MoneyWiseTableLoanCategoryType(final PrometheusDataStore pDatabase) {
    ...
    protected void declareData(final PrometheusDataSet pData) {
        ...
        setList(myData.getLoanCategoryTypes());
    }
