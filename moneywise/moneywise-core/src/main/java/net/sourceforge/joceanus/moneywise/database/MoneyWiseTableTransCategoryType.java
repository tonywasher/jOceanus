 ...
 * @author Tony Washer
 */
public class MoneyWiseTableTransCategoryType
        extends PrometheusTableStaticData<MoneyWiseTransCategoryType> {
    /**
     * The name of the CategoryType table.
     */
    protected static final String TABLE_NAME = MoneyWiseTransCategoryType.LIST_NAME;

    /**
     * Constructor.
     * @param pDatabase the database control
     */
    protected MoneyWiseTableTransCategoryType(final PrometheusDataStore pDatabase) {
