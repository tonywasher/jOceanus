 ...
 */
public class MetisEosListEditSession {
    /**
     * The ListSet.
     */
     ...
     */
    private final List<MetisEosListKey> theSessionLists;

    /**
     * The active version lists.
     */
    private final List<MetisEosListKey> theVersionLists;
     ...
     */
    protected MetisEosListEditSession(final MetisEosListSetVersioned pListSet) {
        /* Store parameters */
        theListSet = pListSet;
        theNewVersion = -1;
     ...
     */
    public static void ensureActive(final List<MetisEosListKey> pList,
     ...
     */
    public <T extends MetisFieldVersionedItem> void prepareItemForEdit(final MetisEosListKey pItemType,
                                                                       final T pItem) {
        /* Start editing */
        newVersion();
     ...
     * @return the new item
     */
    public <T extends MetisFieldVersionedItem> T createNewItem(final MetisEosListKey pItemType) {
        /* Start editing */
        newVersion();
        ...
        /* Access the list */
        final MetisEosListVersioned<T> myList = theListSet.getList(pItemType);
     ...
     * @param pItem the item
     */
    public <T extends MetisFieldVersionedItem> void deleteItem(final MetisEosListKey pItemType,
                                                               final T pItem) {
        /* Start editing */
    ...
    public void cancelVersion() {
        ...
        if (activeVersion()) {
            ...
            while (myIterator.hasNext()) {
                ...
                final MetisEosListVersioned<MetisFieldVersionedItem> myList = theListSet.getList(myKey);
     ...
     */
    private <T extends MetisFieldVersionedItem> void doCancelEditVersion(final MetisEosListVersioned<T> pList) {
    ...
    public void commitEditVersion() {
        ...
        if (activeVersion()) {
            ...
            while (myIterator.hasNext()) {
                ...
                /* Commit the edit version */
                final MetisEosListChange<MetisFieldVersionedItem> myChange = doCommitEditVersion(myList);
    ...
    public void commitEditSession() {
        ...
        if (activeSession()) {
            ...
            /* Loop through the lists */
            final Iterator<MetisEosListKey> myIterator = theSessionLists.iterator();
            while (myIterator.hasNext()) {
                final MetisEosListKey myKey = myIterator.next();
                final MetisEosListVersioned<MetisFieldVersionedItem> myList = theListSet.getList(myKey);
     ...
     */
    protected <T extends MetisFieldVersionedItem> void doCommitEditSession(final MetisEosListVersioned<T> pList,
                                                                           final MetisEosListChange<T> pChange,
                                                                           final MetisEosListChange<T> pBaseChange) {
        /* Loop through the list */
        final Iterator<T> myIterator = pList.iterator();
        while (myIterator.hasNext()) {
            final T myCurr = myIterator.next();
     ...
     * @param pItem the item
     */
    private <T extends MetisFieldVersionedItem> void handleCommitOfNewItem(final MetisEosListVersioned<T> pList,
                                                                           final MetisEosListChange<T> pChange,
                                                                           final MetisEosListChange<T> pBaseChange,
                                                                           final T pItem) {
     ...
     * @param pItem the item
     */
    private static <T extends MetisFieldVersionedItem> void handleCommitOfDelNewItem(final MetisEosListVersioned<T> pList,
                                                                                     final MetisEosListChange<T> pChange,
                                                                                     final T pItem) {
     ...
     * @param pItem the item
     */
    private <T extends MetisFieldVersionedItem> void handleCommitOfChangedItem(final MetisEosListVersioned<T> pList,
                                                                               final MetisEosListChange<T> pChange,
                                                                               final MetisEosListChange<T> pBaseChange,
                                                                               final T pItem) {
    ...
    public void reset() {
        ...
        /* Reset the list */
        MetisEosListBaseManager.reset(theListSet);
    }
    ...
    public void reWindToVersion(final int pVersion) {
        ...
        /* Reset the list */
        MetisEosListBaseManager.reWindToVersion(theListSet, pVersion);
    }
}
