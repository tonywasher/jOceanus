...
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedBigDecimal;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedBigInteger;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedBoolean;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedCharArray;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedDate;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedDilution;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedDouble;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedField;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedFloat;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedInteger;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedJavaDate;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedLong;
...
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedRatio;
import net.sourceforge.joceanus.jmetis.data.MetisEncryptedData.MetisEncryptedShort;
...
public class MetisEncryptionGenerator {
    ...
    public MetisEncryptedField<?> encryptValue(final MetisEncryptedField<?> pCurrent,
        ...
        if ((myCurrent != null)
            && (MetisDifference.isEqual(myCurrent.getValue(), pValue))) {
            return pCurrent;
        }
