 ...
 * @author Tony Washer
 */
public class MetisOasisCellAddress {
    /**
     ...
     */
    protected MetisOasisCellAddress(final String pSheetName,
                                    final MetisCellPosition pPosition) {
        /* Store parameters */
     ...
     */
    private static MetisCellPosition parsePosition(final String pAddress) {
        ...
        return new MetisCellPosition(iCol - 1, iRow - 1);
    }
    ...
    public static class OasisCellRange {
         ...
         * The first cell.
         */
        private final MetisOasisCellAddress theFirstCell;

        /**
         * The last cell.
         */
        private final MetisOasisCellAddress theLastCell;
        ...
        public OasisCellRange(final String pSheetName,
            ...
            /* Store parameters */
            theFirstCell = new MetisOasisCellAddress(pSheetName, pFirstCell);
            theLastCell = new MetisOasisCellAddress(pSheetName, pLastCell);
            isSingleCell = false;
            isSingleSheet = true;
        }
         ...
         */
        public OasisCellRange(final String pSheetName,
                              final MetisCellPosition pSingleCell) {
            /* Store parameters */
            theFirstCell = new MetisOasisCellAddress(pSheetName, pSingleCell);
         ...
         * @param pLastCell the last cell
         */
        public OasisCellRange(final MetisOasisCellAddress pFirstCell,
                              final MetisOasisCellAddress pLastCell) {
            /* Store parameters */
         ...
         */
        public OasisCellRange(final MetisOasisCellAddress pSingleCell) {
            /* Store parameters */
        ...
        public OasisCellRange(final String pAddress) {
            ...
            if (isSingleCell) {
                ...
                theFirstCell = new MetisOasisCellAddress(pAddress.substring(0, iSplit));
                if (pAddress.charAt(iSplit + 1) == CHAR_PERIOD) {
                    theLastCell = new MetisOasisCellAddress(theFirstCell.getSheetName(), pAddress.substring(iSplit + 2));
                    isSingleSheet = true;
                } else {
                    theLastCell = new MetisOasisCellAddress(pAddress.substring(iSplit + 1));
                    isSingleSheet = false;
                }
            }
        }
         ...
         * @return the address
         */
        public MetisOasisCellAddress getFirstCell() {
            return theFirstCell;
        }
         ...
         * @return the address
         */
        public MetisOasisCellAddress getLastCell() {
            return theLastCell;
        }
