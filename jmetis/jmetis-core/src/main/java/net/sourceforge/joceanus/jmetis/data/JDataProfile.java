...
public class JDataProfile
     ...
     * Task Field Id.
     */
    private static final JDataField FIELD_TASK = FIELD_DEFS.declareLocalField(DataResource.PROFILE_TASK.getValue());

    /**
     * Status Field Id.
     */
    private static final JDataField FIELD_STATUS = FIELD_DEFS.declareLocalField(DataResource.PROFILE_STATUS.getValue());

    /**
     * Elapsed Field Id.
     */
    private static final JDataField FIELD_ELAPSED = FIELD_DEFS.declareLocalField(DataResource.PROFILE_ELAPSED.getValue());

    /**
     * Hidden Field Id.
     */
    private static final JDataField FIELD_HIDDEN = FIELD_DEFS.declareLocalField(DataResource.PROFILE_HIDDEN.getValue());
