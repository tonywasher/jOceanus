...
/**
 * Provides the implementation of a error buffer for an object that implements MetisDataFieldItem.
 * Each element represents an error that relates to a field.
 */
public class MetisDataValidation
    ...
    private void allocateNewFields() {
        theLocalFields = new MetisDataFieldSet(MetisDataValidation.class.getSimpleName());
    }
