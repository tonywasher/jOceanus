...
import net.sourceforge.joceanus.jmetis.data.MetisDataObject.MetisDataDiffers;

/**
 * Difference enum and utility.
 * @author Tony Washer
 */
public enum MetisDifference {
    /**
     * Identical.
     */
    IDENTICAL,
     ...
     */
    public MetisDifference combine(final MetisDifference pThat) {
        switch (this) {
            case IDENTICAL:
                return pThat;
            case SECURITY:
     ...
     */
    public static MetisDifference getDifference(final Object pCurr,
                                                final Object pNew) {
        /* Handle identity */
        if (pCurr == pNew) {
            return IDENTICAL;
