 ...
 * @author Tony Washer
 */
public abstract class MetisViewerEntry {
    /**
     ...
     */
    public abstract void addAsChildOf(final MetisViewerEntry pParent);

    /**
     * Add as a child into the tree.
     * @param pParent the parent object
     */
    public abstract void addAsFirstChildOf(final MetisViewerEntry pParent);
        ...
        if (MetisDataContents.class.isInstance(pObject)) {
            ...
            while (myIterator.hasNext()) {
                ...
                if ((myValue instanceof List)
                    ...
                    if (!myList.isEmpty()) {
                        /* Add as a child */
                        MetisViewerEntry myEntry = theManager.newEntry(myField.getName());
