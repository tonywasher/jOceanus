...
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceResource;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet.MetisBooleanPreference;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet.MetisByteArrayPreference;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet.MetisCharArrayPreference;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet.MetisDatePreference;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet.MetisEnumPreference;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet.MetisIntegerPreference;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet.MetisPreferenceItem;
import net.sourceforge.joceanus.jmetis.atlas.preference.MetisPreferenceSet.MetisStringPreference;
