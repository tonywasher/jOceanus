 ...
 */
public class MetisOrderedListSpliterator<T extends Comparable<? super T>>
     ...
     * Index map.
     */
    private final MetisOrderedIndex<T> theIndexMap;
     ...
     */
    protected MetisOrderedListSpliterator(final MetisOrderedList<T> pList) {
        theList = pList;
     ...
     */
    private MetisOrderedListSpliterator(final MetisOrderedListSpliterator<T> pBase,
                                        final int pSplit) {
