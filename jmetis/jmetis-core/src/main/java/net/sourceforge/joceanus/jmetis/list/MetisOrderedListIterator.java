 ...
 */
public class MetisOrderedListIterator<T extends Comparable<? super T>>
     ...
     */
    protected MetisOrderedListIterator(final MetisOrderedList<T> pList) {
        theList = pList;
     ...
     */
    protected MetisOrderedListIterator(final MetisOrderedList<T> pList,
                                       final MetisOrderedNode<T> pNode) {
     ...
     */
    private MetisOrderedNode<T> nextNode() {
     ...
     */
    private MetisOrderedNode<T> previousNode() {
