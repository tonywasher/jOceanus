 ...
 */
public class MetisDataView
        implements Iterable<MetisDataRow> {
    /**
     * Underlying Sheet.
     */
     ...
     * Base Cell Position.
     */
    private final MetisCellPosition theBaseCell;
     ...
     */
    protected MetisDataView(final MetisDataSheet pSheet,
     ...
     * @param pLastCell the last cell of the view
     */
    protected MetisDataView(final MetisDataCell pFirstCell,
                            final MetisDataCell pLastCell) {
        /* Store parameters */
     ...
     */
    public MetisCellPosition getBaseCell() {
        return theBaseCell;
    }
    ...
    @Override
    public Iterator<MetisDataRow> iterator() {
    ...
    @Override
    public Spliterator<MetisDataRow> spliterator() {
    ...
    private static class RowIterator
            implements Iterator<MetisDataRow> {
        /**
         * The data view.
         */
         ...
         * The last row.
         */
        private MetisDataRow theLastRow;

        /**
         * Constructor.
         * @param pView the underlying view.
         */
        protected RowIterator(final MetisDataView pView) {
            theLastRow = null;
            theView = pView;
        ...
        @Override
        public void forEachRemaining(final Consumer<? super MetisDataRow> pAction) {
            while (hasNext()) {
                pAction.accept(next());
            }
        }
    ...
    private static class RowSpliterator
            implements Spliterator<MetisDataRow> {
        /**
         ...
         * @param pView the underlying view.
         */
        protected RowSpliterator(final MetisDataView pView) {
            theLastRow = null;
            theView = pView;
            theCurrIndex = 0;
        ...
        @Override
        public boolean tryAdvance(final Consumer<? super MetisDataRow> pAction) {
            if (hasNext()) {
                pAction.accept(next());
                return true;
            }
        ...
        @Override
        public Comparator<? super MetisDataRow> getComparator() {
