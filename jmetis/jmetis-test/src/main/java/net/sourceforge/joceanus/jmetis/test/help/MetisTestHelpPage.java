 ...
 * HelpPageIds.
 */
public enum MetisTestHelpPage implements MetisHelpId {
    /**
     * Deposits.
     */
     ...
     */
    MetisTestHelpPage(final String pSource) {
        theSource = pSource;
    }
    ...
    public InputStream getInputStream() {
        return MetisTestHelpPage.class.getResourceAsStream(theSource);
    }
}
