...
public class SwingViewerEntry
    ...
    @Override
    protected SwingViewerManager getManager() {
        return (SwingViewerManager) super.getManager();
    }

    @Override
    public void addAsChildOf(final ViewerEntry pParent) {
        /* If this is a swing entry */
        if (pParent instanceof SwingViewerEntry) {
            /* Add as child of parent */
            SwingViewerEntry myParent = (SwingViewerEntry) pParent;
    ...
    public void addAsRootChild() {
        ...
        SwingViewerEntry myRoot = getManager().getRoot();
