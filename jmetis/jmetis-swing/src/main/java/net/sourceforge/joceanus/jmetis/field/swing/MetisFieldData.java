...
public final class MetisFieldData {
     ...
     * RenderState.
     */
    private MetisFieldState theState;
    ...
    protected MetisFieldData(final MetisFieldManager pManager,
        ...
        /* Initialise defaults */
        theForeGround = theManager.getForeground(MetisFieldState.NORMAL);
        theBackGround = theManager.getStandardBackground();
        theFont = theManager.determineFont(MetisFieldState.NORMAL, false);
    }
     ...
     * @return the state
     */
    public MetisFieldState getState() {
        return theState;
    }
    ...
    public void setDefaults() {
        ...
        theForeGround = theManager.getForeground(MetisFieldState.NORMAL);
        theBackGround = theManager.getStandardBackground();
        theFont = theManager.determineFont(MetisFieldState.NORMAL, isFixed);
        theToolTipText = null;
    }
