 ...
 * @author Tony Washer
 */
public class MetisFileSelector
     ...
     * Logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(MetisFileSelector.class);
     ...
     */
    public MetisFileSelector(final Component pParent,
                             final String pTitle,
