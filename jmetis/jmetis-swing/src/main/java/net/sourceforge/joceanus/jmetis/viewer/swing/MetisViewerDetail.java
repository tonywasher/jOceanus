 ...
 * @author Tony Washer
 */
public class MetisViewerDetail {
    /**
     * Buffer length.
     */
     ...
     * link title.
     */
    private static final String LINK_TITLE = MetisViewerResource.VIEWER_LINK_TITLE.getValue();

    /**
     * Forward link.
     */
    private static final String LINK_FORWARD = MetisViewerResource.VIEWER_LINK_FORWARD.getValue();

    /**
     * Backward link.
     */
    private static final String LINK_BACKWARD = MetisViewerResource.VIEWER_LINK_BACKWARD.getValue();
     ...
     * the partner detail.
     */
    private MetisViewerDetail thePartnerDetail;
     ...
     * The forward link.
     */
    private MetisViewerDetail theForward = null;

    /**
     * The backwards link.
     */
    private MetisViewerDetail theBackward = null;
     ...
     * HTML formatter.
     */
    private MetisViewerHTML theFormatter = null;
     ...
     */
    protected MetisViewerDetail(final MetisViewerHTML pFormatter,
        ...
        thePartnerDetail = isList()
                                    ? new MetisViewerDetail(this, theIterator.next())
                                    : null;
    }
     ...
     * @param pObject the object represented
     */
    protected MetisViewerDetail(final MetisViewerDetail pList,
                                final Object pObject) {
        /* Obtain the detail for this object */
     ...
     */
    protected MetisViewerDetail getPartnerDetail() {
     ...
     */
    private MetisViewerDetail setForwardLink(final MetisViewerDetail pLink) {
     ...
     */
    private void setBackwardLink(final MetisViewerDetail pLink) {
        /* Pass call on if we are a child */
        if (isChild) {
    ...
    protected void shiftIterator(final int iNumSteps) {
        ...
        if (myNumSteps > 0) {
            ...
            thePartnerDetail = new MetisViewerDetail(this, myNext);
     ...
     */
    protected MetisViewerDetail getDataLink(final String pName) {
        ...
        if (myLink != null) {
            ...
            MetisViewerDetail myDetail = setForwardLink(new MetisViewerDetail(theFormatter, myLink.theObject));
    ...
    public String addDataLink(final Object pItem,
        ...
        Object myItem = pItem;
        MetisDifference myDifference = MetisDifference.IDENTICAL;
        if (myItem instanceof MetisDataDifference) {
            /* Access the difference */
            MetisDataDifference myDiffer = (MetisDataDifference) pItem;
        ...
        if (myItem == null) {
            return MetisViewerHTML.formatHTMLChange(pText, myDifference);
        }
        ...
        if (myDifference.isDifferent()) {
            ...
            myBuilder.append(MetisViewerHTML.CLASS_CHANGED);
            myBuilder.append("\"");
        }
        myBuilder.append(">");
    ...
    private static final class ViewerLink {
         ...
         */
        private ViewerLink(final MetisViewerDetail pDetail,
                           final Object pObject) {
            /* Store object */
            theObject = pObject;
