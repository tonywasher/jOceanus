 ...
 * $URL: http://localhost/svn/Finance/jOceanus/trunk/jmetis/jmetis-core/src/main/java/net/sourceforge/joceanus/jmetis/service/sheet/jopen/MetisJOpenRow.java $
 * $Revision: 923 $
 * $Author: Tony $
...
public class MetisJOpenRow
    ...
    protected <T> T parseValue(final String pSource,
        ...
        final TethysDataFormatter myFormatter = theJOpenSheet.getDataFormatter();
