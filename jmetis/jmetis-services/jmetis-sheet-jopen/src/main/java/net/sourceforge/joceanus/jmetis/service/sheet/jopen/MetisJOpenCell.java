 ...
 * $URL: http://localhost/svn/Finance/jOceanus/trunk/jmetis/jmetis-core/src/main/java/net/sourceforge/joceanus/jmetis/service/sheet/jopen/MetisJOpenCell.java $
 * $Revision: 923 $
 * $Author: Tony $
...
public class MetisJOpenCell
    ...
    private <T> T parseValue(final String pSource,
        ...
        try {
            ...
            final MetisSheetCellAddress myAddress = new MetisSheetCellAddress(theJOpenRow.getSheet().getName(), getPosition());
