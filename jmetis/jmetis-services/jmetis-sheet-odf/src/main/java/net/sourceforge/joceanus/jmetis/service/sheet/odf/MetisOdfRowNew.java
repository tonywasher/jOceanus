...
public class MetisOdfRowNew
     ...
     */
    MetisOdfRowNew(final MetisOdfRowStore pStore,
    ...
    @Override
    public MetisOdfRowNew getNextRow() {
        return theStore.getReadOnlyRowByIndex(getSheet(), getRowIndex() + 1);
    }

    @Override
    public MetisOdfRowNew getPreviousRow() {
        return theStore.getReadOnlyRowByIndex(getSheet(), getRowIndex() - 1);
    }
    ...
    @Override
    public MetisOdfCellNew getReadOnlyCellByIndex(final int pIndex) {
        return theStore.getReadOnlyCellByIndex(this, pIndex);
    }

    @Override
    protected MetisOdfCellNew getWriteableCellByIndex(final int pIndex) {
