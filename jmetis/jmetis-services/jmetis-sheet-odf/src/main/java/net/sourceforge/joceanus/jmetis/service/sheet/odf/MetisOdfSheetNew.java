...
public class MetisOdfSheetNew
     ...
     */
    MetisOdfSheetNew(final MetisOdfWorkBook pBook,
    ...
    @Override
    public MetisOdfRowNew getReadOnlyRowByIndex(final int pRowIndex) {
        return theSheet.getReadOnlyRowByIndex(this, pRowIndex);
    }

    @Override
    public MetisOdfRowNew getMutableRowByIndex(final int pRowIndex) {
        return isReadOnly()
               ? null
    ...
    @Override
    public MetisOdfColumnNew getReadOnlyColumnByIndex(final int pColIndex) {
        return theSheet.getReadOnlyColumnByIndex(this, pColIndex);
    }

    @Override
    public MetisOdfColumnNew getMutableColumnByIndex(final int pColIndex) {
        return isReadOnly()
               ? null
