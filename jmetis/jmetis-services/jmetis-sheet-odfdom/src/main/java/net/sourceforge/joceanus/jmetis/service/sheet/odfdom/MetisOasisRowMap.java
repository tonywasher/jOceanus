 ...
 * $URL: http://localhost/svn/Finance/jOceanus/trunk/jmetis/jmetis-core/src/main/java/net/sourceforge/joceanus/jmetis/service/sheet/odfdom/MetisOasisRowMap.java $
 * $Revision: 923 $
 * $Author: Tony $
...
public class MetisOasisRowMap {
     ...
     */
    protected MetisOasisRowMap(final MetisOasisSheet pSheet,
                               final int pInitCols) {
        /* Store parameters */
     ...
     * @return the row
     */
    protected MetisOasisRow getReadOnlyRowByIndex(final int pRowIndex) {
     ...
     * @return the row
     */
    protected MetisOasisRow getMutableRowByIndex(final int pRowIndex) {
        /* Handle negative row index */
        if (pRowIndex < 0) {
            return null;
        }
    ...
    private static boolean isEmpty(final TableTableRowElement pElement) {
        ...
        if (myChild != null) {
            ...
            if ((!(myChild instanceof TableTableCellElement))
                || (!MetisOasisCellMap.isEmpty((TableTableCellElement) myChild))) {
                return false;
            }
        }
    ...
    private final class RowReference {
         ...
         */
        private MetisOasisRow getMutableRow() {
            ...
            return new MetisOasisRow(MetisOasisRowMap.this, theElement, theIndex, false);
        }
         ...
         * @return the row representation
         */
        private MetisOasisRow getReadOnlyRow() {
            /* Create and return the row object */
            return new MetisOasisRow(MetisOasisRowMap.this, theElement, theIndex, true);
        }
