 ...
 * $URL: http://localhost/svn/Finance/jOceanus/trunk/jmetis/jmetis-core/src/main/java/net/sourceforge/joceanus/jmetis/service/sheet/odfdom/MetisOasisRow.java $
 * $Revision: 923 $
 * $Author: Tony $
 ...
 * @author Tony Washer
 */
public class MetisOasisRow
        extends MetisSheetRow {
    /**
     * The list of rows.
     */
    private final MetisOasisRowMap theRowMap;
     ...
     */
    protected MetisOasisRow(final MetisOasisRowMap pMap,
        ...
        /* Create the cell map */
        theCellMap = new MetisOasisCellMap(this);
    }

    @Override
    public MetisOasisSheet getSheet() {
        return (MetisOasisSheet) super.getSheet();
    }

    @Override
    public MetisOasisRow getNextRow() {
        return theRowMap.getReadOnlyRowByIndex(getRowIndex() + 1);
    }

    @Override
    public MetisOasisRow getPreviousRow() {
        return theRowMap.getReadOnlyRowByIndex(getRowIndex() - 1);
    }
    ...
    @Override
    public MetisOasisCell getReadOnlyCellByIndex(final int pIndex) {
        return theCellMap.getReadOnlyCellByIndex(pIndex);
    }

    @Override
    public MetisOasisCell getMutableCellByIndex(final int pIndex) {
        return isReadOnly
                          ? null
