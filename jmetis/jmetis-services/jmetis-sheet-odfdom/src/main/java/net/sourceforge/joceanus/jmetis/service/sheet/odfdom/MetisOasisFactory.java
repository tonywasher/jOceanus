 ...
 * $URL: http://localhost/svn/Finance/jOceanus/trunk/jmetis/jmetis-core/src/main/java/net/sourceforge/joceanus/jmetis/service/sheet/odfdom/MetisOasisFactory.java $
 * $Revision: 923 $
 * $Author: Tony $
...
/**
 * Factory to load/initialise an Oasis ODFDOM WorkBook.
 */
@MetisSheetService(MetisSheetWorkBookType.OASISODS)
public class MetisOasisFactory
        implements MetisSheetFactory {
    @Override
    public MetisSheetWorkBook loadFromStream(final InputStream pInput) throws OceanusException {
        return new MetisOasisWorkBook(pInput);
    }

    @Override
    public MetisSheetWorkBook newWorkBook() throws OceanusException {
        return new MetisOasisWorkBook();
    }
}
