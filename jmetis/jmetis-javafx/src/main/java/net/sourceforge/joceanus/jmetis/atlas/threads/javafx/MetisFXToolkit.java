...
public class MetisFXToolkit
    ...
    @Override
    public <R extends MetisDataTableItem> MetisFXTableManager<R> newTableManager(final MetisIndexedList<R> pList) {
        return new MetisFXTableManager<>(getGuiFactory(), pList);
    }
}
