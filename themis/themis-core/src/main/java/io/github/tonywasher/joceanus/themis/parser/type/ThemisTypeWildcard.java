 ...
 */
public class ThemisTypeWildcard
        extends ThemisBaseType<WildcardType> {
    /**
     * The extended type.
     */
    private final ThemisTypeInstance theExtended;

    /**
     * The super type.
     */
    private final ThemisTypeInstance theSuper;
     ...
     */
    ThemisTypeWildcard(final ThemisParserDef pParser,
     ...
     * @return the extended
     */
    public ThemisTypeInstance getExtended() {
        return theExtended;
    }
     ...
     * @return the super
     */
    public ThemisTypeInstance getSuper() {
        return theSuper;
    }
