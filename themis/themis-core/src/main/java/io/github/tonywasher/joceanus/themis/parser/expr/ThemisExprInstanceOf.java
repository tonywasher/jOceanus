 ...
 */
public class ThemisExprInstanceOf
        extends ThemisBaseExpression<InstanceOfExpr> {
    /**
     * The name.
     */
     ...
     * The pattern.
     */
    private final ThemisExpressionInstance thePattern;
     ...
     */
    ThemisExprInstanceOf(final ThemisParserDef pParser,
     ...
     * @return the pattern
     */
    public ThemisExpressionInstance getPattern() {
        return thePattern;
    }
}
