...
public enum ThemisStatement
     ...
     */
    ThemisStatement(final Predicate<Statement> pTester) {
        theTester = pTester;
    }
     ...
     */
    public static ThemisStatement determineStatement(final ThemisParserDef pParser,
                                                     final Statement pStatement) throws OceanusException {
        /* Loop testing each statement type */
        for (ThemisStatement myType : values()) {
