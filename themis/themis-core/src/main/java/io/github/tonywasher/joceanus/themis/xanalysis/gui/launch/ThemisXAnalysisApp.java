 ...
 */
public class ThemisXAnalysisApp
     ...
     * Constructor.
     */
    public ThemisXAnalysisApp() {
        super(ThemisXAnalysisApp.class.getResourceAsStream("ThemisApp.properties"));
    }

    @Override
    public TethysUIIconId[] getIcons() {
        return new TethysUIIconId[]
                {ThemisXAnalysisUIIcon.SMALL, ThemisXAnalysisUIIcon.BIG};
    }

    @Override
    public TethysUIIconId getSplash() {
        return ThemisXAnalysisUIIcon.SPLASH;
    }
    ...
    public TethysUIMainPanel createMainPanel(final TethysUIFactory<?> pFactory) throws OceanusException {
        return new ThemisXAnalysisUIMainPanel(pFactory);
    }
}
