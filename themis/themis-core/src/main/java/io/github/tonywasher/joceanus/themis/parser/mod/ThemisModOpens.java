 ...
 * Module Exports.
 */
public class ThemisModOpens
        extends ThemisBaseModule<ModuleOpensDirective> {
    /**
     * The Opended.
     */
    private final ThemisNodeInstance theOpen;
     ...
     */
    ThemisModOpens(final ThemisParserDef pParser,
     ...
     * @return the targets
     */
    public List<ThemisNodeInstance> getTargets() {
        return theTargets;
    }
}
