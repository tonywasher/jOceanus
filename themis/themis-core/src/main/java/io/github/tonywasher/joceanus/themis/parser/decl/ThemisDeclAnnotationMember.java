 ...
 */
public class ThemisDeclAnnotationMember
        extends ThemisBaseDeclaration<AnnotationMemberDeclaration> {
    /**
     * The name.
     */
     ...
     */
    ThemisDeclAnnotationMember(final ThemisParserDef pParser,
