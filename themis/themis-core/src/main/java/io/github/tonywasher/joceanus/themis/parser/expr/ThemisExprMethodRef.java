 ...
 */
public class ThemisExprMethodRef
        extends ThemisBaseExpression<MethodReferenceExpr> {
    /**
     * The name.
     */
     ...
     * The typeArguments.
     */
    private final List<ThemisTypeInstance> theTypeArgs;
     ...
     */
    ThemisExprMethodRef(final ThemisParserDef pParser,
     ...
     * @return the typeArgs
     */
    public List<ThemisTypeInstance> getTypeArgs() {
        return theTypeArgs;
    }
}
