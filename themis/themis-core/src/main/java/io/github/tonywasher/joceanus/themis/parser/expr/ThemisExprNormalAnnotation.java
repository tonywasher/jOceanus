 ...
 */
public class ThemisExprNormalAnnotation
        extends ThemisBaseExpression<NormalAnnotationExpr> {
    /**
     ...
     * The value pairs.
     */
    private final List<ThemisNodeInstance> thePairs;
     ...
     */
    ThemisExprNormalAnnotation(final ThemisParserDef pParser,
     ...
     * @return the pairs
     */
    public List<ThemisNodeInstance> getPairs() {
        return thePairs;
    }
}
