 ...
 * Labeled Statement.
 */
public class ThemisStmtLabeled
        extends ThemisBaseStatement<LabeledStmt> {
    /**
     * The label.
     */
     ...
     * The contents.
     */
    private final ThemisStatementInstance theLabeled;
     ...
     */
    ThemisStmtLabeled(final ThemisParserDef pParser,
     ...
     */
    public ThemisStatementInstance getLabeled() {
        return theLabeled;
    }
}
