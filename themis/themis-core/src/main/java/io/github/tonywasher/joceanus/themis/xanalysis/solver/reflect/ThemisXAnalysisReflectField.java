 ...
 */
public class ThemisXAnalysisReflectField
     ...
     */
    ThemisXAnalysisReflectField(final Field pField) {
        /* Store the field */
        theField = pField;

        /* Set the modifiers */
        setModifiers(ThemisXAnalysisReflectUtils.buildModifiers(theField));

        /* Set the variable */
        final NodeList<VariableDeclarator> myVarList = new NodeList<>();
        myVarList.add(new ThemisXAnalysisReflectVar(theField));
