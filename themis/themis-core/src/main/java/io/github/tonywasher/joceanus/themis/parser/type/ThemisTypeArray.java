 ...
 */
public class ThemisTypeArray
        extends ThemisTypeReference<ArrayType> {
    /**
     * The underlying type.
     */
    private final ThemisTypeInstance theUnderlying;
     ...
     */
    ThemisTypeArray(final ThemisParserDef pParser,
     ...
     * @return the type
     */
    public ThemisTypeInstance getUnderlying() {
