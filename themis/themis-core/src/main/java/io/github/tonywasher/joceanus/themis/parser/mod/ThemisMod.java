...
public enum ThemisMod
     ...
     */
    ThemisMod(final Predicate<Node> pTester) {
        theTester = pTester;
    }
     ...
     */
    public static ThemisMod determineModule(final ThemisParserDef pParser,
                                            final Node pMod) throws OceanusException {
        /* Loop testing each node type */
        for (ThemisMod myMod : values()) {
