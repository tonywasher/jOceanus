 ...
 */
public class ThemisReflectClass
     ...
     */
    ThemisReflectClass(final Class<?> pClazz) throws OceanusException {
        /* Store the class */
        theClass = pClazz;
        ...
        setExtendedTypes(ThemisReflectUtils.buildExtended(theClass));
