 ...
 */
public class ThemisExprBinary
        extends ThemisBaseExpression<BinaryExpr> {
    /**
     * The left.
     */
    private final ThemisExpressionInstance theLeft;
     ...
     * The right.
     */
    private final ThemisExpressionInstance theRight;
     ...
     */
    ThemisExprBinary(final ThemisParserDef pParser,
     ...
     * @return the right
     */
    public ThemisExpressionInstance getLeft() {
        return theLeft;
    }
     ...
     * @return the right
     */
    public ThemisExpressionInstance getRight() {
        return theRight;
    }
}
