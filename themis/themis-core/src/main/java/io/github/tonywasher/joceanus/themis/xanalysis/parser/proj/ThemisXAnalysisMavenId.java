...
public final class ThemisXAnalysisMavenId {
     ...
     * ElementParser.
     */
    interface ThemisXAnalysisElementParser {
        /**
     ...
     */
    ThemisXAnalysisMavenId(final ThemisXAnalysisElementParser pParser,
    ...
    private void getLatestVersion() {
        ...
        ThemisXAnalysisMavenVersion myLatest = null;
        for (File myFile : Objects.requireNonNull(myBase.listFiles())) {
            if (myFile.isDirectory()) {
                final ThemisXAnalysisMavenVersion myVersion = ThemisXAnalysisMavenVersion.parseVersion(myFile.getName());
                if (myVersion != null) {
                    if (myLatest == null
