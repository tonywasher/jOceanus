...
public enum ThemisType
     ...
     */
    ThemisType(final Predicate<Type> pTester) {
        theTester = pTester;
    }
     ...
     */
    public static ThemisType determineType(final ThemisParserDef pParser,
                                           final Type pType) throws OceanusException {
        /* Loop testing each type */
        for (ThemisType myType : values()) {
