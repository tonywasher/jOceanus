 ...
 * Import.
 */
public class ThemisNodeImport
        extends ThemisBaseNode<ImportDeclaration> {
    /**
     ...
     * The Import.
     */
    private final ThemisNodeInstance theImport;
     ...
     */
    ThemisNodeImport(final ThemisParserDef pParser,
                     final ImportDeclaration pImport) throws OceanusException {
        super(pParser, pImport);
        theImport = pParser.parseNode(pImport.getName());
        final ThemisNodeName myName = (ThemisNodeName) theImport;
        theShortName = myName.getName();
        final ThemisNodeName myQualifier = ((ThemisNodeName) myName.getQualifier());
     ...
     * @return the import
     */
    public ThemisNodeInstance getImport() {
        return theImport;
    }
}
