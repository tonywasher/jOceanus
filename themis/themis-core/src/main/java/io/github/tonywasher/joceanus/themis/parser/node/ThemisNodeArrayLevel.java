 ...
 */
public class ThemisNodeArrayLevel
        extends ThemisBaseNode<ArrayCreationLevel> {
    /**
     * The Level.
     */
    private final ThemisExpressionInstance theLevel;
     ...
     */
    ThemisNodeArrayLevel(final ThemisParserDef pParser,
