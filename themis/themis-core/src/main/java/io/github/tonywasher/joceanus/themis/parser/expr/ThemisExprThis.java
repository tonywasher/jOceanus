 ...
 */
public class ThemisExprThis
        extends ThemisBaseExpression<ThisExpr> {
    /**
     * The type name.
     */
    private final ThemisNodeInstance theTypeName;
     ...
     */
    ThemisExprThis(final ThemisParserDef pParser,
     ...
     * @return the name
     */
    public ThemisNodeInstance getTypeName() {
        return theTypeName;
    }
}
