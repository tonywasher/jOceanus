 ...
 */
public class ThemisXAnalysisUIStatsDocument
     ...
     */
    ThemisXAnalysisUIStatsDocument() throws OceanusException {
        super();
    }
     ...
     */
    public String formatElement(final ThemisXAnalysisStatsElement pElement) {
        /* Create new document and obtain the body */
        final Element myBody = newDocument();

        /* Access the stats and create the tables */
        final ThemisXAnalysisStats myStats = pElement.getStats();
