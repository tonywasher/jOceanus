 ...
 * Compilation Unit.
 */
public class ThemisNodeCompilationUnit
        extends ThemisBaseNode<CompilationUnit> {
    /**
     * The Package.
     */
    private final ThemisNodeInstance thePackageDef;

    /**
     * The Imports.
     */
    private final List<ThemisNodeInstance> theImports;

    /**
     * The Contents.
     */
    private final ThemisClassInstance theContents;
     ...
     */
    ThemisNodeCompilationUnit(final ThemisParserDef pParser,
        ...
        theContents = (ThemisClassInstance) pParser.parseDeclaration(pUnit.getType(0));
    }
     ...
     * @return the package
     */
    public ThemisNodeInstance getPackage() {
     ...
     * @return the imports
     */
    public List<ThemisNodeInstance> getImports() {
        return theImports;
    }
     ...
     * @return the contents
     */
    public ThemisClassInstance getContents() {
        return theContents;
    }
}
