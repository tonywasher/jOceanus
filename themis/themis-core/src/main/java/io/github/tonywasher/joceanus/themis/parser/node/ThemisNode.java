...
public enum ThemisNode
     ...
     */
    ThemisNode(final Predicate<Node> pTester) {
        theTester = pTester;
    }
     ...
     */
    public static ThemisNode determineNode(final ThemisParserDef pParser,
                                           final Node pNode) throws OceanusException {
        /* Loop testing each node type */
        for (ThemisNode myNode : values()) {
