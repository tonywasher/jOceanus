...
public enum ThemisExpression
     ...
     */
    ThemisExpression(final Predicate<Expression> pTester) {
        theTester = pTester;
    }
     ...
     */
    public static ThemisExpression determineExpression(final ThemisParserDef pParser,
                                                       final Expression pExpr) throws OceanusException {
        /* Loop testing each expr type */
        for (ThemisExpression myExpr : values()) {
