 ...
 * Module Exports.
 */
public class ThemisModExports
        extends ThemisBaseModule<ModuleExportsDirective> {
    /**
     * The Export.
     */
    private final ThemisNodeInstance theExport;

    /**
     * The Targets.
     */
    private final List<ThemisNodeInstance> theTargets;
     ...
     */
    ThemisModExports(final ThemisParserDef pParser,
     ...
     * @return the targets
     */
    public List<ThemisNodeInstance> getNames() {
        return theTargets;
    }
}
