...
public class PatternNew
     ...
     */
    public static final String OBJECT_NAME = PatternNew.class.getSimpleName();
    ...
    @Override
    public PatternNew getBase() {
        return (PatternNew) super.getBase();
    }
     ...
     */
    protected PatternNew(final PatternNewList pList,
                         final PatternNew pPattern) {
     ...
     * @param pList the list
     */
    public PatternNew(final PatternNewList pList) {
        /* Initialise as Event */
        super(pList);
     ...
     */
    private PatternNew(final PatternNewList pList,
                       final Integer uId,
     ...
     * @throws JDataException on error
     */
    public EventNew nextEvent(final EventNewList pEvents,
        ...
        EventNew myEvent = new EventNew(pEvents, this);
    ...
    public static class PatternNewList
            extends EventBaseList<PatternNew>
            implements EventDateRange {
        /**
         * Local Report fields.
         */
        protected static final JDataFields FIELD_DEFS = new JDataFields(PatternNewList.class.getSimpleName(), DataList.FIELD_DEFS);
         ...
         */
        protected PatternNewList(final FinanceData pData) {
            super(pData, PatternNew.class);
        }
         ...
         */
        private PatternNewList(final PatternNewList pSource) {
            super(pSource);
        }

        @Override
        protected PatternNewList getEmptyList(final ListStyle pStyle) {
            PatternNewList myList = new PatternNewList(this);
            myList.setStyle(pStyle);
            return myList;
        }

        @Override
        public PatternNewList cloneList(final DataSet<?> pDataSet) {
            return (PatternNewList) super.cloneList(pDataSet);
        }

        @Override
        public PatternNewList deriveList(final ListStyle pStyle) {
            return (PatternNewList) super.deriveList(pStyle);
        }

        @Override
        public PatternNewList deriveDifferences(final DataList<PatternNew> pOld) {
            return (PatternNewList) super.deriveDifferences(pOld);
        }
         ...
         */
        public PatternNewList deriveEditList(final Account pAccount) {
            /* Build an empty Update */
            PatternNewList myList = getEmptyList(ListStyle.EDIT);
            myList.theAccount = pAccount;

            /* Access the list iterator */
            Iterator<PatternNew> myIterator = listIterator();
            ...
            while (myIterator.hasNext()) {
                ...
                /* Copy the item */
                PatternNew myItem = new PatternNew(myList, myCurr);
         ...
         */
        @Override
        public PatternNew addCopyItem(final DataItem pPattern) {
            /* Can only clone from Pattern */
            if (!(pPattern instanceof PatternNew)) {
                return null;
            }

            PatternNew myPattern = new PatternNew(this, (PatternNew) pPattern);
            add(myPattern);
            return myPattern;
        }
         ...
         */
        @Override
        public PatternNew addNewItem() {
            PatternNew myPattern = new PatternNew(this);
        ...
        public void addOpenItem(final Integer uId,
            ...
            PatternNew myPattern = new PatternNew(this, uId, pDate, pDesc, myDebit, myCredit, myTransType, pAmount, myFrequency);
        ...
        public void addSecureItem(final Integer uId,
                                  ...
                                  final Integer uFreqId) throws JDataException {
            /* Create the new pattern */
            PatternNew myPattern = new PatternNew(this, uId, uControlId, pDate, pDesc, uDebitId, uCreditId, uTransId, pAmount, uFreqId);
