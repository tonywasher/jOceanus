 ...
 * @author Tony Washer
 */
public class SheetPatternNew
        extends SheetDataItem<PatternNew> {
    /**
     * NamedArea for Patterns.
     */
    private static final String AREA_PATTERNS = PatternNew.LIST_NAME;
     ...
     * Patterns data list.
     */
    private final PatternNewList theList;

    /**
     * Constructor for loading a spreadsheet.
     * @param pReader the spreadsheet reader
     */
    protected SheetPatternNew(final FinanceReader pReader) {
        /* Call super constructor */
        super(pReader, AREA_PATTERNS);

        /* Access the Lists */
        theList = pReader.getData().getNewPatterns();
        setDataList(theList);
    }
     ...
     */
    protected SheetPatternNew(final FinanceWriter pWriter) {
        /* Call super constructor */
        super(pWriter, AREA_PATTERNS);

        /* Access the Patterns list */
        theList = pWriter.getData().getNewPatterns();
        setDataList(theList);
    }
    ...
    @Override
    protected void insertSecureItem(final PatternNew pItem) throws JDataException {
        /* Set the fields */
    ...
    @Override
    protected void insertOpenItem(final PatternNew pItem) throws JDataException {
        /* Set the fields */
        writeInteger(COL_ID, pItem.getId());
    ...
    protected void formatSheetHeader() throws JDataException {
        ...
        writeHeader(COL_FREQ, PatternNew.FIELD_FREQ.getName());
    ...
    protected static boolean loadArchive(final TaskControl<FinanceData> pTask,
        ...
        try {
            ...
            if (myRange != null) {
                ...
                PatternNewList myList = pData.getNewPatterns();
