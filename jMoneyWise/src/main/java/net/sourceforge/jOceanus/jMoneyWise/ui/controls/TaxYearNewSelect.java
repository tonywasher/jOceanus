 ...
 * @author Tony Washer
 */
public class TaxYearNewSelect extends JEventPanel {
    /**
     * Serial Id.
     */
     ...
     * Years box.
     */
    private final JComboBox<TaxYearNew> theYearsBox;
     ...
     * @return the tax year
     */
    public final TaxYearNew getTaxYear() {
     ...
     */
    public TaxYearNewSelect(final View pView) {
        JLabel mySelect;
        ...
        theYearsBox = new JComboBox<TaxYearNew>();
    ...
    public final void refreshData() {
        ...
        ListIterator<TaxYearNew> myYearIterator = myTaxYears.listIterator();
        TaxYearNew myFirst = null;

        /* Add the Tax Years to the years box in reverse order */
        while (myYearIterator.hasPrevious()) {
            TaxYearNew myYear = myYearIterator.previous();
    ...
    private final class TaxYearListener implements ItemListener {
        ...
        public void itemStateChanged(final ItemEvent evt) {
            ...
            if ((theYearsBox.equals(o)) && (evt.getStateChange() == ItemEvent.SELECTED)) {
                ...
                TaxYearNew myYear = (TaxYearNew) evt.getItem();
    ...
    private final class YearState {
         ...
         * Selected tax year.
         */
        private TaxYearNew theTaxYear = null;
         ...
         * @return true/false
         */
        private boolean setTaxYear(final TaxYearNew pYear) {
