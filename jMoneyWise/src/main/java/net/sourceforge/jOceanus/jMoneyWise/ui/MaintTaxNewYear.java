...
import net.sourceforge.jOceanus.jMoneyWise.data.TaxYearNew;
...
import net.sourceforge.jOceanus.jMoneyWise.ui.controls.TaxYearNewSelect;
 ...
 * @author Tony Washer
 */
public class MaintTaxNewYear extends JEventPanel {
    /**
     * Serial Id.
     */
     ...
     */
    private final TaxYearNewSelect theSelect;
     ...
     * The tax year.
     */
    private transient TaxYearNew theTaxYear = null;

    /**
     * The tax year view.
     */
    private transient TaxYearNewList theTaxView = null;

    /**
     * The tax year list.
     */
    private transient TaxYearNewList theTaxYears = null;
     ...
     */
    private final transient UpdateEntry<TaxYearNew> theYearsEntry;
     ...
     */
    public MaintTaxNewYear(final View pView) {
        /* Record the view */
        theView = pView;
        ...
        theYearsEntry = theUpdateSet.registerClass(TaxYearNew.class);
        ...
        theAllowance = new ItemField(ValueClass.Money, TaxYearNew.FIELD_ALLOW, theFieldSet);
        theLoAgeAllow = new ItemField(ValueClass.Money, TaxYearNew.FIELD_LOAGAL, theFieldSet);
        theHiAgeAllow = new ItemField(ValueClass.Money, TaxYearNew.FIELD_HIAGAL, theFieldSet);
        theCapitalAllow = new ItemField(ValueClass.Money, TaxYearNew.FIELD_CAPALW, theFieldSet);
        theAgeAllowLimit = new ItemField(ValueClass.Money, TaxYearNew.FIELD_AGELMT, theFieldSet);
        theAddAllowLimit = new ItemField(ValueClass.Money, TaxYearNew.FIELD_ADDLMT, theFieldSet);
        theAddIncomeBndry = new ItemField(ValueClass.Money, TaxYearNew.FIELD_ADDBDY, theFieldSet);
        theLoTaxBand = new ItemField(ValueClass.Money, TaxYearNew.FIELD_LOBAND, theFieldSet);
        theBasicTaxBand = new ItemField(ValueClass.Money, TaxYearNew.FIELD_BSBAND, theFieldSet);
        theRental = new ItemField(ValueClass.Money, TaxYearNew.FIELD_RENTAL, theFieldSet);
        theLoTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_LOTAX, theFieldSet);
        theBasicTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_BASTAX, theFieldSet);
        theHiTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_HITAX, theFieldSet);
        theIntTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_INTTAX, theFieldSet);
        theDivTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_DIVTAX, theFieldSet);
        theHiDivTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_HDVTAX, theFieldSet);
        theAddTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_ADDTAX, theFieldSet);
        theAddDivTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_ADVTAX, theFieldSet);
        theCapTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_CAPTAX, theFieldSet);
        theHiCapTaxRate = new ItemField(ValueClass.Rate, TaxYearNew.FIELD_HCPTAX, theFieldSet);
        ...
        theSelect = new TaxYearNewSelect(theView);
     ...
     */
    public void setSelection(final TaxYearNew pTaxYear) {
        /* Reset controls */
        theTaxView = null;
        theTaxYear = null;
