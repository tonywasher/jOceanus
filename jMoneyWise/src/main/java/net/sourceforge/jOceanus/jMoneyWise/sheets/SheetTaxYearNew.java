 ...
 * @author Tony Washer
 */
public class SheetTaxYearNew extends SheetDataItem<TaxYearNew> {
    /**
     ...
     * TaxYear data list.
     */
    private final TaxYearNewList theList;
     ...
     */
    protected SheetTaxYearNew(final FinanceReader pReader) {
        /* Call super constructor */
        super(pReader, AREA_TAXYEARS);

        /* Access the Lists */
        theData = pReader.getData();
        theList = theData.getNewTaxYears();
        setDataList(theList);
    }
     ...
     */
    protected SheetTaxYearNew(final FinanceWriter pWriter) {
        /* Call super constructor */
    ...
    @Override
    protected void insertSecureItem(final TaxYearNew pItem) throws JDataException {
        /* Set the fields */
    ...
    @Override
    protected void insertOpenItem(final TaxYearNew pItem) throws JDataException {
        /* Set the fields */
        writeInteger(COL_ID, pItem.getId());
        writeDate(COL_TAXYEAR, pItem.getTaxYear());
    ...
    protected static boolean loadArchive(final TaskControl<FinanceData> pTask,
        ...
        try {
            ...
            if (myRange != null) {
                ...
                /* Access the lists */
                TaxYearNewList myList = pData.getNewTaxYears();
                ...
                for (int i = myTop.getCol(); i <= myBottom.getCol(); i++, myYear.add(Calendar.YEAR, -1)) {
                    ...
                    /* Add the Tax Year */
                    TaxYearNew myTaxYear = myList.addOpenItem(0, myTaxRegime, myYear.getTime());
