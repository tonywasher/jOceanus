...
public class SheetTaxBasis
        extends SheetStaticData<TaxBasis> {
    /**
     ...
     */
    protected static final String AREA_TAXBASISNAMES = TaxBasis.OBJECT_NAME
                                                       + "Names";
     ...
     */
    protected SheetTaxBasis(final FinanceReader pReader) {
     ...
     */
    protected SheetTaxBasis(final FinanceWriter pWriter) {
        /* Call super-constructor */
    ...
    protected static boolean loadArchive(final TaskControl<FinanceData> pTask,
        ...
        try {
            ...
            throw new JDataException(ExceptionClass.EXCEL, "Failed to Load Tax Bases", e);
        }
