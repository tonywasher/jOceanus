 ...
 * Zopa BadDebt Parser.
 */
public class CoeusZopaBadDebtParser
    ...
    { "Borrower", "Product", "Acquired", "Market", "Term", "Loan size", "Status", "Rate", "Lent", "Outstanding", "Repaid",
            ...
            "Scheduled end date", "Expected Repayment", "Loan purpose", "Repaid %", "DefaultDate" };
     ...
     * Parsed fields.
     */
    private final List<CoeusZopaTransaction> theBadDebts;
     ...
     * @return the badDebts
     */
    public Iterator<CoeusZopaTransaction> badDebtIterator() {
    ...
    protected void processFields(final List<String> pFields) throws OceanusException {
        ...
        if (!checkedHeader) {
            ...
            theBadDebts.add(new CoeusZopaTransaction(this, pFields));
        }
    }
}
