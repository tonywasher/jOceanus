...
public class DateDayButton extends JDateButton {
     ...
     */
    public static final String propertyDATE = "SelectedDateDay";
    ...
    @Override
    protected void fireDatePropertyChange(Calendar pOldValue,
                                          Calendar pNewValue) {
        ...
        firePropertyChange(propertyDATE, myOld, myNew);
    }
}
