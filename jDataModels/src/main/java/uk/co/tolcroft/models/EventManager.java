 ...
 * This maintains a list of ChangeListeners/ActionListeners and allows the caller to fire ChangeEvents and ActionEvents to these lists
 * This is implemented to provide functionality to non-Swing components and also to enable improved control over the contents of the 
...
public class EventManager {
	...
	public void addChangeListener(ChangeListener pListener) {
		...
		Registration myReg = new Registration(RegistrationType.Change,
											  pListener);
	...
	public void addActionListener(ActionListener pListener) {
		/* Create the registration */
		Registration myReg = new Registration(RegistrationType.Action,
											  pListener);
	...
	public void fireStateChanged(Object pOwner) {
		...
		while (myIterator.hasPrevious()) {
			...
			if (myReg.theType != RegistrationType.Change) continue;
	 ...
	 * @param pCommand the action command
	 */
	public void fireActionPerformed(Object pOwner, int uId, String pCommand) {
		...
		while (myIterator.hasPrevious()) {
			...
			if (myReg.theType != RegistrationType.Action) continue;
