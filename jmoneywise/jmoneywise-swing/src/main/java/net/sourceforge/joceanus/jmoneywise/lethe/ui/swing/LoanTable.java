...
public class LoanTable
        extends PrometheusDataTable<Loan, MoneyWiseDataType> {
    /**
     * Name Column Title.
     */
     ...
     */
    private final PrometheusDataTableSelection<Loan, MoneyWiseDataType> theSelectionModel;
     ...
     */
    public LoanTable(final MoneyWiseSwingView pView,
    ...
    protected void refreshData() throws OceanusException {
        ...
        final LoanList myLoans = myData.getLoans();
    ...
    private final class LoanTableModel
            extends PrometheusDataTableModel<Loan, MoneyWiseDataType> {
        /**
         * The Serial Id.
         */
        ...
        private void addNewItem() {
            ...
            try {
                /* Create the new loan */
                final Loan myLoan = new Loan(theLoans);
    ...
    private final class LoanColumnModel
        ...
        private LoanColumnModel(final LoanTable pTable) {
            ...
            final MetisFieldScrollButtonCellEditor<LoanCategory> myCategoryEditor = theFieldMgr.allocateScrollButtonCellEditor(LoanCategory.class);
            ...
            switch (pColIndex) {
                ...
                case COLUMN_ACTIVE:
                    return pLoan.isActive()
                                            ...
                                            : MetisAction.DELETE;
                case COLUMN_LASTTRAN:
                    final Transaction myTran = pLoan.getLatest();
                    return (myTran == null)
                                            ? null
                                            : myTran.getDate();
                default:
