...
public class DepositCategoryTable
     ...
     */
    public DepositCategoryTable(final MoneyWiseView pView,
    ...
    protected void refreshData() throws OceanusException {
        ...
        final DepositCategoryList myCategories = myData.getDepositCategories();
    ...
    private final class CategoryTableModel
        ...
        @Override
        public MetisLetheField getFieldForCell(final DepositCategory pItem,
                                               final int pColIndex) {
        ...
        private void addNewItem() {
            ...
            try {
                ...
                final DepositCategory myCategory = new DepositCategory(theCategories);
    ...
    private final class CategoryColumnModel
        ...
        private CategoryColumnModel(final DepositCategoryTable pTable) {
            ...
            final MetisFieldScrollButtonCellEditor<DepositCategoryType> myScrollEditor = theFieldMgr.allocateScrollButtonCellEditor(DepositCategoryType.class);
