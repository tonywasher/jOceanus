...
public class CashCategoryTable
        extends PrometheusDataTable<CashCategory, MoneyWiseDataType> {
    /**
     * Name Column Title.
     */
     ...
     */
    private final PrometheusDataTableSelection<CashCategory, MoneyWiseDataType> theSelectionModel;
     ...
     */
    public CashCategoryTable(final MoneyWiseSwingView pView,
    ...
    protected void refreshData() throws OceanusException {
        ...
        final CashCategoryList myCategories = myData.getCashCategories();
    ...
    private void handleCashSelection() {
        final CashCategory myCategory = theSelectButton.getValue();
    ...
    private final class CategoryTableModel
            extends PrometheusDataTableModel<CashCategory, MoneyWiseDataType> {
        /**
         * The Serial Id.
         */
        ...
        private void addNewItem() {
            ...
            try {
                ...
                final CashCategory myCategory = new CashCategory(theCategories);
    ...
    private final class CategoryColumnModel
        ...
        private CategoryColumnModel(final CashCategoryTable pTable) {
            ...
            final MetisFieldScrollButtonCellEditor<CashCategoryType> myScrollEditor = theFieldMgr.allocateScrollButtonCellEditor(CashCategoryType.class);
