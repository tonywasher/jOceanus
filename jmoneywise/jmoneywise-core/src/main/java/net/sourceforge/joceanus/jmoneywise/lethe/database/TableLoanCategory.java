...
public class TableLoanCategory
        extends PrometheusXTableEncrypted<LoanCategory> {
    /**
     ...
     */
    protected TableLoanCategory(final PrometheusXDataStore pDatabase) {
        super(pDatabase, TABLE_NAME);
        final PrometheusXTableDefinition myTableDef = getTableDef();

        /* Declare the columns */
        final PrometheusXColumnDefinition myCatCol = myTableDef.addReferenceColumn(LoanCategory.FIELD_CATTYPE, TableLoanCategoryType.TABLE_NAME);
        final PrometheusXColumnDefinition myParentCol = myTableDef.addNullIntegerColumn(LoanCategory.FIELD_PARENT);
