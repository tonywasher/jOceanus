...
public class LoanCategoryType
    ...
    public static class LoanCategoryTypeList
         ...
         * Report fields.
         */
        private static final MetisFieldSet<LoanCategoryTypeList> FIELD_DEFS = MetisFieldSet.newFieldSet(LoanCategoryTypeList.class);
        ...
        @Override
        public MetisFieldSet<LoanCategoryTypeList> getDataFieldSet() {
            return FIELD_DEFS;
        }
