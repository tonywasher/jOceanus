...
import net.sourceforge.joceanus.jprometheus.atlas.sheets.PrometheusSheetStaticData;
 ...
 * @author Tony Washer
 */
public class MoneyWiseSheetPortfolioType
        extends PrometheusSheetStaticData<MoneyWisePortfolioType> {
    /**
     ...
     */
    protected MoneyWiseSheetPortfolioType(final MoneyWiseReader pReader) {
     ...
     */
    protected MoneyWiseSheetPortfolioType(final MoneyWiseWriter pWriter) {
        /* Call super-constructor */
    ...
    protected PrometheusDataValues loadSecureValues() throws OceanusException {
        /* Build data values */
        return getRowValues(MoneyWisePortfolioType.OBJECT_NAME);
    }
    ...
    protected static void loadArchive(final TethysUIThreadStatusReport pReport,
        ...
        final MoneyWisePortfolioTypeList myList = pData.getPortfolioTypes();
