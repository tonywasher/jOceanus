 ...
 * @author Tony Washer
 */
public class TableTaxYearInfoType
        extends PrometheusTableStaticData<TaxYearInfoType, MoneyWiseDataType> {
    /**
     ...
     */
    protected TableTaxYearInfoType(final PrometheusDataStore<?> pDatabase) {
    ...
    protected void declareData(final DataSet<?, ?> pData) {
        ...
        setList(myData.getTaxInfoTypes());
    }
