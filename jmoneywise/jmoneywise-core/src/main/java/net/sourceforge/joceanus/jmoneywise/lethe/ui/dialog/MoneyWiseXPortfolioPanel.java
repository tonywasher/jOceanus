 ...
 */
public class MoneyWiseXPortfolioPanel
        extends MoneyWiseXItemPanel<Portfolio> {
    /**
     * The fieldSet.
     */
    private final PrometheusXFieldSet<Portfolio> theFieldSet;
     ...
     */
    public MoneyWiseXPortfolioPanel(final TethysUIFactory<?> pFactory,
