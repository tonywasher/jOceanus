 ...
 */
public class MoneyWiseXAccountPanel
     ...
     * Deposit Table.
     */
    private final MoneyWiseXDepositTable theDepositTable;

    /**
     * Cash Table.
     */
    private final MoneyWiseXCashTable theCashTable;

    /**
     * Loan Table.
     */
    private final MoneyWiseXLoanTable theLoanTable;

    /**
     * Portfolio Table.
     */
    private final MoneyWiseXPortfolioTable thePortfolioTable;

    /**
     * Security Table.
     */
    private final MoneyWiseXSecurityTable theSecurityTable;

    /**
     * Payee Table.
     */
    private final MoneyWiseXPayeeTable thePayeeTable;
     ...
     */
    MoneyWiseXAccountPanel(final MoneyWiseXView pView) {
        /* Store details */
        theView = pView;
        ...
        thePayeeTable = new MoneyWiseXPayeeTable(pView, theUpdateSet, theError);
        theSecurityTable = new MoneyWiseXSecurityTable(pView, theUpdateSet, theError);
        theDepositTable = new MoneyWiseXDepositTable(pView, theUpdateSet, theError);
        theCashTable = new MoneyWiseXCashTable(pView, theUpdateSet, theError);
        theLoanTable = new MoneyWiseXLoanTable(pView, theUpdateSet, theError);
        thePortfolioTable = new MoneyWiseXPortfolioTable(pView, theUpdateSet, theError);
