 ...
 * @author Tony Washer
 */
public class MoneyWiseSheetTransInfoType
     ...
     */
    protected MoneyWiseSheetTransInfoType(final MoneyWiseReader pReader) {
     ...
     */
    protected MoneyWiseSheetTransInfoType(final MoneyWiseWriter pWriter) {
        /* Call super-constructor */
    ...
    protected static void loadArchive(final TethysUIThreadStatusReport pReport,
        ...
        final MoneyWiseTransInfoTypeList myList = pData.getTransInfoTypes();

        /* Protect against exceptions */
        try {
            /* Find the range of cells */
            final PrometheusSheetView myView = pWorkBook.getRangeView(AREA_TRANSINFOTYPES);
