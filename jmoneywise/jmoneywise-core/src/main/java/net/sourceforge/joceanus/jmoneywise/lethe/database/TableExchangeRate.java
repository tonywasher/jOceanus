...
public class TableExchangeRate
        extends PrometheusXTableDataItem<ExchangeRate> {
    /**
     ...
     */
    protected TableExchangeRate(final PrometheusXDataStore pDatabase) {
        super(pDatabase, TABLE_NAME);
        final PrometheusXTableDefinition myTableDef = getTableDef();

        /* Declare the columns */
        final PrometheusXColumnDefinition myDateCol = myTableDef.addDateColumn(ExchangeRate.FIELD_DATE);
        final PrometheusXColumnDefinition myFromCol = myTableDef.addReferenceColumn(ExchangeRate.FIELD_FROM, TableAssetCurrency.TABLE_NAME);
