...
import net.sourceforge.joceanus.jmoneywise.lethe.ui.dialog.MoneyWiseXCashCategoryPanel;
 ...
 */
public class MoneyWiseXCashCategoryTable
        extends MoneyWiseXCategoryTable<CashCategory, CashCategoryType> {
    /**
     * The Category dialog.
     */
    private final MoneyWiseXCashCategoryPanel theActiveCategory;
     ...
     */
    MoneyWiseXCashCategoryTable(final MoneyWiseXView pView,
        ...
        theActiveCategory = new MoneyWiseXCashCategoryPanel(myGuiFactory, pUpdateSet, pError);
    ...
    private void handlePanelState() {
        ...
        if (!theActiveCategory.isEditing()) {
            ...
            setEnabled(true);
            final CashCategory myCategory = theActiveCategory.getSelectedItem();
            updateTableData();
            if (myCategory != null) {
