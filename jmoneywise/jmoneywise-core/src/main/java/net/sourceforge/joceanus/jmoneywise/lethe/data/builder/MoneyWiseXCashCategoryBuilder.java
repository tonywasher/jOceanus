 ...
 */
public class MoneyWiseXCashCategoryBuilder {
    /**
     * DataSet.
     */
     ...
     */
    public MoneyWiseXCashCategoryBuilder(final MoneyWiseData pDataSet) {
        theDataSet = pDataSet;
     ...
     * @return the builder
     */
    public MoneyWiseXCashCategoryBuilder name(final String pName) {
     ...
     * @return the builder
     */
    public MoneyWiseXCashCategoryBuilder type(final CashCategoryType pType) {
        theType = pType;
        return this;
    }
     ...
     * @return the builder
     */
    public MoneyWiseXCashCategoryBuilder type(final CashCategoryClass pType) {
