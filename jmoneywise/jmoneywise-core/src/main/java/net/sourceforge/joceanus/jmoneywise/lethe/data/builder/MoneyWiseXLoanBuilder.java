 ...
 * Loan Builder.
 */
public class MoneyWiseXLoanBuilder {
    /**
     * DataSet.
     */
     ...
     */
    public MoneyWiseXLoanBuilder(final MoneyWiseData pDataSet) {
        theDataSet = pDataSet;
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder name(final String pName) {
        theName = pName;
        return this;
    }
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder parent(final Payee pParent) {
        theParent = pParent;
        return this;
    }
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder parent(final String pParent) {
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder category(final LoanCategory pCategory) {
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder category(final String pCategory) {
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder currency(final AssetCurrency pCurrency) {
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder currency(final AssetCurrencyClass pCurrency) {
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder openingBalance(final TethysMoney pOpening) {
     ...
     * @return the builder
     */
    public MoneyWiseXLoanBuilder openingBalance(final String pOpening) {
