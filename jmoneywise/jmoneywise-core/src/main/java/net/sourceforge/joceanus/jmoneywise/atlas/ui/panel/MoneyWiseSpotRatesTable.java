...
import net.sourceforge.joceanus.jmoneywise.atlas.ui.controls.MoneyWiseSpotRatesSelect;
import net.sourceforge.joceanus.jmoneywise.atlas.views.MoneyWiseSpotExchangeRate;
import net.sourceforge.joceanus.jmoneywise.atlas.ui.MoneyWiseUIResource;
import net.sourceforge.joceanus.jmoneywise.atlas.views.MoneyWiseSpotExchangeRate.MoneyWiseSpotExchangeList;
...
public class MoneyWiseSpotRatesTable
    ...
    public static class MoneyWiseSpotRatesPanel
        ...
        public MoneyWiseSpotRatesPanel(final MoneyWiseView pView) {
            ...
            /* Create the table */
            theTable = new MoneyWiseSpotRatesTable(pView, theEditSet, theError);
