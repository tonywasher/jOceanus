...
public class SheetTransCategoryType
        extends PrometheusSheetStaticData<TransactionCategoryType, MoneyWiseDataType> {
    ...
    protected static void loadArchive(final MetisThreadStatusReport pReport,
        ...
        final TransactionCategoryTypeList myList = pData.getTransCategoryTypes();

        /* Protect against exceptions */
        try {
            /* Find the range of cells */
            final MetisSheetView myView = pWorkBook.getRangeView(AREA_CATTYPES);
