 ...
 * @author Tony Washer
 */
public class MoneyWiseTableSecurityType
        extends PrometheusTableStaticData<MoneyWiseSecurityType> {
    /**
     * The table name.
     */
    protected static final String TABLE_NAME = MoneyWiseSecurityType.LIST_NAME;

    /**
     * Constructors.
     * @param pDatabase the database control
     */
    protected MoneyWiseTableSecurityType(final PrometheusDataStore pDatabase) {
