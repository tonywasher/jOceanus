 ...
 */
public class MoneyWiseAnalysisValues<E extends Enum<E> & MoneyWiseAnalysisAttribute>
     ...
     */
    public MoneyWiseAnalysisValues(final Class<E> pClass,
     ...
     */
    protected MoneyWiseAnalysisValues(final MoneyWiseAnalysisValues<E> pPrevious) {
        /* Initialise bucket */
     ...
     * @param pClass the Enum class
     */
    private MoneyWiseAnalysisValues(final Class<E> pClass) {
     ...
     * @return the delta
     */
    protected TethysDecimal getDeltaValue(final MoneyWiseAnalysisValues<E> pPrevious,
                                          final E pAttr) {
     ...
     * @return the delta
     */
    protected TethysDecimal getDeltaOrNull(final MoneyWiseAnalysisValues<E> pPrevious,
                                           final E pAttr) {
     ...
     * @return the delta
     */
    protected TethysMoney getDeltaMoneyValue(final MoneyWiseAnalysisValues<E> pPrevious,
                                             final E pAttr) {
     ...
     * @return the delta
     */
    protected TethysMoney getDeltaMoneyOrNull(final MoneyWiseAnalysisValues<E> pPrevious,
                                              final E pAttr) {
        /* Access current and previous values */
        TethysMoney myCurr = getMoneyValue(pAttr);
        if (pPrevious != null) {
     ...
     * @return the delta
     */
    protected TethysUnits getDeltaUnitsValue(final MoneyWiseAnalysisValues<E> pPrevious,
                                             final E pAttr) {
        /* Access current and previous values */
     ...
     * @return the delta
     */
    protected TethysRatio getDeltaRatioValue(final MoneyWiseAnalysisValues<E> pPrevious,
                                             final E pAttr) {
        /* Access current and previous values */
     ...
     * @param pPrevious the previous values
     */
    protected void flattenValues(final MoneyWiseAnalysisValues<E> pPrevious) {
        /* Flatten values */
        for (E myAttr : theClass.getEnumConstants()) {
