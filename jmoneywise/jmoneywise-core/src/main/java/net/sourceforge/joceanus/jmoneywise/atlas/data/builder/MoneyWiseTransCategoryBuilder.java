...
public class MoneyWiseTransCategoryBuilder {
     ...
     */
    MoneyWiseTransCategoryBuilder(final MoneyWiseData pDataSet) {
        theDataSet = pDataSet;
    }
     ...
     */
    public void type(final TransactionCategoryType pType) {
        theType = pType;
    }
     ...
     */
    public TransactionCategory lookupCategory(final String pCategory) {
