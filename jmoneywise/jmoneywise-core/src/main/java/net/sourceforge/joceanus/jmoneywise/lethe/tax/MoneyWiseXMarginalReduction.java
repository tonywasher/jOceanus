 ...
 */
public enum MoneyWiseXMarginalReduction {
    /**
     * Half.
     */
    ONEINTWO(1, 2),
     ...
     */
    MoneyWiseXMarginalReduction(final int pMultiplier,
                                final int pQuotient) {
    ...
    public String toString() {
        ...
        if (theName == null) {
            /* Load the name */
            theName = MoneyWiseXTaxResource.getKeyForMarginalReduction(this).getValue();
        }
