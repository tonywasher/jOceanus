...
import net.sourceforge.joceanus.jmoneywise.atlas.ui.MoneyWiseAnalysisColumnSet;
import net.sourceforge.joceanus.jmoneywise.lethe.data.ids.MoneyWiseTransDataId;
 ...
 */
public class MoneyWiseXTransactionTable
     ...
     */
    MoneyWiseXTransactionTable(final MoneyWiseXView pView,
        ...
        final Map<Boolean, TethysUIIconMapSet<AssetDirection>> myDirMapSets = MoneyWiseXIcon.configureDirectionIconButton(myGuiFactory);
        myTable.declareIconColumn(MoneyWiseTransDataId.DIRECTION, AssetDirection.class)
               ...
               .setCellValueFactory(MoneyWiseXTransactionTable::getFilteredDirection)
               .setEditable(true)
        ...
        final Map<Boolean, TethysUIIconMapSet<Boolean>> myRecMapSets = MoneyWiseXIcon.configureReconciledIconButton(myGuiFactory);
        ...
        myTable.declareStringColumn(MoneyWiseTransDataId.COMMENTS)
               .setCellValueFactory(MoneyWiseXTransactionTable::getFilteredComments)
               .setEditable(true)
        ...
        myTable.declareIconColumn(PrometheusDataId.TOUCH, MetisAction.class)
               ...
               .setCellValueFactory(MoneyWiseXTransactionTable::getFilteredAction)
    ...
    public static class MoneyWiseXStatementPanel
         ...
         * The table.
         */
        private final MoneyWiseXTransactionTable theTable;
         ...
         */
        MoneyWiseXStatementPanel(final MoneyWiseXView pView) {
            ...
            /* Create the table */
            theTable = new MoneyWiseXTransactionTable(pView, theUpdateSet, theError, myViewerFilter, theViewerAnalysis);
