 ...
 * @author Tony Washer
 */
public class MoneyWiseTablePortfolioType
        extends PrometheusTableStaticData<MoneyWisePortfolioType> {
    /**
     * The table name.
     */
    protected static final String TABLE_NAME = MoneyWisePortfolioType.LIST_NAME;

    /**
     * Constructors.
     * @param pDatabase the database control
     */
    protected MoneyWiseTablePortfolioType(final PrometheusDataStore pDatabase) {
