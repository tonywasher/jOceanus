 ...
 */
public class MoneyWiseXTableSelect<T extends DataItem> {
    /**
     * The table.
     */
     ...
     * The item panel.
     */
    private MoneyWiseXItemPanel<T> theItemPanel;
     ...
     */
    MoneyWiseXTableSelect(final TethysUITableManager<?, T> pTable,
     ...
     */
    void declareItemPanel(final MoneyWiseXItemPanel<T> pPanel) {
        theItemPanel = pPanel;
    }
