 ...
 */
public enum FrequencyClass implements StaticDataClass {
    /**
     * Once.
     */
    ONCE(1, 0),
    ...
    public String toString() {
        ...
        if (theName == null) {
            /* Load the name */
            theName = StaticDataResource.getKeyForFrequency(this).getValue();
        }
     ...
     */
    public static FrequencyClass fromId(final int id) throws OceanusException {
        for (FrequencyClass myClass : values()) {
            if (myClass.getClassId() == id) {
                return myClass;
            }
        }
        throw new MoneyWiseDataException("Invalid ClassId for " + MoneyWiseDataType.FREQUENCY.toString() + ":" + id);
    }
