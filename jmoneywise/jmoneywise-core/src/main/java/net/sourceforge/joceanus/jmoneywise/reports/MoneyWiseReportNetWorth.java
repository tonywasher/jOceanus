...
import net.sourceforge.joceanus.jmoneywise.data.analysis.data.MoneyWiseAnalysisAccountAttr;
...
import net.sourceforge.joceanus.jmoneywise.data.analysis.data.MoneyWiseAnalysisCashCategoryBucket;
