 ...
 * Cash Builder.
 */
public class MoneyWiseXCashBuilder {
    /**
     * DataSet.
     */
     ...
     */
    public MoneyWiseXCashBuilder(final MoneyWiseData pDataSet) {
        theDataSet = pDataSet;
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder name(final String pName) {
        theName = pName;
        return this;
    }
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder category(final CashCategory pCategory) {
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder category(final String pCategory) {
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder autoExpense(final TransactionCategory pCategory,
                                             final Payee pPayee) {
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder autoExpense(final String pCategory,
                                             final String pPayee) {
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder currency(final AssetCurrency pCurrency) {
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder currency(final AssetCurrencyClass pCurrency) {
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder openingBalance(final TethysMoney pOpening) {
     ...
     * @return the builder
     */
    public MoneyWiseXCashBuilder openingBalance(final String pOpening) {
