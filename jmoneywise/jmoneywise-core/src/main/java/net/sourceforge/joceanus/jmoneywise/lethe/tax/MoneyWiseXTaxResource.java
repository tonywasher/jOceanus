 ...
 */
public enum MoneyWiseXTaxResource
     ...
     * The Marginal Map.
     */
    private static final Map<MoneyWiseXMarginalReduction, TethysBundleId> MARGINAL_MAP = buildMarginalMap();
     ...
     * The Resource Loader.
     */
    private static final TethysBundleLoader LOADER = TethysBundleLoader.getLoader(MoneyWiseXTaxResource.class.getCanonicalName(),
     ...
     */
    MoneyWiseXTaxResource(final String pKeyName) {
        theKeyName = pKeyName;
    }
     ...
     * @return the map
     */
    private static Map<MoneyWiseXMarginalReduction, TethysBundleId> buildMarginalMap() {
        /* Create the map and return it */
        final Map<MoneyWiseXMarginalReduction, TethysBundleId> myMap = new EnumMap<>(MoneyWiseXMarginalReduction.class);
        myMap.put(MoneyWiseXMarginalReduction.ONEINTWO, MARGINAL_ONEINTWO);
        myMap.put(MoneyWiseXMarginalReduction.TWOINTHREE, MARGINAL_TWOINTHREE);
        return myMap;
    }
     ...
     */
    protected static TethysBundleId getKeyForMarginalReduction(final MoneyWiseXMarginalReduction pValue) {
