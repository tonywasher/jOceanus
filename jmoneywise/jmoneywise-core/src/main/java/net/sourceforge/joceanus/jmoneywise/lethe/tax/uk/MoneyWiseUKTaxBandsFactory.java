...
public final class MoneyWiseUKTaxBandsFactory {
     ...
     * The 2018 TaxBands.
     */
    protected static final MoneyWiseUKTaxBands BANDS_2018 = new MoneyWiseUKTaxBands(new MoneyWiseTaxBandSet(
     ...
     * The 2019 TaxBands.
     */
    protected static final MoneyWiseUKTaxBands BANDS_2019 = new MoneyWiseUKTaxBands(new MoneyWiseTaxBandSet(
     ...
     * @return the amount
     */
    protected static TethysRate getRate(final int pUnits) {
