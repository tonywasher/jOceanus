...
import net.sourceforge.joceanus.jmoneywise.atlas.ui.dialog.MoneyWiseTransCategoryPanel;
...
public class MoneyWiseTransCategoryTable
    ...
    MoneyWiseTransCategoryTable(final MoneyWiseView pView,
        ...
        theActiveCategory = new MoneyWiseTransCategoryPanel(myGuiFactory, pEditSet, pError);
