...
import net.sourceforge.joceanus.jmoneywise.lethe.data.ids.MoneyWiseRegionDataId;
 ...
 */
public class MoneyWiseXRegionTable
        extends MoneyWiseXBaseTable<Region> {
    /**
     * The filter panel.
     */
     ...
     */
    MoneyWiseXRegionTable(final MoneyWiseXView pView,
