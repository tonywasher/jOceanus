...
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKCapitalScheme.MoneyWiseUKCapitalAsIncomeScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKCapitalScheme.MoneyWiseUKCapitalFlatRateScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKCapitalScheme.MoneyWiseUKCapitalResidentialScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKCapitalScheme.MoneyWiseUKCapitalSplitRateScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKDividendScheme.MoneyWiseUKDividendAdditionalRateScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKDividendScheme.MoneyWiseUKDividendAsIncomeScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKDividendScheme.MoneyWiseUKDividendBaseRateScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKDividendScheme.MoneyWiseUKDividendHigherRateScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKDividendScheme.MoneyWiseUKDividendLoHigherRateScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKInterestScheme.MoneyWiseUKInterestAsIncomeScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKInterestScheme.MoneyWiseUKInterestBaseRateScheme;
import net.sourceforge.joceanus.jmoneywise.atlas.tax.uk.MoneyWiseUKInterestScheme.MoneyWiseUKInterestLoBaseRateScheme;
