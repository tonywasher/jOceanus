 ...
 * Tax Year cache.
 */
public abstract class MoneyWiseXTaxYearCache
     ...
     */
    protected MoneyWiseXTaxYearCache(final TethysFiscalYear pYear) {
        theFiscalYear = pYear;
    }

    @Override
    public abstract MoneyWiseXTaxYear findTaxYearForRange(TethysDateRange pRange);

    @Override
    public abstract MoneyWiseXTaxYear findTaxYearForDate(TethysDate pDate);
