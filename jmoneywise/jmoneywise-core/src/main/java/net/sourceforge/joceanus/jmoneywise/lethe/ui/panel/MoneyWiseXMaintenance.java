 ...
 * @author Tony Washer
 */
public class MoneyWiseXMaintenance
     ...
     * The Account Panel.
     */
    private final MoneyWiseXAccountPanel theAccountTab;

    /**
     * The Category Panel.
     */
    private final MoneyWiseXCategoryPanel theCategoryTab;

    /**
     * The Static Panel.
     */
    private final MoneyWiseXStaticPanel theStatic;
     ...
     */
    MoneyWiseXMaintenance(final MoneyWiseXView pView) {
        /* Store details */
        theView = pView;
