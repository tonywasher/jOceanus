...
public enum LoanCategoryClass implements CategoryInterface {
     ...
     */
    public static LoanCategoryClass fromId(final int id) throws OceanusException {
        for (LoanCategoryClass myClass : values()) {
            if (myClass.getClassId() == id) {
                return myClass;
            }
        }
        throw new MoneyWiseDataException("Invalid ClassId for " + MoneyWiseDataType.LOANTYPE.toString() + ":" + id);
    }
