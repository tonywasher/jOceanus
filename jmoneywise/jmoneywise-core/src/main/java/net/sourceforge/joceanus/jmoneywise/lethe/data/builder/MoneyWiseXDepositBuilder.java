 ...
 * Deposit Builder.
 */
public class MoneyWiseXDepositBuilder {
    /**
     * DataSet.
     */
     ...
     */
    public MoneyWiseXDepositBuilder(final MoneyWiseData pDataSet) {
        theDataSet = pDataSet;
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder name(final String pName) {
        theName = pName;
        return this;
    }
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder parent(final Payee pParent) {
        theParent = pParent;
        return this;
    }
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder parent(final String pParent) {
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder category(final DepositCategory pCategory) {
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder category(final String pCategory) {
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder currency(final AssetCurrency pCurrency) {
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder currency(final AssetCurrencyClass pCurrency) {
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder openingBalance(final TethysMoney pOpening) {
     ...
     * @return the builder
     */
    public MoneyWiseXDepositBuilder openingBalance(final String pOpening) {
