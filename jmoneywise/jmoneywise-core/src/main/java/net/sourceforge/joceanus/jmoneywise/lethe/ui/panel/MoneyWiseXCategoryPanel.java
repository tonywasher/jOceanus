...
public class MoneyWiseXCategoryPanel
     ...
     */
    private final MoneyWiseXDepositCategoryTable theDepositTable;

    /**
     * Cash Categories Table.
     */
    private final MoneyWiseXCashCategoryTable theCashTable;

    /**
     * Loan Categories Table.
     */
    private final MoneyWiseXLoanCategoryTable theLoanTable;

    /**
     * Transaction Categories Table.
     */
    private final MoneyWiseXTransCategoryTable theEventTable;

    /**
     * Event Tags Table.
     */
    private final MoneyWiseXTransTagTable theTagTable;

    /**
     * Regions Table.
     */
    private final MoneyWiseXRegionTable theRegionTable;
     ...
     */
    MoneyWiseXCategoryPanel(final MoneyWiseXView pView) {
        /* Store details */
        theView = pView;
        ...
        theDepositTable = new MoneyWiseXDepositCategoryTable(pView, theUpdateSet, theError);
        theCashTable = new MoneyWiseXCashCategoryTable(pView, theUpdateSet, theError);
        theLoanTable = new MoneyWiseXLoanCategoryTable(pView, theUpdateSet, theError);
        theEventTable = new MoneyWiseXTransCategoryTable(pView, theUpdateSet, theError);
        theTagTable = new MoneyWiseXTransTagTable(pView, theUpdateSet, theError);
        theRegionTable = new MoneyWiseXRegionTable(pView, theUpdateSet, theError);
