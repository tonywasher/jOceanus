 ...
 */
public class MoneyWiseXSpotRatesTable
     ...
     */
    MoneyWiseXSpotRatesTable(final MoneyWiseXView pView,
     ...
     * SpotRates Panel.
     */
    public static class MoneyWiseXSpotRatesPanel
         ...
         * The table.
         */
        private final MoneyWiseXSpotRatesTable theTable;
         ...
         */
        public MoneyWiseXSpotRatesPanel(final MoneyWiseXView pView) {
            ...
            /* Create the table */
            theTable = new MoneyWiseXSpotRatesTable(pView, theUpdateSet, theError);
