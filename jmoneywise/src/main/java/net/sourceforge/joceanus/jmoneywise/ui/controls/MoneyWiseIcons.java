...
public final class MoneyWiseIcons
     ...
     * The locked icon.
     */
    private static final Icon ICON_LOCKED = resizeImage(new ImageIcon(MoneyWiseIcons.class.getResource("icons/BlueJellyClosedBook.png")));

    /**
     * The unlocked icon.
     */
    private static final Icon ICON_UNLOCKED = resizeImage(new ImageIcon(MoneyWiseIcons.class.getResource("icons/BlueJellyOpenBook.png")));

    /**
     * The unlock-able icon.
     */
    private static final Icon ICON_UNLOCKABLE = resizeImage(new ImageIcon(MoneyWiseIcons.class.getResource("icons/GreenJellyClosedBook.png")));

    /**
     * The lock-able icon.
     */
    private static final Icon ICON_LOCKABLE = resizeImage(new ImageIcon(MoneyWiseIcons.class.getResource("icons/GreenJellyOpenBook.png")));

    /**
     * The DirectionTo locked icon.
     */
    private static final Icon ICON_DIRTOLOCKED = resizeImage(new ImageIcon(MoneyWiseIcons.class.getResource("icons/BlueJellyDirectionTo.png")));

    /**
     * The DirectionFrom locked icon.
     */
    private static final Icon ICON_DIRFROMLOCKED = resizeImage(new ImageIcon(MoneyWiseIcons.class.getResource("icons/BlueJellyDirectionFrom.png")));

    /**
     * The DirectionTo icon.
     */
    private static final Icon ICON_DIRTO = resizeImage(new ImageIcon(MoneyWiseIcons.class.getResource("icons/GreenJellyDirectionTo.png")));

    /**
     * The DirectionFrom icon.
     */
    private static final Icon ICON_DIRFROM = resizeImage(new ImageIcon(MoneyWiseIcons.class.getResource("icons/GreenJellyDirectionFrom.png")));
     ...
     */
    private static final String TIP_DIRTO = MoneyWiseUIControlResource.ICON_DIRTO.getValue();

    /**
     * DirectionFrom Button ToolTip.
     */
    private static final String TIP_DIRFROM = MoneyWiseUIControlResource.ICON_DIRFROM.getValue();
