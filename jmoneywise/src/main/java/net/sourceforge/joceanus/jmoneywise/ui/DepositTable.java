...
public class DepositTable
     ...
     */
    private final transient JDataEntry theDataDeposits;
    ...
    public DepositTable(final View pView) {
        ...
        theDataDeposits = myDataMgr.new JDataEntry(DepositTable.class.getSimpleName());
        theDataDeposits.addAsChildOf(mySection);
        theDataDeposits.setObject(theUpdateSet);

        /* Create the save buttons */
        theSaveButtons = new SaveButtons(theUpdateSet);

        /* Create the error panel for this view */
        theError = new ErrorPanel(myDataMgr, theDataDeposits);

        /* Create the table model */
        DepositTableModel myModel = new DepositTableModel(this);
        setModel(myModel);
