...
import net.sourceforge.joceanus.jmoneywise.newanalysis.AccountBucket;
...
import net.sourceforge.joceanus.jmoneywise.newanalysis.BucketValues;
 ...
 */
public abstract class NewAnalysisFilter<T extends Enum<T> & BucketAttribute>
     ...
     */
    protected NewAnalysisFilter(final Class<T> pClass) {
        theClass = pClass;
    }
    ...
    public abstract static class AccountFilter<T extends AssetBase<T>>
            extends NewAnalysisFilter<AccountAttribute> {
        /**
         * The Account bucket.
         */
    ...
    public static class SecurityFilter
            extends NewAnalysisFilter<SecurityAttribute> {
        /**
         * The security bucket.
         */
    ...
    public static class PayeeFilter
            extends NewAnalysisFilter<PayeeAttribute> {
        /**
         * The payee bucket.
         */
    ...
    public static class EventCategoryFilter
            extends NewAnalysisFilter<EventAttribute> {
        /**
    ...
    public static class TaxBasisFilter
            extends NewAnalysisFilter<TaxBasisAttribute> {
        /**
         * The payee bucket.
         */
