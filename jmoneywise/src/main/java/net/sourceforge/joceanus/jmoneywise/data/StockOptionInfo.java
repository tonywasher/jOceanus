...
public class StockOptionInfo
    ...
    public static class StockOptionInfoList
        ...
        public void addInfoItem(final Integer pId,
            ...
            if (myInfoType == null) {
                throw new JMoneyWiseDataException(pOption, ERROR_BADINFOCLASS + " [" + pInfoClass + "]");
            }

            /* Create the values */
            DataValues<MoneyWiseDataType> myValues = new DataValues<MoneyWiseDataType>(StockOptionInfo.OBJECT_NAME);
        ...
        @Override
        public StockOptionInfo addValuesItem(final DataValues<MoneyWiseDataType> pValues) throws JOceanusException {
            /* Create the info */
