 ...
 * $Date$
 ******************************************************************************/
package net.sourceforge.joceanus.jmoneywise.newreports;
...
import net.sourceforge.joceanus.jmoneywise.newreports.HTMLBuilder.HTMLTable;
...
public class BalanceSheet
    ...
    public Document createReport(final Analysis pAnalysis) {
        ...
        if (!myPortfolios.isEmpty()) {
            ...
            /* Add to running totals */
            myTotal.addAmount(myValues.getMoneyValue(SecurityAttribute.VALUATION));
            myBase.addAmount(myBaseValues.getMoneyValue(SecurityAttribute.VALUATION));
            myDelta.addAmount(myValues.getMoneyValue(SecurityAttribute.DELTA));
        }
