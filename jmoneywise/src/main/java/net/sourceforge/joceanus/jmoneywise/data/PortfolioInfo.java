...
public class PortfolioInfo
     ...
     */
    @Override
    public int compareTo(final PortfolioInfo pThat) {
    ...
    public boolean applyChanges(final DataItem<?> pInfo) {
        ...
        if (!Difference.isEqual(getField(), myPortInfo.getField())) {
    ...
    public static class PortfolioInfoList
        ...
        @Override
        public PortfolioInfoList cloneList(final DataSet<?, ?> pDataSet) throws JOceanusException {
            return (PortfolioInfoList) super.cloneList(pDataSet);
        }
        ...
        public void addInfoItem(final Integer pId,
            ...
            if (myInfoType == null) {
                throw new JMoneyWiseDataException(pPortfolio, ERROR_BADINFOCLASS + " [" + pInfoClass + "]");
            }
        ...
        @Override
        public PortfolioInfo addValuesItem(final DataValues<MoneyWiseDataType> pValues) throws JOceanusException {
            /* Create the info */
