...
public class ThemisCommitMgr {
     ...
     */
    public void commitChanges(final ThemisJiraIssue pIssue,
        ...
        try {
            ...
            if (myPackets.length > 1) {
                throw new ThemisLogicException("Too many commit packets");
            }
            ...
            throw new ThemisIOException("Failed to commit changes", e);
        }
    }
