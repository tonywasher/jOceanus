...
import net.sourceforge.joceanus.jthemis.threads.swing.ThemisScmThread;

/**
 * Status window for SubVersion operations.
 * @author Tony Washer
 */
public class ThemisSvnStatusWindow
     ...
     * SvnManager.
     */
    private final ThemisSvnManager theManager;
     ...
     * The active thread.
     */
    private ThemisScmThread theThread = null;

    /**
     * The current status.
     */
    private ThemisScmStatus theStatus = new ThemisScmStatus();

    /**
     * Constructor.
     * @param pManager the manager
     */
    protected ThemisSvnStatusWindow(final ThemisSvnManager pManager) {
        /* Store the manager */
        theManager = pManager;
     ...
     */
    protected void runThread(final ThemisScmThread pThread) {
    ...
    @Override
    public void setNewStatus(final ThemisScmStatus pStatus) {
        /* Set new status */
        ThemisScmStatus myOld = theStatus;
        theStatus = pStatus;
