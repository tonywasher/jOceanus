...
public class TaxYear extends DataItem<TaxYear> {
     ...
     */
    protected void setTaxYear(DateDay pTaxYear) {
    ...
    public static class TaxYearList extends DataList<TaxYearList, TaxYear> {
         ...
         */
        protected TaxYearList(FinanceData pData) {
         ...
         */
        private TaxYearList(TaxYearList pSource) {
            super(pSource);
         ...
         */
        private TaxYearList getExtractList(ListStyle pStyle) {
        ...
        @Override
        public TaxYearList getDeepCopy(DataSet<?> pDataSet) {
            /* Build an empty Extract List */
            TaxYearList myList = new TaxYearList(this);
         ...
         */
        @Override
        protected TaxYearList getDifferences(TaxYearList pOld) {
         ...
         */
        public TaxYearList getEditList(TaxYear pTaxYear) {
            /* Build an empty List */
            TaxYearList myList = new TaxYearList(this);
        ...
        public TaxYear searchFor(String pYear) {
            ...
            /* Loop through the items to find the entry */
            while ((myCurr = myIterator.next()) != null) {
                isMatch = (uYear == (long) myCurr.getTaxYear().getYear());
                if (isMatch)
                    break;
            }
