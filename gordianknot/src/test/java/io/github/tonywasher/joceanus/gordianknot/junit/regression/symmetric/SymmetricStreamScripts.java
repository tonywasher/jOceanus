...
import io.github.tonywasher.joceanus.gordianknot.junit.regression.symmetric.SymmetricStore.FactoryStreamCipherSpec;
import io.github.tonywasher.joceanus.gordianknot.junit.regression.symmetric.SymmetricStore.FactoryStreamKeySpec;
import io.github.tonywasher.joceanus.gordianknot.junit.regression.symmetric.SymmetricStore.FactoryStreamPBECipherSpec;
...
public class SymmetricStreamScripts {
    ...
    private static Stream<DynamicNode> streamKeyTests(final FactoryStreamKeySpec pKeySpec) {
        ...
        final FactoryStreamCipherSpec myCipherSpec = new FactoryStreamCipherSpec(pKeySpec, myBuilder.streamCipher(pKeySpec.getSpec()));
        ...
        if (pKeySpec.hasAADVersion()) {
            final FactoryStreamCipherSpec myAADSpec = new FactoryStreamCipherSpec(pKeySpec, myBuilder.streamCipher(pKeySpec.getSpec(), true));
