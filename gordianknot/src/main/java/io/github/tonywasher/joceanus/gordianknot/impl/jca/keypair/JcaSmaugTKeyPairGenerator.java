...
public class JcaSmaugTKeyPairGenerator
     ...
     */
    JcaSmaugTKeyPairGenerator(final GordianBaseFactory pFactory,
        ...
        try {
            ...
            createFactories(SMAUG_ALGO, true);
            final GordianCoreKeyPairSpec myKeySpec = (GordianCoreKeyPairSpec) pKeySpec;
            final SmaugTParameterSpec myParms = myKeySpec.getSmaugTSpec().getParameterSpec();
            getGenerator().initialize(myParms, getRandom());

        } catch (InvalidAlgorithmParameterException e) {
            throw new GordianCryptoException("Failed to create SmaugTgenerator", e);
        }
    }
}
