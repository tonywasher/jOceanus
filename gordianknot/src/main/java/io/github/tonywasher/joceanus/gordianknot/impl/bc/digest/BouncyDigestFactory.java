...
public class BouncyDigestFactory
     ...
     */
    public BouncyDigestFactory(final GordianBaseFactory pFactory) {
     ...
     * @return the digest
     */
    public static GordianBlake2Base getBlake2Digest(final GordianCoreDigestSpec pSpec) {
     ...
     * @return the digest
     */
    public static GordianBlake2Xof getBlake2Xof(final GordianCoreDigestSpec pSpec) {
