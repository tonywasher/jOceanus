...
public final class BouncySNTRUPrimeKeyPair {
    ...
    public static class BouncySNTRUPrimePublicKey
         ...
         */
        BouncySNTRUPrimePublicKey(final GordianNewKeyPairSpec pKeySpec,
    ...
    public static class BouncySNTRUPrimePrivateKey
         ...
         */
        BouncySNTRUPrimePrivateKey(final GordianNewKeyPairSpec pKeySpec,
     ...
     */
    public static class BouncySNTRUPrimeAgreementEngine
