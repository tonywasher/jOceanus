...
/**
 * Core Agreement Parameters.
 */
public class GordianCoreAgreeParams
        implements GordianNewAgreeParams {
    /**
     * The factory.
     */
     ...
     */
    GordianCoreAgreeParams(final GordianCoreAgreementSupplier pSupplier,
     ...
     */
    GordianCoreAgreeParams(final GordianCoreAgreementBuilder pBuilder) {
        /* Copy all fields */
     ...
     */
    GordianCoreAgreeParams(final GordianCoreAgreeParams pSource) {
        /* Copy all fields */
     ...
     *
     * @param pSigner   the signer certificate
     * @param pSignSpec the signer specification
     * @throws GordianException on error
     */
     ...
     * @throws GordianException on error
     */
    void setAdditionalData(final byte[] pData) throws GordianException {
        ...
        /* Update the parameters */
        theAdditional = pData == null ? null : pData.clone();
    }
}
