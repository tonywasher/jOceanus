...
import io.github.tonywasher.joceanus.gordianknot.impl.bc.keypair.BouncyFrodoKeyPair.BouncyFrodoPrivateKey;
import io.github.tonywasher.joceanus.gordianknot.impl.bc.keypair.BouncyFrodoKeyPair.BouncyFrodoPublicKey;
...
/**
 * Frodo Agreement Engine.
 */
public class BouncyFrodoAgreementEngine
     ...
     */
    BouncyFrodoAgreementEngine(final GordianCoreAgreementFactory pFactory,
    ...
    public void buildClientHello() throws GordianException {
        ...
        try {
            ...
            final BouncyFrodoPublicKey myPublic = (BouncyFrodoPublicKey) getPublicKey(getServerKeyPair());
            final FrodoKEMGenerator myGenerator = new FrodoKEMGenerator(getRandom());
    ...
    public void processClientHello() throws GordianException {
        /* Create encapsulation */
        final BouncyFrodoPrivateKey myPrivate = (BouncyFrodoPrivateKey) getPrivateKey(getServerKeyPair());
