 ...
 */
public class GordianCoreSignatureAlgId {
    /**
     * SignatureOID branch.
     */
     ...
     */
    GordianCoreSignatureAlgId(final GordianBaseFactory pFactory) {
        /* Create the maps */
        ...
        for (GordianCoreKeyPairType myKeyType : GordianCoreKeyPairType.values()) {
            ...
            addSignatures(myKeyType.getType());
        }
    }
    ...
    AlgorithmIdentifier getIdentifierForSpecAndKeyPair(final GordianSignatureSpec pSpec,
        ...
        final GordianCoreKeyPairType myKeyPairType = GordianCoreKeyPairType.mapCoreType(pSpec.getKeyPairType());
        if (myKeyPairType.subTypeForSignatures()) {
            /* Look up in the subKey map */
            final Map<Object, AlgorithmIdentifier> myMap = theSpecSubTypeMap.get(pSpec);
            return myMap == null
                    ? null
                    : myMap.get(pKeyPair.getKeyPairSpec().getSubSpec());
        }

        /* DDSA shares OID with DSA */
        final GordianSignatureSpec mySpec = GordianSignatureType.DDSA.equals(pSpec.getSignatureType())
                ? ((GordianCoreSignatureSpec) pSpec).asSignatureType(GordianSignatureType.DSA)
                : pSpec;

        /* Look up in the standard map */
        return theSpecMap.get(mySpec);
    }
    ...
    public GordianSignatureSpec getSpecForIdentifier(final AlgorithmIdentifier pIdentifier) {
        ...
        if (MiscObjectIdentifiers.id_alg_composite.equals(pIdentifier.getAlgorithm())) {
            ...
            return mySigBuilder.composite(myList);
        }
    ...
    private void addRSASignatures() {
        ...
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha1()),
        ...
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha2(GordianLength.LEN_224)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS,
                        createPSSParams(NISTObjectIdentifiers.id_sha224, GordianLength.LEN_224)));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha2(GordianLength.LEN_256)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS,
                        createPSSParams(NISTObjectIdentifiers.id_sha256, GordianLength.LEN_256)));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha2(GordianLength.LEN_384)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS,
                        createPSSParams(NISTObjectIdentifiers.id_sha384, GordianLength.LEN_384)));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha2(GordianLength.LEN_512)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS,
                        createPSSParams(NISTObjectIdentifiers.id_sha512, GordianLength.LEN_512)));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha3(GordianLength.LEN_224)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS,
                        createPSSParams(NISTObjectIdentifiers.id_sha3_224, GordianLength.LEN_224)));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha3(GordianLength.LEN_256)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS,
                        createPSSParams(NISTObjectIdentifiers.id_sha3_256, GordianLength.LEN_256)));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha3(GordianLength.LEN_384)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS,
                        createPSSParams(NISTObjectIdentifiers.id_sha3_384, GordianLength.LEN_384)));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSSMGF1, myDigestBuilder.sha3(GordianLength.LEN_512)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS,
                        createPSSParams(NISTObjectIdentifiers.id_sha3_512, GordianLength.LEN_512)));

        addPSS128Algorithms(myDigestBuilder.sha2(GordianLength.LEN_224),
                NISTObjectIdentifiers.id_sha224, GordianLength.LEN_224);
        addPSS128Algorithms(myDigestBuilder.sha2(GordianLength.LEN_256),
                NISTObjectIdentifiers.id_sha256, GordianLength.LEN_256);
        addPSS128Algorithms(myDigestBuilder.sha2(GordianLength.LEN_384),
                NISTObjectIdentifiers.id_sha384, GordianLength.LEN_384);
        addPSS128Algorithms(myDigestBuilder.sha2(GordianLength.LEN_512),
                NISTObjectIdentifiers.id_sha512, GordianLength.LEN_512);
        addPSS128Algorithms(myDigestBuilder.sha3(GordianLength.LEN_224),
                NISTObjectIdentifiers.id_sha3_224, GordianLength.LEN_224);
        addPSS128Algorithms(myDigestBuilder.sha3(GordianLength.LEN_256),
                NISTObjectIdentifiers.id_sha3_256, GordianLength.LEN_256);
        addPSS128Algorithms(myDigestBuilder.sha3(GordianLength.LEN_384),
                NISTObjectIdentifiers.id_sha3_384, GordianLength.LEN_384);
        addPSS128Algorithms(myDigestBuilder.sha3(GordianLength.LEN_512),
                NISTObjectIdentifiers.id_sha3_512, GordianLength.LEN_512);
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSS128, myDigestBuilder.shake128()),
                new AlgorithmIdentifier(X509ObjectIdentifiers.id_rsassa_pss_shake128, DERNull.INSTANCE));

        addPSS256Algorithms(myDigestBuilder.sha2(GordianLength.LEN_224),
                NISTObjectIdentifiers.id_sha224, GordianLength.LEN_224);
        addPSS256Algorithms(myDigestBuilder.sha2(GordianLength.LEN_256),
                NISTObjectIdentifiers.id_sha256, GordianLength.LEN_256);
        addPSS256Algorithms(myDigestBuilder.sha2(GordianLength.LEN_384),
                NISTObjectIdentifiers.id_sha384, GordianLength.LEN_384);
        addPSS256Algorithms(myDigestBuilder.sha2(GordianLength.LEN_512),
                NISTObjectIdentifiers.id_sha512, GordianLength.LEN_512);
        addPSS256Algorithms(myDigestBuilder.sha3(GordianLength.LEN_224),
                NISTObjectIdentifiers.id_sha3_224, GordianLength.LEN_224);
        addPSS256Algorithms(myDigestBuilder.sha3(GordianLength.LEN_256),
                NISTObjectIdentifiers.id_sha3_256, GordianLength.LEN_256);
        addPSS256Algorithms(myDigestBuilder.sha3(GordianLength.LEN_384),
                NISTObjectIdentifiers.id_sha3_384, GordianLength.LEN_384);
        addPSS256Algorithms(myDigestBuilder.sha3(GordianLength.LEN_512),
                NISTObjectIdentifiers.id_sha3_512, GordianLength.LEN_512);
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSS256, myDigestBuilder.shake256()),
                new AlgorithmIdentifier(X509ObjectIdentifiers.id_rsassa_pss_shake256, DERNull.INSTANCE));

        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.md2()),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.md2WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.md4()),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.md4WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.md5()),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.md5WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha1()),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.sha1WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha2(GordianLength.LEN_224)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.sha224WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha2(GordianLength.LEN_256)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.sha256WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha2(GordianLength.LEN_384)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.sha384WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha2(GordianLength.LEN_512)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.sha512WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha2(GordianDigestState.STATE512, GordianLength.LEN_224)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.sha512_224WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha2(GordianDigestState.STATE512, GordianLength.LEN_256)),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.sha512_256WithRSAEncryption, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha3(GordianLength.LEN_224)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_224, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha3(GordianLength.LEN_256)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_256, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha3(GordianLength.LEN_384)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_384, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.sha3(GordianLength.LEN_512)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_rsassa_pkcs1_v1_5_with_sha3_512, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.ripemd(GordianLength.LEN_128)),
                new AlgorithmIdentifier(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd128, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.ripemd(GordianLength.LEN_160)),
                new AlgorithmIdentifier(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd160, DERNull.INSTANCE));
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PREHASH, myDigestBuilder.ripemd(GordianLength.LEN_256)),
    ...
    private void addDSASignatures() {
        final GordianSignatureSpecBuilder mySigBuilder = GordianCoreSignatureSpecBuilder.newInstance();
        final GordianDigestSpecBuilder myDigestBuilder = GordianCoreDigestSpecBuilder.newInstance();
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha1()),
                new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa_with_sha1, DERNull.INSTANCE));
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha2(GordianLength.LEN_224)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.dsa_with_sha224, DERNull.INSTANCE));
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha2(GordianLength.LEN_256)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.dsa_with_sha256, DERNull.INSTANCE));
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha2(GordianLength.LEN_384)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.dsa_with_sha384, DERNull.INSTANCE));
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha2(GordianLength.LEN_512)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.dsa_with_sha512, DERNull.INSTANCE));
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha3(GordianLength.LEN_224)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_dsa_with_sha3_224, DERNull.INSTANCE));
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha3(GordianLength.LEN_256)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_dsa_with_sha3_256, DERNull.INSTANCE));
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha3(GordianLength.LEN_384)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_dsa_with_sha3_384, DERNull.INSTANCE));
        addToMaps(mySigBuilder.dsa(GordianSignatureType.DSA, myDigestBuilder.sha3(GordianLength.LEN_512)),
    ...
    private void addECSignatures() {
        final GordianSignatureSpecBuilder mySigBuilder = GordianCoreSignatureSpecBuilder.newInstance();
        final GordianDigestSpecBuilder myDigestBuilder = GordianCoreDigestSpecBuilder.newInstance();
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha1()),
                new AlgorithmIdentifier(X9ObjectIdentifiers.ecdsa_with_SHA1, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha2(GordianLength.LEN_224)),
                new AlgorithmIdentifier(X9ObjectIdentifiers.ecdsa_with_SHA224, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha2(GordianLength.LEN_256)),
                new AlgorithmIdentifier(X9ObjectIdentifiers.ecdsa_with_SHA256, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha2(GordianLength.LEN_384)),
                new AlgorithmIdentifier(X9ObjectIdentifiers.ecdsa_with_SHA384, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha2(GordianLength.LEN_512)),
                new AlgorithmIdentifier(X9ObjectIdentifiers.ecdsa_with_SHA512, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha3(GordianLength.LEN_224)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_ecdsa_with_sha3_224, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha3(GordianLength.LEN_256)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_ecdsa_with_sha3_256, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha3(GordianLength.LEN_384)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_ecdsa_with_sha3_384, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.sha3(GordianLength.LEN_512)),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_ecdsa_with_sha3_512, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.shake128()),
                new AlgorithmIdentifier(X509ObjectIdentifiers.id_ecdsa_with_shake128, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.shake256()),
                new AlgorithmIdentifier(X509ObjectIdentifiers.id_ecdsa_with_shake256, DERNull.INSTANCE));
        addToMaps(mySigBuilder.ec(GordianSignatureType.DSA, myDigestBuilder.ripemd(GordianLength.LEN_160)),
                new AlgorithmIdentifier(TeleTrusTObjectIdentifiers.ecSignWithRipemd160, DERNull.INSTANCE));
    }
    ...
    private void addSM2Signatures() {
        final GordianSignatureSpecBuilder mySigBuilder = GordianCoreSignatureSpecBuilder.newInstance();
        final GordianDigestSpecBuilder myDigestBuilder = GordianCoreDigestSpecBuilder.newInstance();
        addToMaps(mySigBuilder.sm2(myDigestBuilder.sm3()),
                new AlgorithmIdentifier(GMObjectIdentifiers.sm2sign_with_sm3, DERNull.INSTANCE));
        addToMaps(mySigBuilder.sm2(myDigestBuilder.sha2(GordianLength.LEN_256)),
    ...
    private void addPSS128Algorithms(final GordianDigestSpec pSpec,
                                     ...
                                     final GordianLength pSaltSize) {
        final GordianSignatureSpecBuilder mySigBuilder = GordianCoreSignatureSpecBuilder.newInstance();
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSS128, pSpec),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS, createPSS128Params(pHash, pSaltSize)));
    }
    ...
    private static RSASSAPSSparams createPSS128Params(final ASN1ObjectIdentifier pHash,
                                                      final GordianLength pSaltSize) {
        return new RSASSAPSSparams(new AlgorithmIdentifier(pHash, DERNull.INSTANCE),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_shake128, DERNull.INSTANCE),
                new ASN1Integer(pSaltSize.getByteLength()),
                new ASN1Integer(1));
    }
    ...
    private void addPSS256Algorithms(final GordianDigestSpec pSpec,
        ...
        final GordianSignatureSpecBuilder mySigBuilder = GordianCoreSignatureSpecBuilder.newInstance();
        addToMaps(mySigBuilder.rsa(GordianSignatureType.PSS256, pSpec),
                new AlgorithmIdentifier(PKCSObjectIdentifiers.id_RSASSA_PSS, createPSS256Params(pHash, pSaltSize)));
    }
    ...
    private static RSASSAPSSparams createPSS256Params(final ASN1ObjectIdentifier pHash,
                                                      final GordianLength pSaltSize) {
        return new RSASSAPSSparams(new AlgorithmIdentifier(pHash, DERNull.INSTANCE),
                new AlgorithmIdentifier(NISTObjectIdentifiers.id_shake256, DERNull.INSTANCE),
                new ASN1Integer(pSaltSize.getByteLength()),
                new ASN1Integer(1));
    }
    ...
    private void addSignatures(final GordianKeyPairType pKeyType) {
        for (GordianSignatureSpec mySpec : theFactory.listAllSupportedSignatures(pKeyType)) {
            /* DDSA signatures share mappings with DSA */
            if (!GordianSignatureType.DDSA.equals(mySpec.getSignatureType())) {
    ...
    private void addSignature(final GordianSignatureSpec pSigSpec) {
        ...
        final GordianCoreSignatureSpec mySigSpec = (GordianCoreSignatureSpec) pSigSpec;
        ...
        final GordianSignatureType mySigType = mySigSpec.getSignatureType();
        ...
        if (pSigSpec.getSignatureSpec() instanceof GordianDigestSpec) {
            ...
            final GordianDigestSpec myDigestSpec = mySigSpec.getDigestSpec();
