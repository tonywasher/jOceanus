 ...
 */
public class GordianCoreEncryptorAlgId {
    /**
     * EncryptorOID branch.
     */
     ...
     */
    GordianCoreEncryptorAlgId(final GordianBaseFactory pFactory) {
        /* Create the maps */
    ...
    public AlgorithmIdentifier getIdentifierForSpec(final GordianEncryptorSpec pSpec) {
        ...
        if (pSpec.getKeyPairType() == GordianKeyPairType.COMPOSITE) {
            ...
            final Iterator<GordianEncryptorSpec> myIterator = mySpec.encryptorSpecIterator();
    ...
    public GordianEncryptorSpec getSpecForIdentifier(final AlgorithmIdentifier pIdentifier) {
        ...
        if (MiscObjectIdentifiers.id_alg_composite.equals(pIdentifier.getAlgorithm())) {
            final GordianEncryptorSpecBuilder myBuilder = GordianCoreEncryptorSpecBuilder.newInstance();
