...
public final class BouncyNTRUKeyPair {
    ...
    public static class BouncyNTRUPublicKey
         ...
         */
        BouncyNTRUPublicKey(final GordianNewKeyPairSpec pKeySpec,
    ...
    public static class BouncyNTRUPrivateKey
         ...
         */
        BouncyNTRUPrivateKey(final GordianNewKeyPairSpec pKeySpec,
     ...
     */
    public static class BouncyNTRUAgreementEngine
