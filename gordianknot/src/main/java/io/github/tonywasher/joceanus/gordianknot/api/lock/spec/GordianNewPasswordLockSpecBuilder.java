 ...
 */
public interface GordianNewPasswordLockSpecBuilder {
    /**
     * create passwordLockSpec.
     *
     * @return the passwordLockSpec
     */
    GordianNewPasswordLockSpec passwordLock();
     ...
     * @return the passwordLockSpec
     */
    GordianNewPasswordLockSpec passwordLock(int pKIterations);
     ...
     * @return the passwordLockSpec
     */
    GordianNewPasswordLockSpec passwordLock(GordianNewKeySetSpec pKeySetSpec);
     ...
     */
    GordianNewPasswordLockSpec passwordLock(int pKIterations,
                                            GordianNewKeySetSpec pKeySetSpec);
}
