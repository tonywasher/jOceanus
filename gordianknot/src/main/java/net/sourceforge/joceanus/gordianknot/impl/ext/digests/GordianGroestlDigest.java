...
public class GordianGroestlDigest
     ...
     */
    private final GordianGroestlFastDigest theDigest;
     ...
     */
    public GordianGroestlDigest(final int pHashBitLen) {
        theDigest = new GordianGroestlFastDigest(pHashBitLen);
     ...
     */
    public GordianGroestlDigest(final GordianGroestlDigest pDigest) {
        theDigestLen = pDigest.theDigestLen;
        theDigest = new GordianGroestlFastDigest(theDigestLen * Byte.SIZE);
    ...
    public GordianGroestlDigest copy() {
        return new GordianGroestlDigest(this);
    }

    @Override
    public void reset(final Memoable pState) {
        final GordianGroestlDigest d = (GordianGroestlDigest) pState;
     ...
     */
    private static class GordianGroestlFastDigest {
        /* Constants */
