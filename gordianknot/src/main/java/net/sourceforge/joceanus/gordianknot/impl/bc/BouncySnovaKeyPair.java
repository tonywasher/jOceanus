...
public final class BouncySnovaKeyPair {
    ...
    public static class BouncySnovaSignature
        ...
        public void initForSigning(final GordianKeyPair pKeyPair) throws GordianException {
            ...
            final BouncySnovaPrivateKey myPrivate = (BouncySnovaPrivateKey) getKeyPair().getPrivateKey();
        ...
        public void initForVerify(final GordianKeyPair pKeyPair) throws GordianException {
            ...
            /* Initialise and set the signer */
            final BouncySnovaPublicKey myPublic = (BouncySnovaPublicKey) getKeyPair().getPublicKey();
