...
public final class BouncyFrodoKeyPair {
    ...
    public static class BouncyFrodoKeyPairGenerator
         ...
         */
        BouncyFrodoKeyPairGenerator(final GordianCoreFactory pFactory,
         ...
         * @throws GordianException on error
         */
        private BouncyFrodoPublicKey derivePublicKey(final X509EncodedKeySpec pEncodedKey) throws GordianException {
            /* Protect against exceptions */
            try {
                /* Check the keySpecs */
    ...
    public static class BouncyFrodoAgreement
         ...
         */
        BouncyFrodoAgreement(final GordianCoreFactory pFactory,
     ...
     */
    public static class BouncyFrodoXAgreementEngine
         ...
         * @throws GordianException on error
         */
        BouncyFrodoXAgreementEngine(final GordianXCoreAgreementFactory pFactory,
