...
public final class BouncyCMCEKeyPair {
    ...
    public static class BouncyCMCEKeyPairGenerator
         ...
         */
        BouncyCMCEKeyPairGenerator(final GordianCoreFactory pFactory,
    ...
    public static class BouncyCMCEAgreement
         ...
         */
        BouncyCMCEAgreement(final GordianCoreFactory pFactory,
    ...
    /**
     * CMCE XAgreement Engine.
     */
    public static class BouncyCMCEXAgreementEngine
         ...
         * @throws GordianException on error
         */
        BouncyCMCEXAgreementEngine(final GordianXCoreAgreementFactory pFactory,
