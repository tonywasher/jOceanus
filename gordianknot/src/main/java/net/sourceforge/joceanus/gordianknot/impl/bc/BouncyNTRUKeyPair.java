...
public final class BouncyNTRUKeyPair {
    ...
    public static class BouncyNTRUKeyPairGenerator
         ...
         */
        BouncyNTRUKeyPairGenerator(final GordianCoreFactory pFactory,
         ...
         * @throws GordianException on error
         */
        private BouncyNTRUPublicKey derivePublicKey(final X509EncodedKeySpec pEncodedKey) throws GordianException {
            /* Protect against exceptions */
            try {
                /* Check the keySpecs */
    ...
    public static class BouncyNTRUAgreement
         ...
         */
        BouncyNTRUAgreement(final GordianCoreFactory pFactory,
    ...
    /**
     * NTRU XAgreement Engine.
     */
    public static class BouncyNTRUXAgreementEngine
         ...
         * @throws GordianException on error
         */
        BouncyNTRUXAgreementEngine(final GordianXCoreAgreementFactory pFactory,
