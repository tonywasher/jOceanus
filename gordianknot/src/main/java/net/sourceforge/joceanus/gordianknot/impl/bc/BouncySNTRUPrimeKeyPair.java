...
public final class BouncySNTRUPrimeKeyPair {
    ...
    public static class BouncySNTRUPrimeKeyPairGenerator
         ...
         */
        BouncySNTRUPrimeKeyPairGenerator(final GordianCoreFactory pFactory,
    ...
    public static class BouncySNTRUPrimeAgreement
         ...
         */
        BouncySNTRUPrimeAgreement(final GordianCoreFactory pFactory,
    ...
    /**
     * SNTRUPrime XAgreement Engine.
     */
    public static class BouncySNTRUPrimeXAgreementEngine
         ...
         * @throws GordianException on error
         */
        BouncySNTRUPrimeXAgreementEngine(final GordianXCoreAgreementFactory pFactory,
