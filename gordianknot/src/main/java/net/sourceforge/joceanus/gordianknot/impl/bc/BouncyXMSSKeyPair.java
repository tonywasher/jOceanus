...
public final class BouncyXMSSKeyPair {
    ...
    public static class BouncyXMSSKeyPairGenerator
         ...
         * @param pKeySpec the keySpec
         */
        BouncyXMSSKeyPairGenerator(final GordianCoreFactory pFactory,
    ...
    public static class BouncyXMSSMTKeyPairGenerator
         ...
         * @param pKeySpec the keySpec
         */
        BouncyXMSSMTKeyPairGenerator(final GordianCoreFactory pFactory,
                                     final GordianKeyPairSpec pKeySpec) {
            /* Initialise underlying class */
            super(pFactory, pKeySpec);
    ...
    public static class BouncyXMSSSignature
         ...
         * @throws GordianException on error
         */
        BouncyXMSSSignature(final GordianCoreFactory pFactory,
