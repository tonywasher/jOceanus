...
public final class BouncyHQCKeyPair {
    ...
    public static class BouncyHQCKeyPairGenerator
         ...
         */
        BouncyHQCKeyPairGenerator(final GordianCoreFactory pFactory,
    ...
    public static class BouncyHQCAgreement
         ...
         */
        BouncyHQCAgreement(final GordianCoreFactory pFactory,
    ...
    /**
     * HQC XAgreement Engine.
     */
    public static class BouncyHQCXAgreementEngine
         ...
         * @throws GordianException on error
         */
        BouncyHQCXAgreementEngine(final GordianXCoreAgreementFactory pFactory,
