...
public class GordianSkeinTree
     ...
     */
    private final GordianSkeinBase theDigest;

    /**
     * The TreeStore.
     */
    private final GordianSkeinTreeStore theStore;
     ...
     */
    public GordianSkeinTree(final GordianSkeinBase pDigest) {
        /* Store parameters and initialise store */
        theDigest = pDigest;
        theStore = new GordianSkeinTreeStore(pDigest);
     ...
     * The Skein tree.
     */
    private static class GordianSkeinTreeStore {
        /**
         * The underlying Skein instance.
         */
        private final GordianSkeinBase theDigest;
         ...
         * @param pDigest the underlying digest.
         */
        GordianSkeinTreeStore(final GordianSkeinBase pDigest) {
            /* Store details */
            theDigest = pDigest;
