 ...
 */
public class GordianGCFBBlockCipher
        extends StreamBlockCipher
{
    ...
    private final GordianCFBBlockCipher cfbEngine;
    ...
    public GordianGCFBBlockCipher(BlockCipher engine)
    {
        super(engine);

        this.cfbEngine = new GordianCFBBlockCipher(engine, engine.getBlockSize() * 8);
    }
