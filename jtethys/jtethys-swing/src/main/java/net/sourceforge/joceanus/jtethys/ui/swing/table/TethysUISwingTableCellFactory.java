...
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableCharArrayColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableDateColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableDilutedPriceColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableDilutionColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableIconColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableIntegerColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableListColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableLongColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableMoneyColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTablePriceColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableRateColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableRatioColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableRawDecimalColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableScrollColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableShortColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableStringColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableUnitsColumn;
import net.sourceforge.joceanus.jtethys.ui.swing.table.TethysUISwingTableManager.TethysUISwingTableValidatedColumn;
...
public class TethysUISwingTableCellFactory<C, R> {
     ...
     */
    public abstract static class TethysUISwingTableCell<T, C, R>
     ...
     * @param <R> the table item class
     */
    public static class TethysUISwingTableDilutedPriceCell<C, R>
            extends TethysUISwingTableCell<TethysDilutedPrice, C, R> {
        /**
         * Constructor.
         *
         * @param pColumn  the column
         * @param pFactory the GUI Factory
         */
        TethysUISwingTableDilutedPriceCell(final TethysUISwingTableDilutedPriceColumn<C, R> pColumn,
                                           final TethysUICoreFactory<?> pFactory) {
            super(pColumn, (TethysUISwingDilutedPriceTextField) pFactory.fieldFactory().newDilutedPriceField(), TethysDilutedPrice.class);
            getControl().setDeemedCurrency(() -> getColumn().getDeemedCurrency().apply(getActiveRow()));
        }

        @Override
        public TethysUISwingTableDilutedPriceColumn<C, R> getColumn() {
            return (TethysUISwingTableDilutedPriceColumn<C, R>) super.getColumn();
        }

        @Override
        public TethysUISwingDilutedPriceTextField getControl() {
            return (TethysUISwingDilutedPriceTextField) super.getControl();
        }
    }
