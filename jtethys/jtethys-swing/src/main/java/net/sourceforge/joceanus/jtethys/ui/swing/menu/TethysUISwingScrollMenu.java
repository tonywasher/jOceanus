 ...
 ******************************************************************************/
package net.sourceforge.joceanus.jtethys.ui.swing.menu;
...
public class TethysUISwingScrollMenu<T>
    ...
    public abstract static class TethysUISwingScrollElement {
        ...
        private TethysUISwingScrollElement(final String pName,
            ...
            final Dimension myDim = new Dimension(TethysUICoreFactory.DEFAULT_ICONWIDTH, DEFAULT_ROWHEIGHT);
    ...
    private static final class TethysUISwingScrollToggle<T>
        ...
        public void setSelected(final boolean pSelected) {
            ...
            setIcon(isSelected
                    ? TethysUISwingUtils.getIconAtSize(TethysUIScrollIcon.CHECKMARK, TethysUICoreFactory.DEFAULT_ICONWIDTH)
                    : null);
        }
