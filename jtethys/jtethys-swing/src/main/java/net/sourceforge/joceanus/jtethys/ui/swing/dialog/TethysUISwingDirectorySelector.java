...
import net.sourceforge.joceanus.jtethys.ui.core.dialog.TethysUICoreDirectorySelector;
...
public class TethysUISwingDirectorySelector
     ...
     * Logger.
     */
    private static final TethysLogger LOGGER = TethysLogManager.getLogger(TethysUISwingDirectorySelector.class);
