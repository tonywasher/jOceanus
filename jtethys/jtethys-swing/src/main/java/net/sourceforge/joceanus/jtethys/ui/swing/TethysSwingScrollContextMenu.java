...
public class TethysSwingScrollContextMenu<T>
     ...
     * Constructor.
     */
    public TethysSwingScrollContextMenu() {
     ...
     */
    public TethysSwingScrollContextMenu(final int pMaxDisplayItems) {
    ...
    private void createDialog(final Component pOwner) {
        ...
        theDialog = pOwner instanceof TethysSwingScrollSubMenu
                                                               ? new JDialog(((TethysSwingScrollSubMenu<?>) pOwner).getDialog(), false)
    ...
    protected static class TethysSwingScrollMenuItem<T>
         ...
         * Parent context menu.
         */
        private final transient TethysSwingScrollContextMenu<T> theContext;
    ...
    public static final class TethysSwingScrollSubMenu<T>
         ...
         * Associated value.
         */
        private final transient TethysSwingScrollContextMenu<T> theSubMenu;
        ...
        private TethysSwingScrollSubMenu(final TethysSwingScrollContextMenu<T> pContext,
            ...
            addMouseListener(new MouseAdapter() {
                ...
                public void mouseEntered(final MouseEvent e) {
                    ...
                    /* Show the menu */
                    theSubMenu.showMenuAtPosition(TethysSwingScrollSubMenu.this, SwingConstants.RIGHT);
                }
