...
public class TethysFXBorderPaneManager
    ...
    protected void setLocationVisibility(final TethysBorderLocation pLocation,
        ...
        switch (pLocation) {
            case NORTH:
                theNode.setTop(myNode);
                break;
            case SOUTH:
                theNode.setBottom(myNode);
                break;
            case WEST:
                theNode.setLeft(myNode);
                break;
            case EAST:
                theNode.setRight(myNode);
                break;
            case CENTRE:
            default:
                theNode.setCenter(myNode);
                break;
        }
    }
}
