 ...
 */
public class TethysFXThreadManager
        extends TethysThreadManager {
    /**
     * The Active status.
     */
    private final AtomicReference<TethysThreadStatus> theActiveStatus;

    /**
     * The Active worker.
     */
    private TethysFXThread<?> theWorker;
     ...
     */
    TethysFXThreadManager(final TethysGuiFactory pFactory,
    ...
    protected <T> Runnable wrapThread(final TethysThread<T> pThread) {
        ...
        theWorker = new TethysFXThread<>(getThreadData(), pThread);
    ...
    protected void publishStatus(final TethysThreadStatus pStatus) throws OceanusException {
        ...
        theActiveStatus.set(new TethysThreadStatus(pStatus));
    ...
    public void cancelWorker() {
        /* cancel the thread */
        final TethysFXThread<?> myWorker = theWorker;
        if (myWorker != null) {
