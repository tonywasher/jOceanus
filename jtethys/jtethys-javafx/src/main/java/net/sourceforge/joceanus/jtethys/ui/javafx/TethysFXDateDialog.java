...
public final class TethysFXDateDialog
     ...
     */
    public TethysFXDateDialog(final TethysDateConfig pConfig) {
    ...
    private static final class PanelNavigation {
        ...
        PanelNavigation(final TethysFXDateDialog pDialog) {
            ...
            /* Set the icons */
            thePrevMonthButton.setGraphic(TethysFXArrowIcon.LEFT.getArrow());
            theNextMonthButton.setGraphic(TethysFXArrowIcon.RIGHT.getArrow());
            thePrevYearButton.setGraphic(TethysFXArrowIcon.DOUBLELEFT.getArrow());
            theNextYearButton.setGraphic(TethysFXArrowIcon.DOUBLERIGHT.getArrow());
