 ...
 */
public abstract class TethysFXDataButtonField {
    /**
     * Private constructor.
     */
     ...
     */
    public abstract static class TethysFXDataEditButtonField<T, B extends Button>
         ...
         */
        protected TethysFXDataEditButtonField(final B pButton) {
            /* Create resources */
        ...
        public void setTextFill(final Color pColor) {
            ...
            theButton.setStyle("-fx-text-inner-color: " + TethysFXGuiUtils.colorToHexString(pColor));
        }
