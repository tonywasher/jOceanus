 ...
 * $URL: http://localhost/svn/Finance/jOceanus/trunk/jtethys/jtethys-javafx/src/test/java/net/sourceforge/joceanus/jtethys/ui/javafx/TethysFXEditUIExample.java $
 * $Revision: 842 $
 * $Author: Tony $
