 ...
 */
public class ScrollUITestHelper<I> {
    /**
     * The max items.
     */
     ...
     */
    public void buildContextMenu(final ScrollMenu<String, I> pMenu) {
        ...
        ScrollSubMenu<String, I> myMenu = addSubMenu(pMenu, "SubMenu");
     ...
     */
    private void addMenuItem(final ScrollMenu<String, I> pMenu,
                             final String pValue) {
        /* Add to context menu */
     ...
     * @return the subMenu
     */
    private ScrollSubMenu<String, I> addSubMenu(final ScrollMenu<String, I> pMenu,
                                                final String pValue) {
        /* Add to context menu */
     ...
     * @param pValue the value to add
     */
    private void addSubMenuItem(final ScrollSubMenu<String, I> pMenu,
                                final String pValue) {
        /* Add to sub menu */
     ...
     */
    public void buildAvailableItems(final ScrollMenu<String, I> pMenu,
        ...
        for (String myValue : AVAILABLE_ITEMS) {
            ScrollMenuToggleItem<String> myItem = pMenu.addToggleItem(myValue);
     ...
     */
    public void buildSimpleIconState(final SimpleIconButtonManager<Boolean, I> pIconManager,
                                     final I pFalseIcon,
                                     final I pTrueIcon) {
        /* Set the state */
     ...
     */
    public void buildStateIconState(final StateIconButtonManager<Boolean, IconState, I> pIconManager,
                                    final I pFalseIcon,
                                    final I pTrueIcon,
     ...
     */
    public void buildStateButton(final ScrollButtonManager<IconState, I> pManager) {
        ScrollMenu<IconState, I> myMenu = pManager.getMenu();
