...
public enum TethysFiscalYear {
     ...
     */
    TethysFiscalYear(final Month pMonth) {
        this(1, pMonth);
    }
     ...
     * @param pMonth the first month of fiscal year
     */
    TethysFiscalYear(final int pDay,
                     final Month pMonth) {
        theDay = pDay;
        theMonth = pMonth;
    }
     ...
     */
    public static TethysFiscalYear determineFiscalYear(final Locale pLocale) {
