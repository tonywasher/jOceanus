...
public class TethysNewDecimal {
     ...
     */
    public TethysNewDecimal(final int pScale) {
        this(0, 0, 0, pScale);
    }
     ...
     */
    public TethysNewDecimal(final BigDecimal pSource) {
     ...
     * @param pScale the number of decimal digits
     */
    public TethysNewDecimal(final long pIntegral,
     ...
     */
    public void add(final TethysNewDecimal pDecimal) {
     ...
     */
    public void subtract(final TethysNewDecimal pDecimal) {
        /* Access the integral/fractional part of the second decimal at the same scale */
        long myIntegral = pDecimal.theIntegral;
        long myFractional = adjustDecimals(pDecimal.theFractional, theScale - pDecimal.theScale);
        if (myFractional >= theFactor) {
     ...
     */
    public void multiply(final TethysNewDecimal pMultiplicand) {
     ...
     */
    public void divide(final TethysNewDecimal pDivisor) {
