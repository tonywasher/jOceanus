 ...
 * represents.
 */
public class TethysHelpPage
        implements Comparable<TethysHelpPage> {
    /**
     * Byte encoding.
     */
     ...
     */
    private final TethysHelpEntry theEntry;
     ...
     */
    public TethysHelpPage(final TethysHelpEntry pEntry,
                          final InputStream pStream) throws TethysHelpException {
     ...
     * @return the entry
     */
    public TethysHelpEntry getEntry() {
        return theEntry;
    }
    ...
    public boolean equals(final Object pThat) {
        ...
        TethysHelpPage myPage = (TethysHelpPage) pThat;
    ...
    public int hashCode() {
        ...
        myHash *= TethysHelpModule.HASH_PRIME;
        if (theHtml != null) {
    ...
    @Override
    public int compareTo(final TethysHelpPage pThat) {
        int result;
