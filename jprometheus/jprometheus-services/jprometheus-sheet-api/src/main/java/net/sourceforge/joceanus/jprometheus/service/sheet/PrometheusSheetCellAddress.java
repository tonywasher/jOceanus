 ...
 */
public class PrometheusSheetCellAddress {
    /**
     ...
     * Sheet name.
     */
    private final PrometheusSheetName theSheetName;
     ...
     */
    public PrometheusSheetCellAddress(final String pSheetName,
                                      final PrometheusSheetCellPosition pPosition) {
        /* Store parameters */
        theSheetName = new PrometheusSheetName(pSheetName, false);
     ...
     */
    PrometheusSheetCellAddress(final String pAddress) {
        /* Store parameters */
        ...
        final String myName = pAddress.substring(pAddress.charAt(0) == CHAR_DOLLAR
                                                                                   ? 1
                                                                                   : 0, iPos);
        theSheetName = new PrometheusSheetName(myName, true);
    }
     ...
     * @param pAddress the cell address
     */
    PrometheusSheetCellAddress(final String pSheetName,
     ...
     */
    void formatPosition(final StringBuilder pBuilder) {
        /* Calculate indexes */
     ...
     */
    private static PrometheusSheetCellPosition parsePosition(final String pAddress) {
        ...
        return new PrometheusSheetCellPosition(iCol - 1, iRow - 1);
    }
     ...
     */
    private static final class PrometheusSheetName {
        /**
         * The sheet name.
         */
         ...
         */
        private PrometheusSheetName(final String pName,
