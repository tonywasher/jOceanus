...
import net.sourceforge.joceanus.jprometheus.service.sheet.PrometheusSheetCellAddress;
 ...
 */
public class PrometheusExcelXSSFCell
        extends PrometheusSheetCell {
    /**
     * The underlying row.
     */
    private final PrometheusExcelXSSFRow theExcelRow;
     ...
     */
    PrometheusExcelXSSFCell(final PrometheusExcelXSSFRow pRow,
