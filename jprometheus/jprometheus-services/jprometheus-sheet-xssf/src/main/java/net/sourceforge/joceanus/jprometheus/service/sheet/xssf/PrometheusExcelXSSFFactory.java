 ...
 */
@PrometheusSheetService(PrometheusSheetWorkBookType.EXCELXLSX)
public class PrometheusExcelXSSFFactory
    ...
    public PrometheusSheetWorkBook loadFromStream(final InputStream pInput) throws OceanusException {
        return new PrometheusExcelXSSFWorkBook(pInput);
    }

    @Override
    public PrometheusSheetWorkBook newWorkBook() {
        return new PrometheusExcelXSSFWorkBook();
    }
}
