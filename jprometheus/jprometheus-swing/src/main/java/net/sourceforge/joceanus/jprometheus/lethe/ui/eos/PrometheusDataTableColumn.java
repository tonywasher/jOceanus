 ...
 */
public class PrometheusDataTableColumn
        extends TableColumn {
    /**
     * Serial Id.
     */
     ...
     */
    private AbstractTableModel theModel;
     ...
     */
    public PrometheusDataTableColumn(final int modelIndex,
                                     final int width,
    ...
    public static class JDataTableColumnModel<E extends Enum<E>>
         ...
         * The DataTableModel.
         */
        private final PrometheusDataTableModel<?, E> theModel;
         ...
         */
        protected void declareColumn(final PrometheusDataTableColumn pColumn) {
            /* Declare the column */
            addColumn(pColumn);
         ...
         * @param pColumn the column
         */
        protected void revealColumn(final PrometheusDataTableColumn pColumn) {
         ...
         * @param pColumn the column
         */
        protected void hideColumn(final PrometheusDataTableColumn pColumn) {
            /* Set the range */
    ...
    protected static final class RowColumnModel<E extends Enum<E>>
         ...
         * Row renderer.
         */
        private MetisFieldRowCellRenderer theRowRenderer;
