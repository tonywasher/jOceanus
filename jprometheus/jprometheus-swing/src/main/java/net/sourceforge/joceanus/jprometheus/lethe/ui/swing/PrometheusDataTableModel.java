...
public abstract class PrometheusDataTableModel<T extends PrometheusTableItem & Comparable<? super T>, E extends Enum<E>>
     ...
     * The Data Table.
     */
    private final transient PrometheusDataTable<T, E> theDataTable;
     ...
     * The table sorter.
     */
    private transient TethysSwingTableSorter<T> theSorter;

    /**
     * Constructor.
     * @param pTable the table with which this model is associated
     */
    protected PrometheusDataTableModel(final PrometheusDataTable<T, E> pTable) {
        /* Access rowHdrModel */
        theDataTable = pTable;
    ...
    protected static class PrometheusRowTableModel<E extends Enum<E>>
         ...
         * The DataTable.
         */
        private final transient PrometheusDataTable<?, E> theDataTable;
