...
import net.sourceforge.joceanus.jprometheus.lethe.ui.eos.PrometheusDataTableColumn.PrometheusRowColumnModel;
import net.sourceforge.joceanus.jprometheus.lethe.ui.eos.PrometheusDataTableModel.PrometheusRowTableModel;
...
public abstract class PrometheusDataTable<T extends DataItem<E> & Comparable<? super T>, E extends Enum<E>>
     ...
     * FieldManager.
     */
    private MetisEosFieldManager theFieldMgr;
     ...
     */
    public MetisEosFieldManager getFieldMgr() {
        return theFieldMgr;
    }
     ...
     */
    protected void setFieldMgr(final MetisEosFieldManager pFieldMgr) {
