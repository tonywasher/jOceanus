 ...
 */
public class PrometheusXBatchControl {
    /**
     ...
     */
    private PrometheusXTableDataItem<?> theCurrTable;
     ...
     */
    protected PrometheusXBatchControl(final Integer pBatchSize) {
     ...
     */
    protected void setCurrentTable(final PrometheusXTableDataItem<?> pTable,
    ...
    private final class BatchTable {
         ...
         */
        private final PrometheusXTableDataItem<?> theTable;
