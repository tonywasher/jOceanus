 ...
 * @author Tony Washer
 */
public class PrometheusSheetXControlKey
        extends PrometheusSheetXDataItem<ControlKey> {
    /**
     * SheetName for Keys.
     */
     ...
     */
    protected PrometheusSheetXControlKey(final PrometheusSheetXReader pReader) {
     ...
     */
    protected PrometheusSheetXControlKey(final PrometheusSheetXWriter pWriter) {
        /* Call super constructor */
