...
import net.sourceforge.joceanus.jmetis.data.ItemValidation;
import net.sourceforge.joceanus.jmetis.data.ItemValidation.ErrorElement;
...
import net.sourceforge.joceanus.jmetis.data.ValueSetHistory;
