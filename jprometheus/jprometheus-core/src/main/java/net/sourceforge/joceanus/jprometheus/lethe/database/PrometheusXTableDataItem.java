 ...
 */
public abstract class PrometheusXTableDataItem<T extends DataItem> {
    /**
     * The Database control.
     */
    private final PrometheusXDataStore theDatabase;
     ...
     */
    protected PrometheusXTableDataItem(final PrometheusXDataStore pDatabase,
                                       final String pTable) {
        /* Set the table */
        theDatabase = pDatabase;
        theConn = theDatabase.getConn();
        theTable = new PrometheusXTableDefinition(theDatabase.getDriver(), pTable);
    }
     ...
     * @return the database
     */
    protected PrometheusXDataStore getDatabase() {
        return theDatabase;
    }
     ...
     */
    protected PrometheusXTableDefinition getTableDef() {
        return theTable;
    }
     ...
     * @return the table definition
     */
    protected PrometheusXTableDefinition getDefinition() {
        return theTable;
    }
    ...
    protected void insertItems(final TethysUIThreadStatusReport pReport,
                               final DataSet pData,
                               final PrometheusXBatchControl pBatch) throws OceanusException {
        /* Declare the new stage */
        ...
        try {
            ...
            while (myIterator.hasNext()) {
                ...
                for (PrometheusXColumnDefinition myCol : theTable.getColumns()) {
