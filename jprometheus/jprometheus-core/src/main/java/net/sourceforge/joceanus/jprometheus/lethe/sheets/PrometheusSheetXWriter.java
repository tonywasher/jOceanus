 ...
 * @author Tony Washer
 */
public abstract class PrometheusSheetXWriter {
    /**
     * Gui Factory.
     */
     ...
     */
    protected PrometheusSheetXWriter(final TethysUIFactory<?> pFactory,
    ...
    public void createBackup(final DataSet pData,
        ...
        /* Assume failure */
        final String myName = PrometheusXSpreadSheet.FILE_NAME + pType.getExtension();
