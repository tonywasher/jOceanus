...
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusBinaryColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusBooleanColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusDateColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusIdColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusIntegerColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusLongColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusMoneyColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusPriceColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusRateColumn;
import net.sourceforge.joceanus.jprometheus.atlas.database.PrometheusColumnDefinition.PrometheusRatioColumn;
