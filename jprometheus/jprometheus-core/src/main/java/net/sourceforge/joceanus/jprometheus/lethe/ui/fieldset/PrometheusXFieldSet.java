 ...
 */
public class PrometheusXFieldSet<T>
     ...
     */
    private final Map<PrometheusDataFieldId, PrometheusXFieldSetPanel<T>> theFieldMap;

    /**
     * The list of panels.
     */
    private final List<PrometheusXFieldSetPanel<T>> thePanels;
     ...
     */
    private PrometheusXFieldSetFields<T> theCurrentPanel;

    /**
     * The tabPanel.
     */
    private PrometheusXFieldSetTabs theTabs;
     ...
     */
    public PrometheusXFieldSet(final TethysUIFactory<?> pFactory) {
        /* Store parameters */
        theFactory = pFactory;
        ...
        theCurrentPanel = new PrometheusXFieldSetFields<>(pFactory, this);
    ...
    public void newTextArea(final String pName,
        ...
        /* Create the new panel and add as tab */
        final PrometheusXFieldSetTextArea<T> myTextArea = new PrometheusXFieldSetTextArea<>(theFactory, this);
    ...
    public void newTable(final String pName,
        ...
        /* Create the new panel and add as tab */
        final PrometheusXFieldSetTableTab<T> myTable = new PrometheusXFieldSetTableTab<>(theFactory, pTable);
    ...
    public void setEditable(final boolean isEditable) {
        ...
        for (PrometheusXFieldSetPanel<T> myPanel : thePanels) {
    ...
    void registerField(final PrometheusDataFieldId pFieldId,
                       final PrometheusXFieldSetPanel<T> pPanel) {
    ...
    public void setFieldVisible(final PrometheusDataFieldId pFieldId,
        ...
        final PrometheusXFieldSetPanel<T> myPanel = theFieldMap.get(pFieldId);
    ...
    void newData(final PrometheusDataFieldId pFieldId,
        ...
        if (!isRefreshing) {
            ...
            final PrometheusXFieldSetEvent myUpdate = new PrometheusXFieldSetEvent(pFieldId, pNewValue);
    ...
    public void setPreferredWidthAndHeight(final int pWidth,
        ...
        final PrometheusXFieldSetPanel<T> myPanel = thePanels.iterator().next();
