 ...
 */
public abstract class PrometheusSheetXEncrypted<T extends EncryptedItem>
        extends PrometheusSheetXDataItem<T> {
    /**
     * KeySetId column.
     */
     ...
     */
    protected PrometheusSheetXEncrypted(final PrometheusSheetXReader pReader,
                                        final String pRange) {
        /* Pass call on */
     ...
     */
    protected PrometheusSheetXEncrypted(final PrometheusSheetXWriter pWriter,
                                        final String pRange) {
        /* Pass call on */
