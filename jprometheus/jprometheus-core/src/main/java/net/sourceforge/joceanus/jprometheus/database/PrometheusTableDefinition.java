...
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusBinaryColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusBooleanColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusDateColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusIdColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusIntegerColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusLongColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusMoneyColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusPriceColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusRateColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusRatioColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusReferenceColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusStringColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PrometheusUnitsColumn;
...
public class PrometheusTableDefinition {
     ...
     * @throws OceanusException on error
     */
    public TethysDate getDateValue(final MetisDataFieldId pId) throws OceanusException {
        /* Obtain the correct id */
        final PrometheusColumnDefinition myCol = getColumnForId(pId);
     ...
     * @throws OceanusException on error
     */
    public TethysMoney getMoneyValue(final MetisDataFieldId pId,
     ...
     * @throws OceanusException on error
     */
    public TethysPrice getPriceValue(final MetisDataFieldId pId,
                                     final TethysUIDataFormatter pFormatter) throws OceanusException {
        /* Obtain the correct id */
        final PrometheusColumnDefinition myCol = getColumnForId(pId);
     ...
     * @throws OceanusException on error
     */
    public TethysRate getRateValue(final MetisDataFieldId pId,
                                   final TethysUIDataFormatter pFormatter) throws OceanusException {
        /* Obtain the correct id */
        final PrometheusColumnDefinition myCol = getColumnForId(pId);
     ...
     * @throws OceanusException on error
     */
    public TethysUnits getUnitsValue(final MetisDataFieldId pId,
                                     final TethysUIDataFormatter pFormatter) throws OceanusException {
        /* Obtain the correct id */
        final PrometheusColumnDefinition myCol = getColumnForId(pId);
     ...
     * @throws OceanusException on error
     */
    public TethysRatio getRatioValue(final MetisDataFieldId pId,
                                     final TethysUIDataFormatter pFormatter) throws OceanusException {
        /* Obtain the correct id */
        final PrometheusColumnDefinition myCol = getColumnForId(pId);
