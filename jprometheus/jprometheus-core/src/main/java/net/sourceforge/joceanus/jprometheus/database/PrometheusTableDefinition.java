...
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.DilutionColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.IdColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.IntegerColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.LongColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.MoneyColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.PriceColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.RateColumn;
import net.sourceforge.joceanus.jprometheus.database.PrometheusColumnDefinition.RatioColumn;
